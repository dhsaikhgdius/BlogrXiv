...
class BlogXiv {
    ...
    getRecentCommunityBlogAdditions() {
        return [
            {
                id: 'giux78-joy-pain-training-llm-from-scratch',
                title: 'The Joy and Pain of Training an LLM from Scratch',
                excerpt: 'Alessandro Ercolani documents the full pipeline behind the Zagreus and Nesso small language model families, from framework selection with Nanotron through tokenizer data engineering and Slurm-driven pretraining to multilingual evaluation, with honest notes on what broke along the way.',
                author: 'Alessandro Ercolani',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Foundation Model',
                tags: ['Small Language Models', 'Pretraining', 'Nanotron', 'Multilingual', 'Training Report'],
                readTime: '25 min read',
                publishDate: '2026-04-02',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/giux78/slm-zagreus-nesso',
                coverImage: 'assets/img/covers/real/giux78-joy-pain-training-llm-from-scratch.png',
                coverAlt: 'Zagreus and Nesso training report cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-techniques-training-large-neural-networks',
                title: 'Techniques for Training Large Neural Networks',
                excerpt: 'OpenAI walks through the parallelism toolbox for training large models, explaining how data, pipeline, tensor, and expert parallelism each split computation across GPUs, where the communication costs land, and which memory-saving tricks make the pieces fit.',
                author: 'Lilian Weng and Justin Jay Wang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Foundation Model',
                tags: ['Distributed Training', 'Data Parallelism', 'Pipeline Parallelism', 'Tensor Parallelism', 'Mixture of Experts'],
                readTime: '10 min read',
                publishDate: '2022-06-09',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/techniques-for-training-large-neural-networks/',
                coverImage: 'assets/img/covers/real/openai-techniques-training-large-neural-networks.webp',
                coverAlt: 'Parallelism techniques diagram from OpenAI',
                coverFit: 'cover'
            },
            {
                id: 'ai2-dolma-3-trillion-token-open-corpus',
                title: 'Dolma: 3 Trillion Token Open Corpus for Language Model Pretraining',
                excerpt: 'Ai2 explains how it assembled Dolma, a 3-trillion-token openly licensed pretraining corpus, walking through source selection, language and quality filtering, deduplication, and toxicity decisions, and releases the toolkit so the pipeline can be audited or remixed.',
                author: 'Luca Soldaini',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=allenai.org&sz=128',
                category: 'Foundation Model',
                tags: ['Pretraining Data', 'Open Corpus', 'Data Curation', 'Deduplication'],
                readTime: '12 min read',
                publishDate: '2023-08-18',
                sourceName: 'Ai2 Blog',
                url: 'https://allenai.org/blog/dolma-3-trillion-tokens-open-llm-corpus-9a0ff4b8da64',
                coverImage: 'assets/img/covers/real/ai2-dolma-3-trillion-token-open-corpus.jpg',
                coverAlt: 'Dolma open pretraining corpus cover',
                coverFit: 'cover'
            },
            {
                id: 'apple-third-generation-foundation-models',
                title: 'Introducing the Third Generation of Apple\'s Foundation Models',
                excerpt: 'Apple details its third-generation foundation model family: a 3B dense on-device model, a 20B sparse on-device model that activates only 1-4B parameters per request, and three server models on Private Cloud Compute, with privacy-preserving deployment as a first-class design constraint.',
                author: 'Apple Machine Learning Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=machinelearning.apple.com&sz=128',
                category: 'Foundation Model',
                tags: ['Apple Foundation Models', 'On-Device AI', 'Sparse Models', 'Private Cloud Compute'],
                ...
                coverImage: 'assets/img/covers/real/apple-third-generation-foundation-models.png',
                coverAlt: 'Apple Foundation Models third generation hero image',
                coverFit: 'cover'
            },
            {
                id: 'google-multi-token-prediction-gemma-4',
                title: 'Accelerating Gemma 4: Faster Inference with Multi-Token Prediction Drafters',
                excerpt: 'Google engineers explain how Multi-Token Prediction drafters give Gemma 4 up to a 3x decoding speedup through a specialized speculative decoding architecture, covering why standard LLM inference is memory-bandwidth bound and how draft-and-verify preserves output quality.',
                author: 'Olivier Lacombe and Maarten Grootendorst',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=blog.google&sz=128',
                category: 'Foundation Model',
                tags: ['Gemma 4', 'Multi-Token Prediction', 'Speculative Decoding', 'Inference'],
                readTime: '8 min read',
                ...
                coverImage: 'assets/img/covers/real/google-multi-token-prediction-gemma-4.png',
                coverAlt: 'Gemma 4 multi-token prediction cover',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Albert Gu, Karan Goel, and Chris Re unpack the S4 architecture, showing how one state space model can be computed as a continuous-time system, a recurrence, or a convolution, and why switching between the three views unlocks efficient long-range sequence modeling.',
                author: 'Albert Gu, Karan Goel, and Chris Re',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Foundation Model',
                tags: ['State Space Models', 'S4', 'Long-Range Dependencies', 'Sequence Modeling'],
                readTime: '15 min read',
                publishDate: '2022-01-14',
                sourceName: 'Stanford Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2022-01-14-s4-3',
                coverImage: 'assets/img/covers/real/hazyresearch-structured-state-spaces-s4.png',
                coverAlt: 'State space model diagram from the S4 blog',
                coverFit: 'cover'
            },
            {
                id: 'openai-learning-to-reason-with-llms',
                title: 'Learning to Reason with LLMs',
                excerpt: 'OpenAI describes how o1 was trained with large-scale reinforcement learning to produce a private chain of thought before answering, and shows accuracy climbing smoothly with both train-time and test-time compute across competition math, coding, and science benchmarks.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'LLM & MLLM',
                tags: ['Reasoning', 'Reinforcement Learning', 'Chain of Thought', 'Test-Time Compute', 'o1'],
                readTime: '12 min read',
                publishDate: '2024-09-12',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/learning-to-reason-with-llms/',
                coverImage: 'assets/img/covers/real/openai-learning-to-reason-with-llms.png',
                coverAlt: 'OpenAI o1 reasoning article cover',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'MiniMax details the framework that pushed its M3 model past the human gold-medal threshold on IMO 2025 and USAMO 2026, combining a stronger base prover, an aligned generative verifier, refinement training, and evolutionary search at test time.',
                author: 'MiniMax',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=minimax.io&sz=128',
                category: 'LLM & MLLM',
                tags: ['Theorem Proving', 'Generative Verifier', 'Reinforcement Learning', 'Test-Time Scaling'],
                readTime: '14 min read',
                publishDate: '2026-06-09',
                sourceName: 'MiniMax Research',
                url: 'https://www.minimax.io/blog/minimax-maxproof-math-proof-evolution',
                coverImage: 'assets/img/covers/real/minimax-maxproof-math-proof-evolution.png',
                coverAlt: 'MaxProof mathematical proof framework cover',
                coverFit: 'cover'
            },
            {
                id: 'jalammar-illustrated-retrieval-transformer',
                title: 'The Illustrated Retrieval Transformer',
                excerpt: 'Jay Alammar visualizes DeepMind\'s RETRO, explaining step by step how a 7.5B-parameter model backed by a trillion-token retrieval database can match far larger models by separating world-knowledge lookup from language modeling.',
                author: 'Jay Alammar',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jalammar.github.io&sz=128',
                category: 'LLM & MLLM',
                tags: ['RETRO', 'Retrieval-Augmented Generation', 'Retrieval', 'Transformers'],
                readTime: '10 min read',
                publishDate: '2022-01-03',
                sourceName: 'Jay Alammar',
                url: 'https://jalammar.github.io/illustrated-retrieval-transformer/',
                coverImage: 'assets/img/covers/real/jalammar-illustrated-retrieval-transformer.png',
                coverAlt: 'RETRO retrieval transformer illustration',
                coverFit: 'cover'
            },
            {
                id: 'jalammar-illustrated-transformer',
                title: 'The Illustrated Transformer',
                excerpt: 'The canonical visual walkthrough of the Transformer, building up self-attention, multi-head attention, positional encoding, and the encoder-decoder stack one diagram at a time - still the fastest way to develop intuition for the architecture behind modern LLMs.',
                author: 'Jay Alammar',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jalammar.github.io&sz=128',
                category: 'LLM & MLLM',
                tags: ['Transformers', 'Self-Attention', 'Architecture', 'Visualization'],
                readTime: '18 min read',
                publishDate: '2018-06-27',
                sourceName: 'Jay Alammar',
                url: 'https://jalammar.github.io/illustrated-transformer/',
                coverImage: 'assets/img/covers/real/jalammar-illustrated-transformer.png',
                coverAlt: 'Illustrated Transformer architecture diagram',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-mapping-mind-language-model',
                title: 'Mapping the Mind of a Large Language Model',
                excerpt: 'Anthropic reports the first detailed look inside a production LLM, using sparse autoencoders to extract millions of interpretable features from Claude 3 Sonnet - including safety-relevant ones - and showing that amplifying or suppressing features causally changes behavior.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'LLM & MLLM',
                tags: ['Interpretability', 'Sparse Autoencoders', 'Features', 'Claude'],
                readTime: '12 min read',
                publishDate: '2024-05-21',
                sourceName: 'Anthropic',
                url: 'https://www.anthropic.com/research/mapping-mind-language-model',
                coverImage: 'assets/img/covers/real/anthropic-mapping-mind-language-model.jpg',
                coverAlt: 'Vintage head diagrams representing concept mapping inside an AI model',
                coverFit: 'cover'
            },
            {
                id: 'google-chain-of-thought-reasoning',
                title: 'Language Models Perform Reasoning via Chain of Thought',
                excerpt: 'Jason Wei and Denny Zhou show that simply prompting large models to produce intermediate reasoning steps unlocks major gains on arithmetic, commonsense, and symbolic reasoning - and that chain-of-thought ability emerges only past a certain model scale.',
                author: 'Jason Wei and Denny Zhou',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'LLM & MLLM',
                tags: ['Chain of Thought', 'Prompting', 'Reasoning', 'Emergent Abilities'],
                readTime: '7 min read',
                ...
                coverImage: 'assets/img/covers/real/google-chain-of-thought-reasoning.jpg',
                coverAlt: 'Chain-of-thought prompting illustration from Google Research',
                coverFit: 'cover'
            },
            {
                id: 'hf-whats-going-on-open-llm-leaderboard',
                title: 'What\'s Going On with the Open LLM Leaderboard?',
                excerpt: 'Hugging Face\'s evaluation team dissects why three implementations of the same MMLU benchmark give wildly different LLaMA scores, tracing the gaps to prompt formatting and log-likelihood versus generation-based scoring - a cautionary tale for anyone comparing eval numbers.',
                author: 'Clementine Fourrier, Nathan Habib, Julien Launay, and Thomas Wolf',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'LLM & MLLM',
                tags: ['Evaluation', 'MMLU', 'Benchmarks', 'Reproducibility'],
                readTime: '13 min read',
                publishDate: '2023-06-23',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/open-llm-leaderboard-mmlu',
                coverImage: 'assets/img/covers/real/hf-whats-going-on-open-llm-leaderboard.png',
                coverAlt: 'Open LLM Leaderboard MMLU deep dive cover',
                coverFit: 'cover'
            },
            {
                id: 'hf-illustrating-rlhf',
                title: 'Illustrating Reinforcement Learning from Human Feedback (RLHF)',
                excerpt: 'Nathan Lambert and collaborators break RLHF into its three trainable stages - a base language model, a human-preference reward model, and PPO-based policy optimization - clarifying what each stage actually optimizes and where the open research problems sit.',
                author: 'Nathan Lambert, Louis Castricato, Leandro von Werra, and Alex Havrilla',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'LLM & MLLM',
                tags: ['RLHF', 'Reward Models', 'PPO', 'Post-Training'],
                readTime: '11 min read',
                publishDate: '2022-12-09',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/rlhf',
                coverImage: 'assets/img/covers/real/hf-illustrating-rlhf.png',
                coverAlt: 'Illustrated RLHF training pipeline cover',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Matteo Nulli builds vision-language models up from first principles: the mathematical formulation, ViT-CLIP vision encoders, contrastive alignment of image and text embeddings, and the architectural flow that turns raw pixels into tokens an LLM can attend to.',
                author: 'Matteo Nulli',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Multimodal Model',
                tags: ['Vision-Language Models', 'CLIP', 'Contrastive Learning', 'Vision Encoders'],
                readTime: '14 min read',
                publishDate: '2026-02-17',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/MatteoNulli/de-mystifying-multimodal-learning-enabiling-vision',
                coverImage: 'assets/img/covers/real/matteo-nulli-demystifying-multimodal-learning.png',
                coverAlt: 'VLM architecture overview from the demystifying multimodal learning post',
                coverFit: 'cover'
            },
            {
                id: 'lilian-weng-generalized-visual-language-models',
                title: 'Generalized Visual Language Models',
                excerpt: 'Lilian Weng surveys four families of visually-augmented language models - joint training on image-text pairs, learned visual prefixes, cross-attention fusion, and frozen-LLM approaches - comparing how each injects vision into a text backbone and what it costs.',
                author: 'Lilian Weng',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=lilianweng.github.io&sz=128',
                category: 'Multimodal Model',
                tags: ['Vision-Language Models', 'Multimodal', 'Image Captioning', 'Survey'],
                readTime: '20 min read',
                publishDate: '2022-06-09',
                sourceName: 'Lil\'Log',
                url: 'https://lilianweng.github.io/posts/2022-06-09-vlm/',
                coverImage: 'assets/img/covers/real/lilian-weng-generalized-visual-language-models.png',
                coverAlt: 'VisualBERT architecture diagram from Generalized Visual Language Models',
                coverFit: 'cover'
            },
            {
                id: 'chip-huyen-multimodality-large-multimodal-models',
                title: 'Multimodality and Large Multimodal Models (LMMs)',
                excerpt: 'Chip Huyen maps the large multimodal model landscape, working through CLIP\'s contrastive pretraining and Flamingo\'s vision-language fusion in detail, then cataloging the data, architecture, and training choices that separate today\'s LMM systems.',
                author: 'Chip Huyen',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huyenchip.com&sz=128',
                category: 'Multimodal Model',
                tags: ['Large Multimodal Models', 'CLIP', 'Flamingo', 'Multimodal Systems'],
                readTime: '25 min read',
                publishDate: '2023-10-10',
                sourceName: 'Chip Huyen',
                url: 'https://huyenchip.com/2023/10/10/multimodal.html',
                coverImage: 'assets/img/covers/real/chip-huyen-multimodality-large-multimodal-models.png',
                coverAlt: 'CLIP architecture diagram from the LMM overview',
                coverFit: 'cover'
            },
            {
                id: 'hf-accelerating-document-ai',
                title: 'Accelerating Document AI',
                excerpt: 'Rajiv Shah, Niels Rogge, and Nicholas Broad organize document AI into six practical use cases - from OCR and classification to layout analysis, document QA, and table extraction - matching each with open-source models like LayoutLM and Donut and the licensing realities practitioners face.',
                author: 'Rajiv Shah, Niels Rogge, and Nicholas Broad',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Multimodal Model',
                tags: ['Document AI', 'LayoutLM', 'OCR', 'Document QA'],
                readTime: '12 min read',
                publishDate: '2022-11-21',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/document-ai',
                coverImage: 'assets/img/covers/real/hf-accelerating-document-ai.png',
                coverAlt: 'Document AI use cases cover',
                coverFit: 'cover'
            },
            {
                id: 'sander-dieleman-noise-schedules-considered-harmful',
                title: 'Noise schedules considered harmful',
                excerpt: 'Sander Dieleman argues that the noise schedule is a superfluous abstraction in diffusion models that entangles time reparameterization, loss weighting, and sampling behavior, and shows how reasoning directly in terms of signal-to-noise ratio disentangles these design choices.',
                author: 'Sander Dieleman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=sander.ai&sz=128',
                category: 'Visual Generation',
                tags: ['Diffusion Models', 'Noise Schedules', 'Loss Weighting', 'Generative Modeling'],
                readTime: '22 min read',
                publishDate: '2024-06-14',
                sourceName: 'Sander Dieleman',
                url: 'https://sander.ai/2024/06/14/noise-schedules.html',
                coverImage: 'assets/img/covers/real/sander-dieleman-noise-schedules-considered-harmful.jpg',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'sander-dieleman-paradox-of-diffusion-distillation',
                title: 'The paradox of diffusion distillation',
                excerpt: 'Sander Dieleman examines the tension at the heart of diffusion distillation: iterative refinement is what makes diffusion models work, yet distillation methods keep trying to make sampling less iterative, and he maps the trade-offs across consistency models, adversarial approaches, and progressive distillation.',
                author: 'Sander Dieleman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=sander.ai&sz=128',
                category: 'Visual Generation',
                tags: ['Diffusion Models', 'Distillation', 'Sampling Efficiency', 'Consistency Models'],
                readTime: '25 min read',
                publishDate: '2024-02-28',
                sourceName: 'Sander Dieleman',
                url: 'https://sander.ai/2024/02/28/paradox.html',
                coverImage: 'assets/img/covers/real/sander-dieleman-paradox-of-diffusion-distillation.jpg',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'NVIDIA\'s Efficient AI lab surveys autoregressive video generation, explaining why causal structure enables streaming inference and KV-cache reuse, how few-step distillation makes block-wise generation practical, and how recent systems extend video length while cutting training cost.',
                author: 'Song Han',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                category: 'Visual Generation',
                tags: ['Video Generation', 'Autoregressive Models', 'KV Cache', 'Distillation'],
                readTime: '14 min read',
                publishDate: '2026-07-13',
                sourceName: 'NVIDIA Research',
                url: 'https://research.nvidia.com/labs/eai/blogs/autoregressive-video-gen/',
                coverImage: 'assets/img/covers/real/nvidia-autoregressive-video-generation.svg',
                coverAlt: 'Article figure comparing full-sequence diffusion with autoregressive diffusion',
                coverFit: 'cover'
            },
            {
                id: 'meta-muse-image-and-muse-video',
                title: 'Introducing Muse Image and Muse Video',
                excerpt: 'Meta Superintelligence Labs details its first media generation models: Muse Image treats image generation as an agentic process that invokes search and code tools and self-refines with test-time compute, while Muse Video builds on the same pretraining base to add native audio support.',
                author: 'Meta Superintelligence Labs',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=ai.meta.com&sz=128',
                category: 'Visual Generation',
                tags: ['Image Generation', 'Video Generation', 'Agentic Tool Use', 'Test-Time Compute'],
                readTime: '15 min read',
                publishDate: '2026-07-07',
                sourceName: 'Meta AI',
                url: 'https://ai.meta.com/blog/introducing-muse-image-muse-video-msl/',
                coverImage: 'assets/img/covers/real/meta-muse-image-and-muse-video.webp',
            ...
            },
            {
                ...
                excerpt: 'NVIDIA\'s Efficient AI lab argues that scaling video generation is now dominated by systems concerns, walking through long-context attention, memory budgets, decoding, scheduling, compression, and parallelism, and showing how deployment-aware design decisions shape model architecture.',
                author: 'Song Han',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                category: 'Visual Generation',
                tags: ['Video Generation', 'Inference Systems', 'Parallelism', 'Long Context'],
                readTime: '13 min read',
                publishDate: '2026-05-26',
                sourceName: 'NVIDIA Research',
                url: 'https://research.nvidia.com/labs/eai/blogs/video-gen-is-an-infra-problem/',
                coverImage: 'assets/img/covers/real/nvidia-video-generation-infrastructure-problem.png',
                coverAlt: 'Article figure on video generation infrastructure',
                coverFit: 'cover'
            },
            {
                id: 'diffusionflow-diffusion-meets-flow-matching',
                title: 'Diffusion Meets Flow Matching: Two Sides of the Same Coin',
                excerpt: 'Ruiqi Gao and colleagues at Google DeepMind show that Gaussian flow matching and diffusion models are mathematically equivalent under a unified parameterization, using interactive figures to connect training objectives, weighting functions, ODE and SDE samplers, and noise schedules across both frameworks.',
                author: 'Ruiqi Gao, Emiel Hoogeboom, Jonathan Heek, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=diffusionflow.github.io&sz=128',
                category: 'Visual Generation',
                tags: ['Flow Matching', 'Diffusion Models', 'ODE Samplers', 'Generative Modeling'],
                readTime: '20 min read',
                publishDate: '2024-12-02',
                sourceName: 'diffusionflow.github.io',
                url: 'https://diffusionflow.github.io/',
                coverImage: 'assets/img/covers/real/diffusionflow-diffusion-meets-flow-matching.gif',
                coverAlt: 'Animated article figure showing particle movement between distributions',
                coverFit: 'cover'
            },
            {
                id: 'meta-fair-partnr-human-robot-collaboration',
                title: 'Advancing machine intelligence through human-centered research',
                excerpt: 'Meta FAIR introduces PARTNR, a 100,000-task benchmark, dataset, and planning model for human-robot collaboration built on Habitat 3.0, showing that state-of-the-art LLM planners still fail at coordination and error recovery while a fine-tuned smaller planner runs 8.6x faster and makes human partners 24% more efficient.',
                author: 'Meta FAIR',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=ai.meta.com&sz=128',
                category: 'World Model',
                tags: ['Human-Robot Collaboration', 'Embodied AI', 'Benchmarks', 'Habitat', 'Planning'],
                readTime: '12 min read',
                publishDate: '2025-02-07',
                sourceName: 'Meta AI',
                url: 'https://ai.meta.com/blog/machine-intelligence-research-new-models/',
                coverImage: 'assets/img/covers/real/meta-fair-partnr-human-robot-collaboration.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'bair-rl-traffic-smoothing-100-av-deployment',
                title: 'Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment',
                excerpt: 'Berkeley researchers describe training RL controllers in fast data-driven simulation and deploying them on 100 autonomous vehicles on Nashville\'s I-24, where the controllers dampened stop-and-go traffic waves and cut fuel consumption for surrounding human drivers by up to 20 percent.',
                author: 'Nathan Lichtlé, Kathy Jang, Eugene Vinitsky, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=bair.berkeley.edu&sz=128',
                category: 'World Model',
                tags: ['Reinforcement Learning', 'Autonomous Vehicles', 'Sim-to-Real', 'Field Deployment'],
                readTime: '9 min read',
                publishDate: '2025-03-25',
                sourceName: 'BAIR Blog',
                url: 'https://bair.berkeley.edu/blog/2025/03/25/rl-av-smoothing/',
                coverImage: 'assets/img/covers/real/bair-rl-traffic-smoothing-100-av-deployment.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'ai2-molmospaces-embodied-ai-ecosystem',
                title: 'MolmoSpaces, an open ecosystem for embodied AI',
                excerpt: 'Ai2 presents MolmoSpaces, an open platform of physics-grounded scenes, objects, and grasp annotations for training and evaluating generalist robotic policies, positioning reproducible simulation assets as shared infrastructure for embodied AI research.',
                author: 'Ai2',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=allenai.org&sz=128',
                category: 'World Model',
                tags: ['Embodied AI', 'Robotics', 'Simulation', 'Open Source'],
                readTime: '8 min read',
                publishDate: '2026-02-11',
                sourceName: 'Ai2 Blog',
                url: 'https://allenai.org/blog/molmospaces',
                coverImage: 'assets/img/covers/real/ai2-molmospaces-embodied-ai-ecosystem.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'google-deepmind-gemini-robotics-1-5',
                title: 'Gemini Robotics 1.5 brings AI agents into the physical world',
                excerpt: 'Google DeepMind explains the two-model design behind Gemini Robotics 1.5: an embodied reasoning model that plans, thinks, and calls tools, paired with a vision-language-action model that transfers learned motions across different robot embodiments to execute multi-step physical tasks.',
                author: 'Carolina Parada',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'World Model',
                tags: ['Robotics', 'Vision-Language-Action', 'Embodied Reasoning', 'Cross-Embodiment'],
                readTime: '10 min read',
                publishDate: '2025-09-25',
                sourceName: 'Google DeepMind',
                url: 'https://deepmind.google/discover/blog/gemini-robotics-15-brings-ai-agents-into-the-physical-world/',
                coverImage: 'assets/img/covers/real/google-deepmind-gemini-robotics-1-5.webp',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'arena-agent-arena-causal-evaluation',
                title: 'Agent Arena: Causal Evaluation of Agents in the Real World',
                excerpt: 'Arena describes a causal evaluation methodology for AI agents grounded in real user interactions, using randomized assignment to isolate the effect of the orchestrator from the underlying model so agent rankings scale with actual usage instead of static benchmarks.',
                author: 'Arena Team',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=arena.ai&sz=128',
                category: 'AI Agents',
                tags: ['Agent Evaluation', 'Causal Inference', 'Real-World Tasks', 'Methodology'],
                readTime: '11 min read',
                publishDate: '2026-06-04',
                sourceName: 'Arena.ai',
                url: 'https://arena.ai/blog/agent-arena-methodology',
                coverImage: 'assets/img/covers/real/arena-agent-arena-causal-evaluation.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'github-copilot-agentic-harness-evaluation',
                title: 'Evaluating performance and efficiency of the GitHub Copilot agentic harness across models and tasks',
                excerpt: 'GitHub benchmarks its Copilot agentic harness against other coding harnesses under fixed models, tasks, and budgets, reporting resolution rate alongside token consumption, cost, and wall-clock time to argue that harness design, not just model choice, drives agentic coding outcomes.',
                author: 'Shibani Basava, Carlos Castro',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=github.blog&sz=128',
                category: 'AI Agents',
                tags: ['Coding Agents', 'Agent Harness', 'Benchmarks', 'Token Efficiency'],
                readTime: '12 min read',
                ...
                coverImage: 'assets/img/covers/real/github-copilot-agentic-harness-evaluation.png',
                coverAlt: 'Article figure showing the Copilot agentic harness architecture across surfaces',
                coverFit: 'cover'
            },
            {
                id: 'letta-context-repositories-git-memory',
                title: 'Introducing Context Repositories: Git-based Memory for Coding Agents',
                excerpt: 'Letta rebuilds coding-agent memory around Git: context is stored as versioned files with frontmatter metadata, edited by a memory subagent in an isolated worktree, giving agents auditable, diffable long-term memory instead of opaque vector stores.',
                author: 'Letta',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=letta.com&sz=128',
                category: 'AI Agents',
                tags: ['Agent Memory', 'Context Management', 'Coding Agents', 'Git'],
                readTime: '9 min read',
                publishDate: '2026-02-12',
                sourceName: 'Letta Blog',
                url: 'https://www.letta.com/blog/context-repositories/',
                coverImage: 'assets/img/covers/real/letta-context-repositories-git-memory.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Hugging Face maintainers run controlled experiments benchmarking open models against their own agentic tooling, showing how to measure tool-calling reliability and task completion on the harness you actually use rather than trusting leaderboard numbers.',
                author: 'Ben Burtenshaw, Merve Noyan, Pedro Cuenca, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'AI Agents',
                tags: ['Agent Evaluation', 'Open Models', 'Tool Calling', 'Benchmarks'],
                readTime: '10 min read',
                publishDate: '2026-06-18',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/is-it-agentic-enough',
                coverImage: 'assets/img/covers/real/hf-is-it-agentic-enough.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'msr-magentic-ui-human-centered-web-agent',
                title: 'Magentic-UI, an experimental human-centered web agent',
                excerpt: 'Microsoft Research presents Magentic-UI, an open-source web agent built around human oversight: co-planning, action approvals, answer verification, and plan memory let people steer browser-based tasks while the system studies where human-in-the-loop control actually improves agent safety and reliability.',
                author: 'Microsoft Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128',
                category: 'AI Agents',
                tags: ['Web Agents', 'Human-in-the-Loop', 'Agent Safety', 'Open Source'],
                readTime: '11 min read',
                ...
                coverImage: 'assets/img/covers/real/msr-magentic-ui-human-centered-web-agent.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'msr-magentic-one-generalist-multi-agent',
                title: 'Magentic-One: A Generalist Multi-Agent System for Solving Complex Tasks',
                excerpt: 'Microsoft Research details Magentic-One, a multi-agent architecture where an Orchestrator maintains task and progress ledgers while delegating to specialized web-browsing, file-navigation, and coding agents, achieving competitive results on GAIA, AssistantBench, and WebArena without modifying the underlying models.',
                author: 'Adam Fourney, Gagan Bansal, Hussein Mozannar, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128',
                category: 'AI Agents',
                tags: ['Multi-Agent Systems', 'Orchestration', 'Agent Benchmarks', 'AutoGen'],
                readTime: '14 min read',
                ...
                coverImage: 'assets/img/covers/real/msr-magentic-one-generalist-multi-agent.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'metr-task-standard-portable-evaluation-tasks',
                title: 'Portable Evaluation Tasks via the METR Task Standard',
                excerpt: 'METR publishes a standard format for defining agent evaluation tasks so the same task definition, environment setup, and scoring logic can run unchanged across different evaluation harnesses, reducing duplicated engineering and making dangerous-capability evaluations easier to share between labs.',
                author: 'METR',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=metr.org&sz=128',
                category: 'AI Agents',
                tags: ['Agent Evaluation', 'Task Standard', 'Interoperability', 'Evals Infrastructure'],
                readTime: '6 min read',
                publishDate: '2024-02-29',
                sourceName: 'METR Blog',
                url: 'https://metr.org/blog/2024-02-29-metr-task-standard/',
                coverImage: 'assets/img/covers/real/metr-task-standard-portable-evaluation-tasks.svg',
                coverAlt: 'Editorial diagram of one task standard running across multiple evaluation harnesses',
                coverFit: 'cover'
            },
            {
                id: 'metr-expenditure-horizon',
                title: 'Expenditure Horizon: Measuring Optimization Ability, with an Application to NanoGPT',
                excerpt: 'METR proposes the expenditure horizon, a metric that measures an agent\'s optimization ability by how much human-equivalent spending its improvements match, and illustrates the measure empirically on the NanoGPT speedrun to track how agents compare to human optimization effort over time.',
                author: 'METR',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=metr.org&sz=128',
                category: 'AI Agents',
                tags: ['Agent Evaluation', 'Optimization', 'NanoGPT', 'Capability Measurement'],
                readTime: '10 min read',
                publishDate: '2026-07-21',
                sourceName: 'METR Blog',
                url: 'https://metr.org/blog/2026-07-21-expenditure-horizon/',
                coverImage: 'assets/img/covers/real/metr-expenditure-horizon.svg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Matei Zaharia and colleagues argue that state-of-the-art AI results increasingly come from compound systems that combine multiple model calls, retrievers, and external tools rather than single models, and analyze the design and optimization questions this shift raises for builders.',
                author: 'Matei Zaharia, Omar Khattab, Lingjiao Chen, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=bair.berkeley.edu&sz=128',
                category: 'AI Agents',
                tags: ['Compound AI Systems', 'System Design', 'Retrieval', 'LLM Applications'],
                readTime: '12 min read',
                publishDate: '2024-02-18',
                sourceName: 'BAIR Blog',
                url: 'https://bair.berkeley.edu/blog/2024/02/18/compound-ai-systems/',
                coverImage: 'assets/img/covers/real/bair-compound-ai-systems.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Alon Jacovi reports a large-scale comparison of tool-assisted generation strategies, finding that few-shot tool calling generally fails to beat no-tool baselines on question answering and reasoning tasks, and diagnoses why demonstrations alone are insufficient for reliable tool use.',
                author: 'Alon Jacovi',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'AI Agents',
                tags: ['Tool Use', 'Few-Shot Learning', 'Negative Results', 'Evaluation'],
                readTime: '8 min read',
                publishDate: '2024-05-30',
                sourceName: 'Google Research Blog',
                url: 'https://research.google/blog/few-shot-tool-use-doesnt-really-work-yet/',
                coverImage: 'assets/img/covers/real/google-few-shot-tool-use-doesnt-work-yet.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'msr-plugmem-reusable-agent-memory',
                title: 'PlugMem: Transforming raw agent interactions into reusable knowledge',
                excerpt: 'Microsoft Research introduces PlugMem, a memory system that converts raw agent interaction histories into a structured knowledge graph of facts and skills, demonstrating cross-task memory reuse on three task families while significantly reducing memory token consumption.',
                author: 'Microsoft Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128',
                category: 'AI Agents',
                tags: ['Agent Memory', 'Knowledge Graphs', 'Skill Reuse', 'Token Efficiency'],
                readTime: '10 min read',
                ...
                coverImage: 'assets/img/covers/real/msr-plugmem-reusable-agent-memory.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-minions-to-openjarvis-retrospective',
                title: 'From Minions to OpenJarvis: A Retrospective on Two Years in Local AI',
                excerpt: 'Jon Saad-Falcon and Avanika Narayan look back on two years of building local-cloud agent systems at Hazy Research, tracing how the Minions cost-accuracy trade-off evolved into the OpenJarvis personal agent stack and distilling lessons about where small on-device models genuinely hold up.',
                author: 'Jon Saad-Falcon, Avanika Narayan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'AI Agents',
                tags: ['Local Models', 'Personal Agents', 'Cost-Accuracy Trade-offs', 'Systems Retrospective'],
                readTime: '15 min read',
                publishDate: '2026-05-15',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2026-05-15-minions-to-openjarvis-retrospective',
                coverImage: 'assets/img/covers/real/hazyresearch-minions-to-openjarvis-retrospective.png',
                coverAlt: 'Article hero figure from the OpenJarvis retrospective',
                coverFit: 'cover'
            },
            {
                id: 'ai2-evaluating-scientific-discovery-agents',
                title: 'Evaluating agents for scientific discovery',
                excerpt: 'Ai2 uses its ScienceWorld and DiscoveryWorld benchmarks to test whether AI agents can run the full scientific loop of hypothesizing, experimenting, and concluding, finding that even strong agents struggle with discovery problems human scientists solve routinely.',
                author: 'Ai2',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=allenai.org&sz=128',
                category: 'AI Agents',
                tags: ['Scientific Discovery', 'Agent Benchmarks', 'ScienceWorld', 'Evaluation'],
                readTime: '9 min read',
                publishDate: '2026-04-13',
                sourceName: 'Ai2 Blog',
                url: 'https://allenai.org/blog/evaluating-scientific-discovery-agents',
                coverImage: 'assets/img/covers/real/ai2-evaluating-scientific-discovery-agents.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-flashattention-long-sequences',
                title: 'FlashAttention: Fast Transformer Training with Long Sequences',
                excerpt: 'Tri Dao details how parallelizing FlashAttention over the sequence dimension keeps GPUs saturated at long context, making 8k-token GPT training up to 2.7x faster than an optimized baseline while computing exact attention.',
                author: 'Tri Dao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['FlashAttention', 'Long Context', 'GPU Kernels', 'Training Efficiency'],
                readTime: '9 min read',
                publishDate: '2023-01-12',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2023-01-12-flashattention-long-sequences',
                coverImage: 'assets/img/covers/real/hazyresearch-flashattention-long-sequences.png',
                coverAlt: 'FlashAttention forward and backward pass parallelization diagram',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-flashattention-2',
                title: 'FlashAttention-2: Faster Attention with Better Parallelism and Work Partitioning',
                excerpt: 'FlashAttention-2 rewrites the attention kernel with better work partitioning between warps and thread blocks and fewer non-matmul FLOPs, reaching up to 2x the speed of the original FlashAttention and 72% of peak A100 throughput.',
                author: 'Tri Dao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['FlashAttention-2', 'Attention Kernels', 'GPU Utilization', 'Work Partitioning'],
                readTime: '10 min read',
                publishDate: '2023-07-17',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2023-07-17-flash2',
                coverImage: 'assets/img/covers/real/hazyresearch-flashattention-2.png',
                coverAlt: 'FlashAttention versus FlashAttention-2 work partitioning diagram',
                coverFit: 'cover'
            },
            {
                id: 'jax-ml-how-to-scale-your-model',
                title: 'How to Scale Your Model',
                excerpt: 'Google DeepMind engineers turn LLM scaling from alchemy into arithmetic: a book-length treatment of rooflines, TPU and GPU architecture, collective communication, and every major parallelism strategy for training and inference.',
                author: 'Jacob Austin, Sholto Douglas, Roy Frostig, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jax-ml.github.io&sz=128',
                category: 'Efficient AI',
                tags: ['Systems', 'Parallelism', 'Rooflines', 'TPUs', 'Scaling'],
                readTime: '90 min read',
                publishDate: '2025-02-04',
                sourceName: 'Google DeepMind',
                url: 'https://jax-ml.github.io/scaling-book/',
                coverImage: 'assets/img/covers/real/jax-ml-how-to-scale-your-model.png',
                coverAlt: 'How to Scale Your Model book cover artwork',
                coverFit: 'cover'
            },
            {
                id: 'kipply-transformer-inference-arithmetic',
                title: 'Transformer Inference Arithmetic',
                excerpt: 'Kipply derives a back-of-the-envelope performance model for transformer inference, using KV cache size, weight memory, FLOPs, and communication costs to predict latency and throughput before running a single benchmark.',
                author: 'Carol Chen (kipply)',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=kipp.ly&sz=128',
                category: 'Efficient AI',
                tags: ['Inference', 'KV Cache', 'Performance Modeling', 'FLOPs'],
                readTime: '25 min read',
                publishDate: '2022-03-30',
                sourceName: 'kipply\'s blog',
                url: 'https://kipp.ly/p/transformer-inference-arithmetic',
                coverImage: 'assets/img/covers/real/kipply-transformer-inference-arithmetic.jpg',
                coverAlt: 'Transformer inference arithmetic article cover',
                coverFit: 'cover'
            },
            {
                id: 'horace-he-making-deep-learning-go-brrrr',
                title: 'Making Deep Learning Go Brrrr From First Principles',
                excerpt: 'Horace He splits deep learning performance into compute-bound, memory-bandwidth-bound, and overhead-bound regimes, showing how to diagnose which one you are in and why optimizations like operator fusion only pay off in the right regime.',
                author: 'Horace He',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=horace.io&sz=128',
                category: 'Efficient AI',
                tags: ['Performance', 'Memory Bandwidth', 'Operator Fusion', 'Profiling'],
                readTime: '18 min read',
                publishDate: '2022-03-15',
                sourceName: 'horace.io',
                url: 'https://horace.io/brrr_intro.html',
                coverImage: 'assets/img/covers/real/horace-he-making-deep-learning-go-brrrr.webp',
                coverAlt: 'GPUs go brrr illustration from the article',
                coverFit: 'cover'
            },
            {
                id: 'google-research-gspmd-parallelization',
                title: 'General and Scalable Parallelization for Neural Networks',
                excerpt: 'Google Research introduces GSPMD, an XLA compiler pass that expands lightweight tensor sharding annotations into full SPMD parallelization, letting a single program express data, model, and pipeline parallelism across thousands of accelerators.',
                author: 'Yuanzhong Xu and Yanping Huang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'Efficient AI',
                tags: ['GSPMD', 'Model Parallelism', 'XLA', 'Distributed Training'],
                readTime: '8 min read',
                publishDate: '2021-12-08',
                sourceName: 'Google Research',
                url: 'https://research.google/blog/general-and-scalable-parallelization-for-neural-networks/',
                coverImage: 'assets/img/covers/real/google-research-gspmd-parallelization.jpg',
                coverAlt: 'GSPMD parallelization article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-research-looking-back-at-speculative-decoding',
                title: 'Looking Back at Speculative Decoding',
                excerpt: 'Yaniv Leviathan and colleagues recount the origin of speculative decoding, explaining how draft-then-verify sampling emits several tokens per serial step without changing the output distribution, and how the idea spread through production LLM serving.',
                author: 'Yaniv Leviathan, Matan Kalman, and Yossi Matias',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'Efficient AI',
                tags: ['Speculative Decoding', 'Inference', 'Latency', 'LLM Serving'],
                readTime: '9 min read',
                publishDate: '2024-12-06',
                sourceName: 'Google Research',
                url: 'https://research.google/blog/looking-back-at-speculative-decoding/',
                coverImage: 'assets/img/covers/real/google-research-looking-back-at-speculative-decoding.jpg',
                coverAlt: 'Speculative decoding retrospective article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-mastering-llm-inference-optimization',
                title: 'Mastering LLM Techniques: Inference Optimization',
                excerpt: 'A single reference that maps the LLM inference stack end to end: prefill versus decode, KV caching, batching, attention variants like MQA/GQA and FlashAttention, PagedAttention, quantization, and model parallelism strategies.',
                author: 'Shashank Verma and Neal Vaidya',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['Inference Optimization', 'KV Cache', 'Attention', 'Model Parallelism'],
                readTime: '22 min read',
                ...
                coverImage: 'assets/img/covers/real/nvidia-mastering-llm-inference-optimization.png',
                coverAlt: 'LLM inference optimization overview graphic',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-peft-parameter-efficient-fine-tuning',
                title: 'Parameter-Efficient Fine-Tuning using PEFT',
                excerpt: 'Hugging Face introduces the PEFT library, showing how LoRA, prefix tuning, and prompt tuning adapt billion-parameter models by training a small fraction of weights, with checkpoints measured in megabytes instead of tens of gigabytes.',
                author: 'Sourab Mangrulkar and Sayak Paul',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['PEFT', 'LoRA', 'Fine-Tuning', 'Adapters'],
                readTime: '10 min read',
                publishDate: '2023-02-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/peft',
                coverImage: 'assets/img/covers/real/huggingface-peft-parameter-efficient-fine-tuning.png',
                coverAlt: 'PEFT library announcement thumbnail',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-4bit-transformers-bitsandbytes',
                title: 'Making LLMs Even More Accessible with bitsandbytes, 4-bit Quantization and QLoRA',
                excerpt: 'The QLoRA release explained: 4-bit NF4 quantization, double quantization, and paged optimizers in bitsandbytes let a 65B-parameter model be fine-tuned on a single 48GB GPU while matching 16-bit fine-tuning quality.',
                author: 'Younes Belkada, Tim Dettmers, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['Quantization', 'QLoRA', '4-bit', 'bitsandbytes'],
                readTime: '12 min read',
                publishDate: '2023-05-24',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/4bit-transformers-bitsandbytes',
                coverImage: 'assets/img/covers/real/huggingface-4bit-transformers-bitsandbytes.png',
                coverAlt: 'bitsandbytes 4-bit quantization thumbnail',
                coverFit: 'cover'
            },
            {
                id: 'raschka-lora-and-dora-from-scratch',
                title: 'Improving LoRA: Implementing Weight-Decomposed Low-Rank Adaptation (DoRA) from Scratch',
                excerpt: 'Sebastian Raschka implements LoRA and DoRA in plain PyTorch from scratch, showing how DoRA\'s decomposition of weights into magnitude and direction can beat LoRA even with half the rank.',
                author: 'Sebastian Raschka',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=sebastianraschka.com&sz=128',
                category: 'Efficient AI',
                tags: ['LoRA', 'DoRA', 'Fine-Tuning', 'PyTorch'],
                readTime: '16 min read',
                publishDate: '2024-02-18',
                sourceName: 'Ahead of AI',
                url: 'https://magazine.sebastianraschka.com/p/lora-and-dora-from-scratch',
                coverImage: 'assets/img/covers/real/raschka-lora-and-dora-from-scratch.jpg',
                coverAlt: 'LoRA and DoRA from scratch article cover',
                coverFit: 'cover'
            },
            {
                id: 'epoch-ai-inference-economics-of-language-models',
                title: 'Inference Economics of Language Models',
                excerpt: 'Ege Erdil builds a first-principles economic model of LLM inference covering arithmetic, memory bandwidth, network bandwidth, and latency constraints, deriving cost-versus-speed Pareto frontiers and why serial speedups get expensive fast.',
                author: 'Ege Erdil',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Efficient AI',
                tags: ['Inference Economics', 'Serving Cost', 'Parallelism', 'Token Latency'],
                readTime: '30 min read',
                publishDate: '2025-06-05',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/inference-economics-of-language-models',
                coverImage: 'assets/img/covers/real/epoch-ai-inference-economics-of-language-models.png',
                coverAlt: 'Inference economics of language models report banner',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-thunderkittens-dsl',
                title: 'ThunderKittens: A Simple Embedded DSL for AI Kernels',
                excerpt: 'Hazy Research argues that GPUs want simple abstractions: ThunderKittens is an embedded CUDA DSL built around 16x16 tiles that makes attention and other AI kernels easier to write while staying competitive with hand-tuned libraries.',
                author: 'Benjamin Spector, Aaryan Singhal, Simran Arora, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['ThunderKittens', 'CUDA', 'Kernel DSL', 'Tensor Cores'],
                readTime: '12 min read',
                publishDate: '2024-05-12',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2024-05-12-quick-tk',
                coverImage: 'assets/img/covers/real/hazyresearch-thunderkittens-dsl.png',
                coverAlt: 'ThunderKittens blog hero illustration',
                coverFit: 'cover'
            },
            {
                id: 'uk-aisi-control-red-team-stress-testing-frontier-monitors',
                title: 'How Our New Control Red Team is Stress-Testing Frontier Monitors',
                excerpt: 'UK AISI\'s Control Red Team shares early lessons from red-teaming the internal monitors frontier AI companies use to catch misbehaving models, and lays out the open problems in making those monitors robust to adversarial pressure.',
                author: 'UK AI Security Institute',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=aisi.gov.uk&sz=128',
                category: 'Trustworthy AI',
                tags: ['AI Control', 'Red Teaming', 'Monitoring', 'Frontier Safety'],
                readTime: '10 min read',
                ...
                coverImage: 'assets/img/covers/real/uk-aisi-control-red-team-stress-testing-frontier-monitors.png',
                coverAlt: 'UK AISI control red team article cover',
                coverFit: 'cover'
            },
            {
                id: 'redwood-research-prioritizing-threats-for-ai-control',
                title: 'Prioritizing Threats for AI Control',
                excerpt: 'Ryan Greenblatt maps the space of threats that AI control should defend against, arguing that control resources should be allocated across scheming risk scenarios by likelihood and severity rather than spread evenly over all conceivable failures.',
                author: 'Ryan Greenblatt',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=blog.redwoodresearch.org&sz=128',
                category: 'Trustworthy AI',
                tags: ['AI Control', 'Threat Models', 'Scheming', 'Safety Strategy'],
                readTime: '14 min read',
                publishDate: '2025-03-19',
                sourceName: 'Redwood Research Blog',
                url: 'https://blog.redwoodresearch.org/p/prioritizing-threats-for-ai-control',
                coverImage: 'assets/img/covers/real/redwood-research-prioritizing-threats-for-ai-control.jpg',
                coverAlt: 'Prioritizing threats for AI control article cover',
                coverFit: 'cover'
            },
            {
                id: 'distill-building-blocks-of-interpretability',
                title: 'The Building Blocks of Interpretability',
                excerpt: 'Olah and colleagues combine feature visualization, attribution, and matrix factorization into composable interfaces for looking inside neural networks, establishing a foundational grammar for modern interpretability tooling.',
                author: 'Chris Olah, Arvind Satyanarayan, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'Trustworthy AI',
                tags: ['Interpretability', 'Feature Visualization', 'Attribution', 'Neural Networks'],
                readTime: '25 min read',
                publishDate: '2018-03-06',
                sourceName: 'Distill',
                url: 'https://distill.pub/2018/building-blocks/',
                coverImage: 'assets/img/covers/real/distill-building-blocks-of-interpretability.jpg',
                coverAlt: 'Building blocks of interpretability feature visualization thumbnail',
                coverFit: 'cover'
            },
            {
                id: 'distill-circuits-thread',
                title: 'Thread: Circuits',
                excerpt: 'The Distill Circuits thread argues that neural networks contain understandable, reusable circuits of features, documenting curve detectors and other structures weight by weight in InceptionV1 as an \'open science\' interpretability program.',
                author: 'Nick Cammarata, Shan Carter, Gabriel Goh, Chris Olah, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'Trustworthy AI',
                tags: ['Circuits', 'Mechanistic Interpretability', 'Vision Models', 'Features'],
                readTime: '60 min read',
                publishDate: '2020-03-10',
                sourceName: 'Distill',
                url: 'https://distill.pub/2020/circuits/',
                coverImage: 'assets/img/covers/real/distill-circuits-thread.jpg',
                coverAlt: 'Distill circuits thread thumbnail',
                coverFit: 'cover'
            },
            {
                id: 'distill-advex-bugs-discussion',
                title: 'A Discussion of \'Adversarial Examples Are Not Bugs, They Are Features\'',
                excerpt: 'A structured scientific exchange around the claim that adversarial examples exploit non-robust but genuinely predictive features, with six response essays and author replies that sharpen exactly what the result does and does not show.',
                author: 'Logan Engstrom, Justin Gilmer, Gabriel Goh, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'Trustworthy AI',
                tags: ['Adversarial Examples', 'Robustness', 'Scientific Discussion', 'Robust Features'],
                readTime: '30 min read',
                publishDate: '2019-08-06',
                sourceName: 'Distill',
                url: 'https://distill.pub/2019/advex-bugs-discussion/',
                coverImage: 'assets/img/covers/real/distill-advex-bugs-discussion.jpg',
                coverAlt: 'Adversarial examples discussion article thumbnail',
                coverFit: 'cover'
            },
            {
                id: 'deepmind-how-undesired-goals-can-arise-with-correct-rewards',
                title: 'How Undesired Goals Can Arise with Correct Rewards',
                excerpt: 'DeepMind researchers separate goal misgeneralisation from specification gaming, giving concrete RL and LLM examples where an agent trained with a correct reward signal still learns to pursue the wrong goal out of distribution.',
                author: 'Rohin Shah, Victoria Krakovna, Vikrant Varma, and Zachary Kenton',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Goal Misgeneralisation', 'Specification Gaming', 'Alignment', 'RL Safety'],
                readTime: '8 min read',
                publishDate: '2022-10-07',
                sourceName: 'Google DeepMind Blog',
                url: 'https://deepmind.google/blog/how-undesired-goals-can-arise-with-correct-rewards/',
                coverImage: 'assets/img/covers/real/deepmind-how-undesired-goals-can-arise-with-correct-rewards.webp',
                coverAlt: 'Goal misgeneralisation article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-deliberative-alignment',
                title: 'Deliberative Alignment: Reasoning Enables Safer Language Models',
                excerpt: 'OpenAI describes deliberative alignment, which teaches o-series models the text of safety specifications and trains them to reason explicitly over those specifications at inference time, improving both refusal precision and jailbreak robustness.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Deliberative Alignment', 'Safety Training', 'Reasoning Models', 'Specifications'],
                readTime: '12 min read',
                publishDate: '2024-12-20',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/deliberative-alignment/',
                coverImage: 'assets/img/covers/real/openai-deliberative-alignment.png',
                coverAlt: 'Deliberative alignment article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-simple-probes-can-catch-sleeper-agents',
                title: 'Simple Probes Can Catch Sleeper Agents',
                excerpt: 'Anthropic shows that simple linear probes on residual-stream activations can detect backdoored \'sleeper agent\' models about to defect, working surprisingly well even with generic contrast prompts unrelated to the backdoor behavior.',
                author: 'Anthropic Alignment Science Team',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Sleeper Agents', 'Linear Probes', 'Defection Detection', 'Alignment'],
                readTime: '14 min read',
                publishDate: '2024-04-23',
                sourceName: 'Anthropic Research',
                url: 'https://www.anthropic.com/research/probes-catch-sleeper-agents',
                coverImage: 'assets/img/covers/real/anthropic-simple-probes-can-catch-sleeper-agents.jpg',
                coverAlt: 'Sleeper agent probes article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-off-switch-dual-use-knowledge',
                title: 'An Off Switch for Dual-Use Knowledge in AI Models',
                excerpt: 'Anthropic and AE Studio introduce GRAM, which routes gradients from dual-use training data into dedicated removable modules, so capabilities like virology knowledge can be deleted at deployment while general abilities stay intact.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Dual-Use Knowledge', 'Gradient Routing', 'Biosecurity', 'Safeguards'],
                readTime: '11 min read',
                publishDate: '2026-07-08',
                sourceName: 'Anthropic Research',
                url: 'https://www.anthropic.com/research/off-switch-dual-use',
                coverImage: 'assets/img/covers/real/anthropic-off-switch-dual-use-knowledge.png',
                coverAlt: 'Off switch for dual-use knowledge article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-diff-tool-behavioral-differences',
                title: 'A \'Diff\' Tool for AI: Finding Behavioral Differences in New Models',
                excerpt: 'Anthropic Fellows build a diff tool that compares the internal features of two models and flags behaviors exclusive to one of them, surfacing switches like censorship or copyright-refusal features that black-box testing would likely miss.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Model Diffing', 'Interpretability', 'Auditing', 'Behavioral Evaluation'],
                readTime: '10 min read',
                publishDate: '2026-03-13',
                sourceName: 'Anthropic Research',
                url: 'https://www.anthropic.com/research/diff-tool',
                coverImage: 'assets/img/covers/real/anthropic-diff-tool-behavioral-differences.png',
                coverAlt: 'Diff tool for AI models article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepmind-early-warning-system-novel-ai-risks',
                title: 'An Early Warning System for Novel AI Risks',
                excerpt: 'DeepMind proposes an early-warning framework for frontier risk: evaluate models separately for dangerous capabilities and for alignment, and feed the results into training, deployment, and security decisions before harm can occur.',
                author: 'Toby Shevlane',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Dangerous Capability Evals', 'Frontier Risk', 'Model Evaluation', 'Governance'],
                readTime: '9 min read',
                publishDate: '2023-05-25',
                sourceName: 'Google DeepMind Blog',
                url: 'https://deepmind.google/blog/an-early-warning-system-for-novel-ai-risks/',
                coverImage: 'assets/img/covers/real/deepmind-early-warning-system-novel-ai-risks.webp',
                coverAlt: 'Early warning system for novel AI risks article cover',                coverFit: 'cover'
            },
            {
                id: 'hamming-you-and-your-research',
                title: 'You and Your Research',
                excerpt: 'Transcript of Hamming\'s 1986 Bellcore colloquium on why so few scientists do Nobel-class work: he argues that courage, working on important problems with the door open, and selling your results compound over a career far more than raw ability.',
                author: 'Richard Hamming',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.virginia.edu&sz=128',
                category: 'How to Research',
                tags: ['Research Careers', 'Problem Selection', 'Scientific Excellence', 'Classic Essay'],
                readTime: '50 min read',
                publishDate: '1986-03-07',
                sourceName: 'UVA Computer Science Archive',
                url: 'https://www.cs.virginia.edu/~robins/YouAndYourResearch.html',
                coverImage: 'assets/img/covers/real/hamming-you-and-your-research.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'michael-nielsen-principles-of-effective-research',
                title: 'Principles of Effective Research',
                excerpt: 'Nielsen\'s 2004 essay splits effective research into self-development and creative work, offering concrete principles: work proactively rather than reactively, keep a vision you revisit, and develop your strengths as a problem-creator or problem-solver.',
                author: 'Michael Nielsen',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=michaelnielsen.org&sz=128',
                category: 'How to Research',
                tags: ['Research Process', 'Self-Development', 'Problem Selection', 'Classic Essay'],
                readTime: '25 min read',
                publishDate: '2004-07-27',
                sourceName: 'michaelnielsen.org',
                url: 'https://michaelnielsen.org/blog/principles-of-effective-research/',
                coverImage: 'assets/img/covers/real/michael-nielsen-principles-of-effective-research.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Keshav\'s widely translated two-page classic teaches the three-pass method — a five-minute bird\'s-eye scan, an hour-long content pass, and a virtual re-implementation — and shows how to chain the passes into an efficient literature survey.',
                author: 'S. Keshav',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=svr-sk818-web.cl.cam.ac.uk&sz=128',
                category: 'How to Research',
                tags: ['Paper Reading', 'Literature Review', 'Three-Pass Method', 'Research Skills'],
                readTime: '8 min read',
                publishDate: '2007-07-01',
                sourceName: 'University of Cambridge',
                url: 'https://svr-sk818-web.cl.cam.ac.uk/keshav/publications/htrap.html',
                coverImage: 'assets/img/covers/real/keshav-how-to-read-a-paper.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'karpathy-survival-guide-to-a-phd',
                title: 'A Survival Guide to a PhD',
                excerpt: 'Karpathy\'s candid guide through the Stanford PhD: whether to do one at all, picking an adviser and problems at the research frontier, treating paper-writing as a craft to be studied, and surviving the psychological lows.',
                author: 'Andrej Karpathy',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=karpathy.github.io&sz=128',
                category: 'How to Research',
                tags: ['PhD Advice', 'Adviser Selection', 'Paper Writing', 'Research Careers'],
                readTime: '35 min read',
                publishDate: '2016-09-07',
                sourceName: 'Andrej Karpathy Blog',
                url: 'https://karpathy.github.io/2016/09/07/phd/',
                coverImage: 'assets/img/covers/real/karpathy-survival-guide-to-a-phd.jpg',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'john-schulman-opinionated-guide-ml-research',
                title: 'An Opinionated Guide to ML Research',
                excerpt: 'Written for the OpenAI Fellows program, Schulman\'s essay contrasts goal-driven with idea-driven research, prescribes reproducing papers to build skill, and treats research taste as something honed through deliberate feedback loops.',
                author: 'John Schulman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=joschu.net&sz=128',
                category: 'How to Research',
                tags: ['ML Research', 'Problem Selection', 'Research Taste', 'Mentoring'],
                readTime: '20 min read',
                publishDate: '2020-01-24',
                sourceName: 'joschu.net',
                url: 'http://joschu.net/blog/opinionated-guide-ml-research.html',
                coverImage: 'assets/img/covers/real/john-schulman-opinionated-guide-ml-research.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'jacob-steinhardt-film-study-for-research',
                title: 'Film Study for Research',
                excerpt: 'Steinhardt borrows two habits from elite athletes — film study and deliberate drills — and shows how researchers can replay how a result was actually produced, dissect papers and talks, and train isolated research skills on purpose.',
                author: 'Jacob Steinhardt',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jsteinhardt.stat.berkeley.edu&sz=128',
                category: 'How to Research',
                tags: ['Deliberate Practice', 'Research Training', 'Skill Building', 'Mentoring'],
                readTime: '10 min read',
                publishDate: '2021-06-28',
                sourceName: 'Jacob Steinhardt',
                url: 'https://jsteinhardt.stat.berkeley.edu/blog/film-study',
                coverImage: 'assets/img/covers/real/jacob-steinhardt-film-study-for-research.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'distill-research-debt',
                title: 'Research Debt',
                excerpt: 'Olah and Carter diagnose \'research debt\' — the accumulated interpretive labor of undigested ideas, bad abstractions, and noise that walls off a field — and argue that distillation is serious research work deserving first-class credit.',
                author: 'Chris Olah and Shan Carter',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'How to Research',
                tags: ['Research Distillation', 'Scientific Communication', 'Interpretive Labor', 'Field Building'],
                readTime: '12 min read',
                publishDate: '2017-03-22',
                sourceName: 'Distill',
                url: 'https://distill.pub/2017/research-debt/',
                coverImage: 'assets/img/covers/real/distill-research-debt.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'colah-research-taste-exercises',
                title: 'Research Taste Exercises',
                excerpt: 'A rough note offering five concrete exercises for developing research taste — necessary because real feedback on whether an idea was good arrives only a few times a year — along with three failure modes to avoid.',
                author: 'Christopher Olah',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=colah.github.io&sz=128',
                category: 'How to Research',
                tags: ['Research Taste', 'Deliberate Practice', 'Research Judgment', 'Problem Selection'],
                readTime: '8 min read',
                publishDate: '2021-01-09',
                sourceName: 'colah\'s blog',
                url: 'https://colah.github.io/notes/taste/',
                coverImage: 'assets/img/covers/real/colah-research-taste-exercises.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'jason-wei-practicing-ai-research',
                title: 'Practicing AI research',
                excerpt: 'Jason Wei decomposes AI research into four trainable skills — idea conception and selection, experiment design and execution, paper writing, and maximizing impact — and gives practical habits for improving each through practice.',
                author: 'Jason Wei',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jasonwei.net&sz=128',
                category: 'How to Research',
                tags: ['AI Research', 'Research Practice', 'Paper Writing', 'Career Growth'],
                readTime: '12 min read',
                publishDate: '2023-02-07',
                sourceName: 'Jason Wei Blog',
                url: 'https://www.jasonwei.net/blog/practicing-ai-research',
                coverImage: 'assets/img/covers/real/jason-wei-practicing-ai-research.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'eugene-yan-choosing-problems',
                title: 'Choosing Problems in Data Science and Machine Learning',
                excerpt: 'Eugene Yan converts problem selection into explicit trade-offs — short versus long-term gain, incremental versus disruptive innovation, resume-driven versus impact-driven development — for deciding which ML problems deserve your time.',
                author: 'Eugene Yan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=eugeneyan.com&sz=128',
                category: 'How to Research',
                tags: ['Problem Selection', 'Data Science', 'Prioritization', 'Career Growth'],
                readTime: '12 min read',
                publishDate: '2021-03-21',
                sourceName: 'eugeneyan.com',
                url: 'https://eugeneyan.com/writing/how-to-choose-problems/',
                coverImage: 'assets/img/covers/real/eugene-yan-choosing-problems.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'matt-might-illustrated-guide-to-phd',
                title: 'The Illustrated Guide to a Ph.D.',
                excerpt: 'Matt Might\'s circle-of-knowledge drawings compress the doctoral journey into a handful of pictures: years of study buy you a tiny dent in the boundary of human knowledge — so keep pushing.',
                author: 'Matt Might',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=matt.might.net&sz=128',
                category: 'How to Research',
                tags: ['PhD Advice', 'Visual Explanation', 'Research Careers', 'Classic Essay'],
                readTime: '3 min read',
                publishDate: '2010-01-01',
                sourceName: 'matt.might.net',
                url: 'https://matt.might.net/articles/phd-school-in-pictures/',
                coverImage: 'assets/img/covers/real/matt-might-illustrated-guide-to-phd.jpg',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'terence-tao-partial-progress',
                title: 'On the importance of partial progress',
                excerpt: 'Tao explains why researchers must value partial progress: failed attempts and solved toy cases cost nothing to combine later, and they localize exactly where the remaining difficulty of a problem lives.',
                author: 'Terence Tao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=terrytao.wordpress.com&sz=128',
                category: 'How to Research',
                tags: ['Problem Solving', 'Partial Progress', 'Mathematical Research', 'Career Advice'],
                readTime: '6 min read',
                publishDate: '2012-07-17',
                sourceName: 'What\'s new (Terence Tao)',
                url: 'https://terrytao.wordpress.com/career-advice/on-the-importance-of-partial-progress/',
                coverImage: 'assets/img/covers/real/terence-tao-partial-progress.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'terence-tao-learn-and-relearn-your-field',
                title: 'Learn and relearn your field',
                excerpt: 'Starting from Pólya\'s dictum that no problem is ever exhausted, Tao lists ways to keep re-learning your own field — alternate proofs, dropped hypotheses, model examples, and asking why each result is true — until understanding becomes generative.',
                author: 'Terence Tao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=terrytao.wordpress.com&sz=128',
                category: 'How to Research',
                tags: ['Deep Understanding', 'Learning Strategy', 'Mathematical Research', 'Career Advice'],
                readTime: '5 min read',
                publishDate: '2007-05-06',
                sourceName: 'What\'s new (Terence Tao)',
                url: 'https://terrytao.wordpress.com/career-advice/learn-and-relearn-your-field/',
                coverImage: 'assets/img/covers/real/terence-tao-learn-and-relearn-your-field.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'google-brain-team-approach-to-research',
                title: 'The Google Brain Team\'s Approach to Research',
                excerpt: 'Jeff Dean describes how Google Brain organizes research as a portfolio across timescales, pairing long-term open-ended work with product collaborations, and measuring success through papers, open tools, and the researchers it trains.',
                author: 'Jeff Dean',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'How to Research',
                tags: ['Research Strategy', 'Industrial Research', 'Google Brain', 'Research Management'],
                readTime: '8 min read',
                publishDate: '2017-09-13',
                sourceName: 'Google Research Blog',
                url: 'https://research.google/blog/the-google-brain-teams-approach-to-research/',
                coverImage: 'assets/img/covers/real/google-brain-team-approach-to-research.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'metr-changing-developer-productivity-experiment-design',
                title: 'We are Changing our Developer Productivity Experiment Design',
                excerpt: 'METR publicly diagnoses why its second developer-productivity RCT became unreliable — developers increasingly refused to work without AI, biasing the speedup estimate — and details the redesigned experiment that addresses the selection effect.',
                author: 'Joel Becker, Nate Rush, Tom Cunningham, David Rein, and Khalid Mahamud',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=metr.org&sz=128',
                category: 'Research Craft',
                tags: ['Experiment Design', 'Selection Effects', 'Developer Productivity', 'Research Integrity'],
                readTime: '8 min read',
                publishDate: '2026-02-24',
                sourceName: 'METR Blog',
                url: 'https://metr.org/blog/2026-02-24-uplift-update/',
                coverImage: 'assets/img/covers/real/metr-changing-developer-productivity-experiment-design.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'hamel-husain-hard-to-eval-is-a-product-smell',
                title: '"It\'s Hard to Eval" Is a Product Smell',
                excerpt: 'Hamel Husain argues that when an AI product is hard to evaluate, the product itself is misdesigned: outputs users cannot verify are outputs builders cannot eval, so verifiability should be a first-class design constraint.',
                author: 'Hamel Husain',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hamel.dev&sz=128',
                category: 'Research Craft',
                tags: ['Evals', 'Product Design', 'Verifiability', 'AI Products'],
                readTime: '10 min read',
                publishDate: '2026-06-29',
                sourceName: 'Hamel\'s Blog',
                url: 'https://hamel.dev/blog/posts/eval-smell/',
                coverImage: 'assets/img/covers/real/hamel-husain-hard-to-eval-is-a-product-smell.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Godbole, Dahl, Gilmer, Shallue, and Nado codify Google Brain\'s hyperparameter-tuning practice into an explicit protocol: start from a baseline, separate scientific from nuisance hyperparameters, and iterate through deliberately designed tuning rounds.',
                author: 'Varun Godbole, George E. Dahl, Justin Gilmer, Christopher J. Shallue, and Zachary Nado',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developers.google.com&sz=128',
                category: 'Research Craft',
                tags: ['Hyperparameter Tuning', 'Deep Learning', 'Experimental Protocol', 'Best Practices'],
                readTime: '60 min read',
                ...
                coverImage: 'assets/img/covers/real/google-deep-learning-tuning-playbook.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'google-rules-of-machine-learning',
                title: 'Rules of Machine Learning: Best Practices for ML Engineering',
                excerpt: 'Zinkevich\'s 43 rules stage ML engineering discipline from \'launch without ML if you can\' through feature engineering to refinement, with hard-won guidance on metrics, training-serving skew, and keeping the first pipeline simple.',
                author: 'Martin Zinkevich',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developers.google.com&sz=128',
                category: 'Research Craft',
                tags: ['ML Engineering', 'Best Practices', 'Training-Serving Skew', 'Pipelines'],
                readTime: '45 min read',
                publishDate: '2018-01-01',
                sourceName: 'Google for Developers',
                url: 'https://developers.google.com/machine-learning/guides/rules-of-ml/',
                coverImage: 'assets/img/covers/real/google-rules-of-machine-learning.png',
                coverAlt: 'Real cover from manual:original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'eugene-yan-how-to-test-machine-learning',
                title: 'How to Test Machine Learning Code and Systems',
                excerpt: 'Eugene Yan separates ML testing into checks for correct implementation, expected learned behaviour, and satisfactory performance, with runnable pre-train and post-train tests for invariance, directional expectations, and gradient sanity.',
                author: 'Eugene Yan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=eugeneyan.com&sz=128',
                category: 'Research Craft',
                tags: ['ML Testing', 'Reproducibility', 'Model Evaluation', 'Engineering Practice'],
                readTime: '15 min read',
                publishDate: '2020-09-06',
                sourceName: 'eugeneyan.com',
                url: 'https://eugeneyan.com/writing/testing-ml/',
                coverImage: 'assets/img/covers/real/eugene-yan-how-to-test-machine-learning.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'eugene-yan-maintaining-machine-learning-in-production',
                title: 'A Practical Guide to Maintaining Machine Learning in Production',
                excerpt: 'A checklist-driven tour of the unglamorous half of ML — monitoring data quality after deployment, deciding retraining cadence, breaking feedback loops, and paying down the pipeline complexity that accumulates in production systems.',
                author: 'Eugene Yan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=eugeneyan.com&sz=128',
                category: 'Research Craft',
                tags: ['MLOps', 'Production ML', 'Monitoring', 'Technical Debt'],
                readTime: '15 min read',
                publishDate: '2020-05-25',
                sourceName: 'eugeneyan.com',
                url: 'https://eugeneyan.com/writing/practical-guide-to-maintaining-machine-learning/',
                coverImage: 'assets/img/covers/real/eugene-yan-maintaining-machine-learning-in-production.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'From ML@CMU\'s research-practice series: a taxonomy of reproducibility failures in machine learning and a checklist covering data and code release, random seeds, run counts, and variance reporting that authors and reviewers can apply directly.',
                author: 'Zihao Ding, Aniketh Reddy, and Aparna Joshi',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=blog.ml.cmu.edu&sz=128',
                category: 'Research Craft',
                tags: ['Reproducibility', 'Research Methodology', 'Variance Reporting', 'Open Science'],
                readTime: '12 min read',
                publishDate: '2020-08-31',
                sourceName: 'ML@CMU Blog',
                url: 'https://blog.ml.cmu.edu/2020/08/31/5-reproducibility/',
                coverImage: 'assets/img/covers/real/cmu-ml-blog-reproducibility.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'distill-how-to-use-tsne-effectively',
                title: 'How to Use t-SNE Effectively',
                excerpt: 'Wattenberg, Viégas, and Johnson\'s interactive Distill essay demonstrates how perplexity and iteration count reshape t-SNE plots, and why cluster sizes and inter-cluster distances in the projection usually cannot be trusted.',
                author: 'Martin Wattenberg, Fernanda Viégas, and Ian Johnson',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'Research Craft',
                tags: ['t-SNE', 'Visualization', 'Dimensionality Reduction', 'Interpretation Pitfalls'],
                readTime: '12 min read',
                publishDate: '2016-10-13',
                sourceName: 'Distill',
                url: 'https://distill.pub/2016/misread-tsne/',
                coverImage: 'assets/img/covers/real/distill-how-to-use-tsne-effectively.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'openai-how-evals-drive-the-next-chapter-in-ai',
                title: 'How evals drive the next chapter in AI for businesses',
                excerpt: 'OpenAI\'s Applied Evals and Economic Research teams argue that contextual evals — specified, measured, and improved against a specific workflow — are what turn frontier model capability into dependable deployed systems.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Research Craft',
                tags: ['Evals', 'Contextual Evaluation', 'AI Deployment', 'Measurement'],
                readTime: '10 min read',
                publishDate: '2025-11-19',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/evals-drive-next-chapter-of-ai/',
                coverImage: 'assets/img/covers/real/openai-how-evals-drive-the-next-chapter-in-ai.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'epoch-ai-can-ai-scaling-continue-through-2030',
                title: 'Can AI scaling continue through 2030?',
                excerpt: 'Epoch AI quantifies four constraints on continued scale-up — power, chip manufacturing, data scarcity, and the latency wall — and concludes that training runs of 2e29 FLOP, a GPT-2-to-GPT-4-sized leap beyond today, look feasible by 2030.',
                author: 'Jaime Sevilla et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['Scaling', 'Compute', 'Power Constraints', 'AI Forecasting'],
                readTime: '40 min read',
                publishDate: '2024-08-20',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/can-ai-scaling-continue-through-2030',
                coverImage: 'assets/img/covers/real/epoch-ai-can-ai-scaling-continue-through-2030.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'epoch-ai-have-ai-capabilities-accelerated',
                title: 'Have AI Capabilities Accelerated?',
                excerpt: 'Epoch AI fits trend breaks to four capability metrics to test whether AI progress has sped up: three of the four show strong evidence of acceleration, driven primarily by the rise of reasoning models.',
                author: 'Jean-Stanislas Denain et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['AI Progress', 'Capability Trends', 'Reasoning Models', 'Trend Analysis'],
                readTime: '20 min read',
                publishDate: '2026-04-16',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/have-ai-capabilities-accelerated',
                coverImage: 'assets/img/covers/real/epoch-ai-have-ai-capabilities-accelerated.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'epoch-ai-training-compute-grows-4-5x-per-year',
                title: 'Training compute of frontier AI models grows by 4-5x per year',
                excerpt: 'Using Epoch\'s expanded database of notable models, this report establishes that frontier training compute has grown 4-5x per year since 2010, a rate that holds across frontier models, language models, and leading labs alike.',
                author: 'Jaime Sevilla et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['Training Compute', 'Scaling Trends', 'Frontier Models', 'Data Analysis'],
                readTime: '12 min read',
                publishDate: '2024-05-28',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/training-compute-of-frontier-ai-models-grows-by-4-5x-per-year',
                coverImage: 'assets/img/covers/real/epoch-ai-training-compute-grows-4-5x-per-year.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'epoch-ai-power-demands-of-frontier-ai-training',
                title: 'How much power will frontier AI training demand in 2030?',
                excerpt: 'Josh You projects the power demands of frontier training: draw is growing by more than 2x per year and is on trend to require multiple gigawatts — and eventually distributed, multi-site runs — by 2030.',
                author: 'Josh You',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['Power Demand', 'AI Infrastructure', 'Data Centers', 'Forecasting'],
                readTime: '15 min read',
                publishDate: '2025-08-11',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/power-demands-of-frontier-ai-training',
                coverImage: 'assets/img/covers/real/epoch-ai-power-demands-of-frontier-ai-training.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Colin Raffel uses the parable of the Boeing 747 and supersonic flight to ask whether language models are nearing a \'good enough\' plateau, where cost, reliability, and convenience — not peak capability — determine which systems endure.',
                author: 'Colin Raffel',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Frontier',
                tags: ['AI Progress', 'Capability Plateaus', 'Language Models', 'Research Perspective'],
                readTime: '7 min read',
                publishDate: '2026-07-16',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/craffel/when-will-language-models-be-good-enough',
                coverImage: 'assets/img/covers/real/colin-raffel-when-will-language-models-be-good-enough.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'mishig-two-years-of-local-ai-on-a-laptop',
                title: 'Two Years of Local AI on a Laptop: When Open Models Outpaced Moore\'s Law',
                excerpt: 'With MacBook memory stuck at 128 GB from 2024 to 2026, this analysis tracks six snapshots of the best open model runnable on one laptop, showing local intelligence scores jumping from 3 to 50 through sparse MoE and quantization rather than hardware.',
                author: 'Mishig Davaadorj',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Frontier',
                tags: ['Open Models', 'Local Inference', 'Quantization', 'Capability Trends'],
                readTime: '15 min read',
                publishDate: '2026-05-11',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/mishig/local-moores-law',
                coverImage: 'assets/img/covers/real/mishig-two-years-of-local-ai-on-a-laptop.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'Mistral\'s first embodied model: an 8B network that follows plain-language routes from a single RGB camera, hitting 76.6% on R2R-CE validation unseen — beating depth- and multi-camera systems — with pointing-based actions and online reinforcement learning.',
                author: 'Mistral AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=mistral.ai&sz=128',
                category: 'Frontier',
                tags: ['Embodied AI', 'Robot Navigation', 'Vision-Language Models', 'Reinforcement Learning'],
                readTime: '8 min read',
                publishDate: '2026-07-08',
                sourceName: 'Mistral AI News',
                url: 'https://mistral.ai/news/robostral-navigate/',
                coverImage: 'assets/img/covers/real/mistral-robostral-navigate.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'stanford-hai-2026-ai-index-report',
                title: 'The 2026 AI Index Report',
                excerpt: 'The ninth AI Index compiles independently sourced data across nine chapters — from R&D and technical performance to policy and public opinion — documenting a year in which capabilities advanced faster than our ability to measure and manage them.',
                author: 'Stanford HAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hai.stanford.edu&sz=128',
                category: 'Frontier',
                tags: ['AI Index', 'Annual Report', 'AI Policy', 'Measurement'],
                readTime: '20 min read',
                publishDate: '2026-04-13',
                sourceName: 'Stanford HAI',
                url: 'https://hai.stanford.edu/ai-index/2026-ai-index-report',
                coverImage: 'assets/img/covers/real/stanford-hai-2026-ai-index-report.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'The second International AI Safety Report, led by Yoshua Bengio with over 100 experts and backed by more than 30 countries, synthesizes the scientific evidence on general-purpose AI capabilities and risks — the largest global collaboration on AI safety to date.',
                author: 'Yoshua Bengio et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=internationalaisafetyreport.org&sz=128',
                category: 'Frontier',
                tags: ['AI Safety', 'International Governance', 'Scientific Assessment', 'General-Purpose AI'],
                readTime: '30 min read',
                ...
                coverImage: 'assets/img/covers/real/international-ai-safety-report-2026.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                ...
                excerpt: 'AISI\'s first public trends report aggregates two years of evaluations across more than 30 frontier systems, finding some capabilities doubling every eight months, cyber task success rising from 10% to 50%, and universal jailbreaks in every system tested.',
                author: 'UK AI Security Institute',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=aisi.gov.uk&sz=128',
                category: 'Frontier',
                tags: ['Frontier Evals', 'Capability Trends', 'AI Security', 'Government Research'],
                readTime: '25 min read',
                publishDate: '2025-12-18',
                sourceName: 'UK AISI',
                url: 'https://www.aisi.gov.uk/frontier-ai-trends-report',
                coverImage: 'assets/img/covers/real/uk-aisi-frontier-ai-trends-report.webp',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'gen-1-5-generalist-ai',
                title: 'GEN-1.5',
                excerpt: 'Generalist AI presents GEN-1.5, an embodied foundation model focused on one-shot learning and broader generalization from minimal task exposure.',
                author: 'Generalist AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=generalistai.com&sz=128',
                category: 'Foundation Model',
                tags: ['GEN-1.5', 'Embodied AI', 'One-shot Learning', 'Foundation Model'],
                readTime: '8 min read',
                publishDate: '2026-08-24',
                sourceName: 'Generalist AI',
                url: 'https://generalistai.com/blog/gen-1.5',
                coverImage: 'assets/img/covers/real/gen-1.5.png',
                coverAlt: 'GEN-1.5 article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepseek-harness',
                title: 'DeepSeek Harness',
                excerpt: 'DeepSeek releases a developer-preview agent harness that makes models, tools, sessions, sandboxes, storage, and UI layers swappable and composable.',
                author: 'DeepSeek',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepseek.com&sz=128',
                category: 'AI Agents',
                tags: ['DeepSeek Harness', 'Agent Harness', 'Tool Use', 'Developer Preview'],
                readTime: '9 min read',
                publishDate: '2026-08-24',
                sourceName: 'DeepSeek',
                url: 'https://www.deepseek.com/harness/en/',
                coverImage: 'assets/img/covers/real/deepseek-harness.png',
                coverAlt: 'DeepSeek Harness developer preview cover',
                coverFit: 'cover'
            },
            {
                id: 'mureka-v9-5',
                title: 'Mureka V9.5',
                excerpt: 'Mureka updates its music generation stack with stronger prompt control, richer creative direction, and a more polished workflow for song creation.',
                author: 'Mureka',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=mureka.ai&sz=128',
                category: 'Multimodal Model',
                tags: ['Mureka V9.5', 'Music Generation', 'Audio', 'Creative Tools'],
                readTime: '8 min read',
                publishDate: '2026-08-24',
                sourceName: 'Mureka',
                url: 'https://www.mureka.ai/mureka-9-5',
                coverImage: 'assets/img/covers/real/mureka.png',
                coverAlt: 'Mureka V9.5 launch cover',
                coverFit: 'cover'
            },
            {
                id: 'minimax-design',
                title: 'MiniMax Design',
                excerpt: 'MiniMax Design presents a visual design experience centered on semantic layout, high-level composition, and faster creative iteration.',
                author: 'MiniMax',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=design.minimax.io&sz=128',
                category: 'Visual Generation',
                tags: ['MiniMax Design', 'Design Tools', 'Image Generation', 'Creative AI'],
                readTime: '7 min read',
                publishDate: '2026-08-24',
                sourceName: 'MiniMax Design',
                url: 'https://design.minimax.io/',
                coverImage: 'assets/img/covers/real/minimax-design.png',
                coverAlt: 'MiniMax Design launch cover',
                coverFit: 'cover'
            },
            {
                id: 'glm-5-3-z-ai',
                title: 'GLM-5.3',
                excerpt: 'Z.ai introduces GLM-5.3, a frontier coding model with emergent cyber capabilities and a stronger agent-oriented tooling story.',
                author: 'Z.ai',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=z.ai&sz=128',
                category: 'Foundation Model',
                tags: ['GLM-5.3', 'Coding', 'Cyber Capabilities', 'Foundation Model'],
                readTime: '10 min read',
                publishDate: '2026-08-19',
                sourceName: 'Z.ai',
                url: 'https://z.ai/blog/glm-5.3',
                coverImage: 'assets/img/covers/real/glm-5.3.png',
                coverAlt: 'GLM-5.3 launch cover',
                coverFit: 'cover'
            },
            {
                id: 'google-gemini-3-7-flash',
                title: 'Introducing Gemini 3.7 Flash',
                excerpt: 'Google introduces Gemini 3.7 Flash as its most intelligent workhorse model yet, emphasizing stronger coding and agent performance for production workloads.',
                author: 'Tulsee Doshi',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=blog.google&sz=128',
                category: 'Foundation Model',
                tags: ['Gemini 3.7 Flash', 'Coding', 'AI Agents', 'Model Release'],
                readTime: '8 min read',
                publishDate: '2026-08-17',
                sourceName: 'Google Blog',
                url: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-gemini-3-7-flash/',
                coverImage: 'assets/img/covers/real/google_flash3.7.jpg',
                coverAlt: 'Gemini 3.7 Flash article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-ten-advances-in-mathematics',
                title: 'Ten Advances in Mathematics',
                excerpt: 'OpenAI highlights ten mathematics advances connected to AI-assisted reasoning and research, showing how frontier models are beginning to support mathematical discovery workflows.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'LLM & MLLM',
                tags: ['Mathematics', 'Reasoning', 'AI for Science', 'Research Progress'],
                readTime: '10 min read',
                publishDate: '2026-08-17',
                sourceName: 'OpenAI',
                url: 'https://openai.com/zh-Hans-CN/index/ten-advances-in-mathematics/',
                coverImage: 'assets/img/covers/real/ten-advances-in-mathematics.jpg',
                coverAlt: 'OpenAI ten advances in mathematics article cover',
                coverFit: 'cover'
            },
            {
                id: 'thinking-machines-inkling-small',
                title: 'Introducing Inkling-Small',
                excerpt: 'Thinking Machines Lab introduces Inkling-Small, an open-weights multimodal mixture-of-experts model that matches Inkling at a quarter of the size and supports controllable reasoning effort.',
                author: 'Thinking Machines Lab',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=thinkingmachines.ai&sz=128',
                category: 'Foundation Model',
                tags: ['Inkling-Small', 'Open Weights', 'Multimodal', 'Mixture of Experts'],
                readTime: '14 min read',
                publishDate: '2026-08-17',
                sourceName: 'Thinking Machines Lab',
                url: 'https://thinkingmachines.ai/news/inkling-small/',
                coverImage: 'assets/img/covers/real/link_small.jpg',
                coverAlt: 'Inkling-Small article cover',
                coverFit: 'cover'
            },
            {
                id: 'ken-ashe-sparse-weight-decomposition-circuit-extraction',
                title: 'Sparse Weight Decomposition Makes Circuit Extraction Less Expensive',
                excerpt: 'Ken Ashe explains Sparse Weight Decomposition, a method for exposing circuit units inside dense transformer weights without training a separate replacement model, reducing data needs while staying close to the original network.',
                author: 'Ken Ashe',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=kenashe.ai&sz=128',
                category: 'Trustworthy AI',
                tags: ['Mechanistic Interpretability', 'Circuit Extraction', 'Sparse Decomposition', 'Transformers'],
                readTime: '8 min read',
                publishDate: '2026-08-17',
                sourceName: 'Ken Ashe | AI Optimist',
                url: 'https://kenashe.ai/blog/2026-08-05-sparse-weight-decomposition-makes-circuit-extraction-less-expensive/',
                coverImage: 'assets/img/covers/real/sparse-weight-decomposition-makes-circuit-extraction-less-expensive.jpg',
                coverAlt: 'Sparse Weight Decomposition article cover',
                coverFit: 'cover'
            },
            {
                id: 'normaltech-ai-agents-cant-yet-do-open-ended-ai-research',
                title: 'AI agents can\'t yet do open-ended AI research',
                excerpt: 'Sayash Kapoor and Arvind Narayanan analyze early evidence from two case studies, arguing that current frontier agents still struggle with open-ended AI research despite progress on more verifiable tasks.',
                author: 'Sayash Kapoor and Arvind Narayanan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=normaltech.ai&sz=128',
                category: 'AI Agents',
                tags: ['Open-Ended Research', 'Agent Evaluation', 'AI Research Automation', 'Recursive Self-Improvement'],
                readTime: '7 min read',
                publishDate: '2026-08-17',
                sourceName: 'AI as Normal Technology',
                url: 'https://www.normaltech.ai/p/ai-agents-cant-yet-do-open-ended',
                coverImage: 'assets/img/covers/real/ai-agents-cant-yet-do-open-ended.png',
                coverAlt: 'AI agents open-ended research article cover',
                coverFit: 'cover'
            },
            {
                id: '01-research-interaction-scaling',
                title: 'Interaction Scaling',
                excerpt: 'A research exploration of interaction scaling and how increasing iterative exchanges between models, tools, environments, or users can unlock additional capability.',
                author: '01 Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=01.me&sz=128',
                category: 'Foundation Model',
                tags: ['Interaction Scaling', 'Reasoning', 'Test-Time Compute', 'Model Capability'],
                readTime: '10 min read',
                publishDate: '2026-08-10',
                sourceName: '01 Research',
                url: 'https://01.me/research/interaction-scaling/#idea',
                coverImage: 'assets/img/covers/real/What if the model could check its work — and why you’d never know it helped.png',
                coverAlt: 'Real article cover downloaded from the source page',
                coverFit: 'cover'
            },
            {
                ...
                author: 'Ruhan Wang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=ruhan-wang.github.io&sz=128',
                category: 'AI Agents',
                tags: ['Agent Harnesses', 'Coding Agents', 'Tool Use', 'Evaluation'],
                readTime: '15 min read',
                publishDate: '2026-08-10',
                sourceName: 'Ruhan Wang',
                url: 'https://ruhan-wang.github.io/Harness-Handbook/',
                coverImage: 'assets/img/covers/real/Harness Handbook.png',
                coverAlt: 'Real article cover downloaded from the source page',
                coverFit: 'cover'
            },
            {
                id: 'lesswrong-ai-generated-content-mechanistic-analysis',
                title: 'An Analysis of AI-Generated Content at the Mechanistic Level',
                excerpt: 'A mechanistic investigation of AI-generated content that examines internal model behavior rather than relying only on surface-level output characteristics.',
                author: 'LessWrong Community',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=lesswrong.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Mechanistic Interpretability', 'AI-Generated Content', 'Model Analysis', 'Interpretability'],
                readTime: '12 min read',
                publishDate: '2026-08-10',
                ...
                coverImage: 'assets/img/covers/real/An analysis of AI-generated content at the Mechanistic Interpretability Workshop.png',
                coverAlt: 'Real article cover downloaded from the source page',
                coverFit: 'cover'
            },
            {
                id: 'meta-circle-ophis-autoresearch',
                title: 'Ophis: A New Paradigm for Autoresearch',
                excerpt: 'Meta Circle introduces Ophis and a new autoresearch workflow for using AI systems to explore, execute, and refine research ideas with less manual orchestration.',
                author: 'Meta Circle',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=meta-circle.com&sz=128',
                category: 'AI Agents',
                tags: ['Autoresearch', 'Research Agents', 'Automation', 'Scientific Discovery'],
                readTime: '10 min read',
                publishDate: '2026-08-10',
                sourceName: 'Meta Circle',
                url: 'https://meta-circle.com/blog/ophis-a-new-paradigm-for-autoresearch',
                coverImage: 'assets/img/covers/real/Towards Mechanistic Auto-Research.png',
                coverAlt: 'Real article cover downloaded from the source page',
                coverFit: 'cover'
            },
            {
                id: 'ibm-research-artificial-intelligence',
                title: 'IBM Research — Artificial Intelligence',
                excerpt: 'IBM Research\'s artificial-intelligence index brings together work across foundation models, reasoning, AI for science, chips, and enterprise AI, providing a broad view of frontier research directions.',
                author: 'IBM Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.ibm.com&sz=128',
                category: 'Frontier',
                tags: ['Frontier AI', 'AI Research', 'Foundation Models', 'AI for Science'],
                readTime: '8 min read',
                publishDate: '2026-07-26',
                sourceName: 'IBM Research',
                url: 'https://research.ibm.com/blog?tag=artificial-intelligence',
                coverImage: '',
                coverAlt: 'IBM Research artificial intelligence article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-quantifying-infrastructure-noise-agentic-coding-evals',
                title: 'Quantifying Infrastructure Noise in Agentic Coding Evals',
                excerpt: 'Anthropic quantifies how CPU, memory, storage, and network quotas change coding-agent evaluation scores, showing why infrastructure must be reported as an evaluation variable.',
                author: 'Anthropic / Gian Segato',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'AI Agents',
                tags: ['Coding Agents', 'Evaluation', 'Infrastructure', 'Reproducibility'],
                readTime: '10 min read',
                publishDate: '2026-02-05',
                sourceName: 'Anthropic Engineering',
                url: 'https://www.anthropic.com/engineering/infrastructure-noise',
                coverImage: '',
                coverAlt: 'Infrastructure noise in agentic coding evaluations article cover',
                coverFit: 'cover'
            },
            {
                id: 'meta-open-sourcing-touch-representations-robot-dexterity',
                title: 'Open-Sourcing Touch Representations and Models for Robot Dexterity',
                excerpt: 'Meta AI open-sources touch representations and models that help robots perceive contact and improve dexterous manipulation, expanding the foundation-model toolkit for embodied intelligence.',
                author: 'Meta AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=ai.meta.com&sz=128',
                category: 'World Model',
                tags: ['Robotics', 'Tactile Sensing', 'Dexterous Manipulation', 'Embodied AI'],
                readTime: '8 min read',
                publishDate: '2025-01-01',
                sourceName: 'Meta AI',
                url: 'https://ai.meta.com/blog/fair-robotics-open-source/',
                coverImage: '',
                coverAlt: 'Robot dexterity article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-vila-visual-language-models',
                title: 'Visual Language Models on NVIDIA Hardware with VILA',
                excerpt: 'NVIDIA and MIT introduce VILA and walk through visual-language model training, multi-image and video question answering, and efficient AWQ deployment on NVIDIA hardware.',
                author: 'NVIDIA & MIT',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Multimodal Model',
                tags: ['VILA', 'Vision Language Models', 'Video Understanding', 'AWQ'],
                readTime: '9 min read',
                publishDate: '2024-05-03',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/visual-language-models-on-nvidia-hardware-with-vila/',
                coverImage: '',
                coverAlt: 'VILA visual language model article cover',
                coverFit: 'cover'
            },
            {
                id: 'hugging-face-mixture-of-experts-explained',
                title: 'Mixture of Experts Explained',
                excerpt: 'Hugging Face explains the core ideas behind mixture-of-experts language models, including sparse routing, expert capacity, load balancing, and the trade-offs of scaling conditional computation.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'LLM & MLLM',
                tags: ['Mixture of Experts', 'Sparse Models', 'Transformers', 'Model Architecture'],
                readTime: '10 min read',
                publishDate: '2023-01-01',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/moe',
                coverImage: '',
                coverAlt: 'Mixture of Experts Explained article cover',
                coverFit: 'cover'
            },
            {
                id: 'codelion-1-billion-token-challenge',
                title: 'The 1 Billion Token Challenge: Finding the Perfect Pre-training Mix',
                excerpt: 'CodeLion reports more than 50 controlled experiments on data mixtures and curriculum strategies for pre-training, releasing the recipes and artifacts behind a one-billion-token challenge.',
                author: 'Asankhaya Sharma / CodeLion',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Foundation Model',
                tags: ['Pre-training', 'Data Mixtures', 'Language Models', 'Open Research'],
                readTime: '12 min read',
                publishDate: '2025-11-03',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/codelion/optimal-dataset-mixing',
                coverImage: '',
                coverAlt: 'The 1 Billion Token Challenge article cover',
                coverFit: 'cover'
            },
            {
                id: 'lightonai-mdenseon-mlateon',
                title: 'mDenseOn with the mLateOn: Open Multilingual, Long-Context, and Code Retrieval Models',
                excerpt: 'LightOn AI releases mDenseOn and mLateOn, open multilingual retrieval models built for long-context and code search across dense and late-interaction architectures.',
                author: 'LightOn AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['Retrieval', 'Multilingual Models', 'Long Context', 'Code Search'],
                readTime: '10 min read',
                publishDate: '2026-08-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/lightonai/mdenseon-mlateon',
                coverImage: 'assets/img/covers/real/mDenseOn with the mLateOn- Open Multilingual, Long-Context, and Code Retrieval Models.png',
                coverAlt: 'mDenseOn and mLateOn article cover',
                coverFit: 'cover'
            },
            {
                id: 'jinaai-jina-reranker-v3-5-faster-listwise-reranking',
                title: 'jina-reranker-v3.5: Faster Listwise Reranking with Hybrid Attention and Self-Distillation',
                excerpt: 'Jina AI presents jina-reranker-v3.5, improving listwise retrieval reranking speed and quality with hybrid attention and self-distillation.',
                author: 'Jina AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['Reranking', 'Information Retrieval', 'Hybrid Attention', 'Distillation'],
                readTime: '9 min read',
                publishDate: '2026-08-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/jinaai/jina-reranker-v3-5-faster-listwise-reranking',
                coverImage: 'assets/img/covers/real/jina-reranker-v3.5- Faster Listwise Reranking with Hybrid Attention and Self-Distillation.png',
                coverAlt: 'jina-reranker-v3.5 article cover',
                coverFit: 'cover'
            },
            {
                id: 'liquidai-lfm2-5-2-6b',
                title: 'Deploy local agents everywhere with LFM2.5-2.6B',
                excerpt: 'Liquid AI introduces LFM2.5-2.6B, a compact multimodal language model designed to bring capable local agents to more devices and deployment environments.',
                author: 'Liquid AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Foundation Model',
                tags: ['LFM2.5', 'Small Language Models', 'Local AI', 'Agents'],
                readTime: '8 min read',
                publishDate: '2026-08-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/LiquidAI/lfm2-5-2-6b',
                coverImage: 'assets/img/covers/real/Deploy local agents everywhere with LFM2.5-2.6B.png',
                coverAlt: 'LFM2.5-2.6B article cover',
                coverFit: 'cover'
            },
            {
                id: 'sergiopaniego-trl-openenv-harness-training',
                title: 'Training a coding agent using the OpenCode harness in remote HF sandboxes with TRL and OpenEnv',
                excerpt: 'Sergio Paniego shows how to train a coding agent with the OpenCode harness in remote Hugging Face sandboxes, combining TRL and OpenEnv for reproducible agent training workflows.',
                author: 'Sergio Paniego',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'AI Agents',
                tags: ['Coding Agents', 'TRL', 'OpenEnv', 'Reinforcement Learning'],
                readTime: '10 min read',
                publishDate: '2026-08-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/sergiopaniego/trl-openenv-harness-training',
                coverImage: 'assets/img/covers/real/Training a coding agent using the OpenCode harness in remote HF sandboxes with TRL and OpenEnv.png',
                coverAlt: 'OpenCode harness training article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-chatgpt-for-academic-researchers',
                title: 'Accelerating scientific discovery with ChatGPT for Academic Researchers',
                excerpt: 'OpenAI introduces ChatGPT for Academic Researchers, a program giving selected academic researchers free access to frontier models, Codex, expanded deep research, larger context windows, training, and research support.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Research Craft',
                tags: ['ChatGPT', 'Academic Research', 'Scientific Discovery', 'Research Workflows'],
                readTime: '8 min read',
                publishDate: '2026-07-29',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/chatgpt-for-academic-researchers/',
                coverImage: 'assets/img/covers/real/Accelerating scientific discovery with ChatGPT for Academic Researchers.png',
                coverAlt: 'ChatGPT for Academic Researchers article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-scientific-computing-agentic-ai',
                title: 'Scientific computing in the age of agentic AI',
                excerpt: 'OpenAI shares a field report on agent-assisted scientific computing projects, showing how coding agents can modernize research software while leaving verification, stewardship, and scientific judgment with researchers.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'AI Agents',
                tags: ['Agentic AI', 'Scientific Computing', 'Codex', 'Research Software'],
                readTime: '10 min read',
                publishDate: '2026-07-28',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/scientific-computing-agentic-ai/',
                coverImage: 'assets/img/covers/real/Scientific computing in the age of agentic AI.png',
                coverAlt: 'Scientific computing in the age of agentic AI article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-deepmind-gemini-robotics-2-whole-body-intelligence',
                title: 'Gemini Robotics 2 brings whole-body intelligence to robots',
                excerpt: 'Google DeepMind introduces Gemini Robotics 2, extending robot foundation models toward full-body control, dexterous manipulation, embodied reasoning, multi-step tasks, and safer operation across humanoid platforms.',
                author: 'Google DeepMind',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Frontier',
                tags: ['Gemini Robotics', 'Embodied AI', 'Robotics', 'Whole-Body Control'],
                readTime: '7 min read',
                publishDate: '2026-07-31',
                sourceName: 'Google DeepMind',
                url: 'https://deepmind.google/blog/gemini-robotics-2-brings-whole-body-intelligence-to-robots/',
                coverImage: 'assets/img/covers/real/gemini_robo_2.png',
                coverAlt: 'Gemini Robotics 2 article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepseek-ai-deepseek-v4-pro',
                title: 'DeepSeek-V4-Pro',
                excerpt: 'DeepSeek releases DeepSeek-V4-Pro on Hugging Face as a 1.6T-parameter MoE model with 49B activated parameters, one-million-token context, hybrid attention, mHC connections, Muon training, and an MIT license.',
                author: 'DeepSeek-AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepseek.com&sz=128',
                category: 'Frontier',
                tags: ['DeepSeek-V4', 'Long Context', 'Mixture of Experts', 'Open Weights'],
                readTime: '6 min read',
                publishDate: '2026-06-27',
                sourceName: 'Hugging Face',
                url: 'https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro',
                coverImage: 'assets/img/covers/real/deepseek-v4.png',
                coverAlt: 'DeepSeek-V4-Pro model card cover',
                coverFit: 'cover'
            },
            {
                id: 'minimax-minimax-h3-modelscope',
                title: 'MiniMax-H3',
                excerpt: 'MiniMax publishes MiniMax-H3 on ModelScope, adding another frontier Chinese model release to the open model ecosystem and giving practitioners a direct model hub entry for evaluation and deployment.',
                author: 'MiniMax',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=minimax.io&sz=128',
                category: 'Frontier',
                tags: ['MiniMax', 'ModelScope', 'Open Model', 'Frontier Model'],
                readTime: '5 min read',
                publishDate: '2026-07-30',
                sourceName: 'ModelScope',
                url: 'https://modelscope.cn/models/MiniMax/MiniMax-H3/summary',
                coverImage: 'assets/img/covers/real/minimax-hl3.png',
                coverAlt: 'MiniMax-H3 ModelScope cover',
                coverFit: 'cover'
            },
            {
                id: 'black-forest-labs-flux-3-real-world-models',
                title: 'FLUX 3 - Real World Models: Towards Multimodal Flow Models as the Backbone of Visual Intelligence',
                excerpt: 'Black Forest Labs introduces FLUX 3, a multimodal flow model trained jointly across images, video, audio, language, and action prediction, positioning visual generation as a foundation for real-world visual intelligence.',
                author: 'Black Forest Labs',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=bfl.ai&sz=128',
                category: 'Visual Generation',
                tags: ['FLUX 3', 'Multimodal Flow Models', 'Video Generation', 'Physical AI'],
                readTime: '5 min read',
                publishDate: '2026-07-23',
                sourceName: 'Black Forest Labs',
                url: 'https://bfl.ai/blog/flux-3',
                coverImage: 'assets/img/covers/real/flux3.png',
                coverAlt: 'FLUX 3 article cover',
                coverFit: 'cover'
            },
            {
                id: 'codelion-scaling-pedagogical-pre-training-from-optimal-mixing-to-10-billio',
                title: 'Scaling Pedagogical Pre-training: From Optimal Mixing to 10 Billion Tokens',
                ...
                coverImage: 'assets/img/covers/real/a-plus/scaling-pedagogical-pre-training-from-optimal-mixing-to-10-billion-tokens.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'llm360-introducing-llm360-fully-transparent-open-source-llms',
                title: 'Introducing LLM360: Fully Transparent Open-Source LLMs',
                ...
                author: 'LLM360 Team',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=llm360.ai&sz=128',
                category: 'Foundation Model',
                tags: ['Open Source LLMs', 'Training Transparency', 'Datasets', 'Checkpoints'],
                readTime: '10 min read',
                publishDate: '2023-12-11',
                sourceName: 'LLM360',
                url: 'https://www.llm360.ai/news/introducing-llm360-fully-transparent-open-source-llms.html',
                coverImage: 'assets/img/covers/real/a-plus/introducing-llm360-fully-transparent-open-source-llms.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'ai2-blog-investigating-pretraining-dynamics-and-stability-with-olmo-checkp',
                title: 'Investigating pretraining dynamics and stability with OLMo checkpoints',
                ...
                sourceName: 'Ai2 Blog',
                url: 'https://allenai.org/blog/investigating-pretraining-dynamics-and-stability-with-olmo-checkpoints-ece6f0c4947a',
                coverImage: 'assets/img/covers/real/a-plus/investigating-pretraining-dynamics-and-stability-with-olmo-checkpoints.jpg',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'minimax-blog-internal-investigation-of-sparse-token-forgetting',
                title: 'Internal Investigation of Sparse Token Forgetting',
                ...
                coverImage: 'assets/img/covers/real/a-plus/internal-investigation-of-sparse-token-forgetting.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'hazy-research-efficient-language-models-as-arithmetic-circuits',
                title: 'Efficient Language Models as Arithmetic Circuits',
                ...
                coverImage: 'assets/img/covers/real/a-plus/efficient-language-models-as-arithmetic-circuits.jpg',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
                        {
                id: 'hugging-face-blog-vision-language-models-better-faster-stronger',
                ...
                coverImage: 'assets/img/covers/real/a-plus/vision-language-models-better-faster-stronger.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'hugging-face-blog-one-adapter-both-modalities-field-notes-from-building-an',
                ...
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/lightonai/lighton-rerank',
                coverImage: 'assets/img/covers/real/a-plus/one-adapter-both-modalities-field-notes-from-building-and-serving-a-multim.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'sander-dieleman-generative-modelling-in-latent-space',
                ...
                coverImage: 'assets/img/covers/real/a-plus/generative-modelling-in-latent-space.jpg',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'yang-song-generative-modeling-by-estimating-gradients-of-the-data-distribu',
                ...
                author: 'Yang Song',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=yang-song.net&sz=128',
                category: 'Visual Generation',
                ...
                coverImage: 'assets/img/covers/real/a-plus/generative-modeling-by-estimating-gradients-of-the-data-distribution.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'google-research-blog-bringing-3d-shoppable-products-online-with-generative',
                ...
                coverImage: 'assets/img/covers/real/a-plus/bringing-3d-shoppable-products-online-with-generative-ai.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                                    {
                id: 'ai2-blog-molmomotion-language-guided-3d-motion-forecasting',
                ...
                coverImage: 'assets/img/covers/real/a-plus/molmomotion-language-guided-3d-motion-forecasting.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                                    {
                id: 'hugging-face-blog-continuous-batching-from-first-principles',
                ...
                coverImage: 'assets/img/covers/real/a-plus/continuous-batching-from-first-principles.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-technical-blog-run-high-performance-llm-inference-kernels-from-nvid',
                ...
                coverImage: 'assets/img/covers/real/a-plus/run-high-performance-llm-inference-kernels-from-nvidia-using-flashinfer.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'pytorch-blog-training-moes-at-scale-with-pytorch',
                ...
                url: 'https://pytorch.org/blog/training-moes/',
                coverImage: 'assets/img/covers/real/a-plus/training-moes-at-scale-with-pytorch.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'vllm-blog-a-first-comprehensive-study-of-turboquant-accuracy-and-performan',
                ...
                coverImage: 'assets/img/covers/real/a-plus/a-first-comprehensive-study-of-turboquant-accuracy-and-performance.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'modal-docs-high-performance-llm-inference',
                ...
                url: 'https://modal.com/docs/guide/high-performance-llm-inference',
                coverImage: 'assets/img/covers/real/a-plus/high-performance-llm-inference.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                                    {
                id: 'microsoft-research-blog-zero-and-deepspeed-new-system-optimizations-enable',
                ...
                coverImage: 'assets/img/covers/real/a-plus/zero-and-deepspeed-new-system-optimizations-enable-training-models-with-ov.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'pytorch-blog-introducing-pytorch-fully-sharded-data-parallel-fsdp-api',
                ...
                coverImage: 'assets/img/covers/real/a-plus/introducing-pytorch-fully-sharded-data-parallel-fsdp-api.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
                                                {
                id: 'anthropic-alignment-agentic-misalignment-in-summer-2026',
                ...
                authorAvatar: 'https://www.google.com/s2/favicons?domain=alignment.anthropic.com&sz=128',
                category: 'Trustworthy AI',
                ...
                coverImage: 'assets/img/covers/real/a-plus/agentic-misalignment-in-summer-2026.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'uk-aisi-blog-cheating-behaviour-in-frontier-model-evaluations',
                ...
                coverImage: 'assets/img/covers/real/cheating-behaviour-in-frontier-model-evaluations.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                        {
                id: 'redwood-research-introducing-linuxarena',
                title: 'Introducing LinuxArena',
                ...
                url: 'https://blog.redwoodresearch.org/p/introducing-linuxarena',
                coverImage: 'assets/img/covers/real/a-plus/introducing-linuxarena.jpg',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'uk-aisi-blog-more-compute-more-capability-why-ai-agent-evaluations-need-to',
                ...
                coverImage: 'assets/img/covers/real/a-plus/more-compute-more-capability-why-ai-agent-evaluations-need-to-account-for-.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'uk-aisi-blog-a-pipeline-for-transcript-analysis-using-inspect-scout',
                title: 'A pipeline for transcript analysis using Inspect Scout',
                ...
                sourceName: 'UK AISI Blog',
                url: 'https://www.aisi.gov.uk/blog/a-pipeline-for-transcript-analysis-using-inspect-scout',
                coverImage: 'assets/img/covers/real/a-plus/a-pipeline-for-transcript-analysis-using-inspect-scout.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                        {
                id: 'hamel-dev-a-field-guide-to-rapidly-improving-ai-products',
                ...
                coverImage: 'assets/img/covers/real/a-plus/a-field-guide-to-rapidly-improving-ai-products.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'eugene-yan-evaluating-the-effectiveness-of-llm-evaluators-aka-llm-as-judge',
                ...
                coverImage: 'assets/img/covers/real/a-plus/evaluating-the-effectiveness-of-llm-evaluators-aka-llm-as-judge.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'google-research-blog-introducing-the-model-card-toolkit-for-easier-model-t',
                ...
                coverImage: 'assets/img/covers/real/a-plus/introducing-the-model-card-toolkit-for-easier-model-transparency-reporting.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'google-research-blog-data-centric-ml-benchmarking-announcing-dataperf-s-20',
                title: 'Data-centric ML benchmarking: Announcing DataPerf’s 2023 challenges',
                ...
                sourceName: 'Google Research Blog',
                url: 'https://research.google/blog/data-centric-ml-benchmarking-announcing-dataperfs-2023-challenges/',
                coverImage: 'assets/img/covers/real/a-plus/data-centric-ml-benchmarking-announcing-dataperf-s-2023-challenges.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'hugging-face-blog-j-space-yet-another-llm-mind-reader',
                ...
                coverImage: 'assets/img/covers/real/a-plus/j-space-yet-another-llm-mind-reader.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'google-deepmind-blog-introducing-gemini-3-5-flash-cyber',
                ...
                coverImage: 'assets/img/covers/real/a-plus/introducing-gemini-3-5-flash-cyber.webp',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'noise-lab-how-to-do-great-research',
                ...
                authorAvatar: 'https://www.google.com/s2/favicons?domain=noise-lab.net&sz=128',
                category: 'How to Research',
                tags: ['Research Training', 'Graduate School', 'Project Design', 'Research Process'],
                readTime: '40 min read',
                publishDate: '2010-01-01',
                sourceName: 'Noise Lab',
                url: 'https://noise-lab.net/research-course/',
                coverImage: 'assets/img/covers/real/a-plus/how-to-do-great-research.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
                        {
                id: 'jacob-steinhardt-research-as-a-stochastic-decision-process',
                ...
                author: 'Jacob Steinhardt',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.stanford.edu&sz=128',
                category: 'How to Research',
                ...
                coverImage: 'assets/img/covers/real/a-plus/research-as-a-stochastic-decision-process.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
                        {
                id: 'denny-britz-replication-issues-in-ai-research',
                title: 'Replication Issues in AI Research',
                ...
                author: 'Denny Britz',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=dennybritz.com&sz=128',
                category: 'How to Research',
                tags: ['Replication', 'AI Research', 'Reproducibility', 'Experimental Practice'],
                readTime: '12 min read',
                publishDate: '2020-01-01',
                sourceName: 'Denny Britz',
                url: 'https://dennybritz.com/posts/ai-replication-issues/',
                coverImage: 'assets/img/covers/real/a-plus/replication-issues-in-ai-research.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
                                    {
                id: 'phd-in-ai-becoming-an-ai-researcher-practical-advice-for-graduate-students',
                title: 'Becoming an AI Researcher: Practical Advice for Graduate Students',
                ...
                authorAvatar: 'https://www.google.com/s2/favicons?domain=phd-in-ai.com&sz=128',
                category: 'How to Research',
                tags: ['AI Research', 'Graduate School', 'Career Advice', 'Research Practice'],
                readTime: '18 min read',
                publishDate: '2026-01-01',
                sourceName: 'PhD in AI',
                url: 'https://www.phd-in-ai.com/',
                coverImage: 'assets/img/covers/real/a-plus/becoming-an-ai-researcher-practical-advice-for-graduate-students.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
                        {
                id: 'microsoft-research-how-to-write-a-great-research-paper',
                ...
                url: 'https://www.microsoft.com/en-us/research/video/how-to-write-a-great-research-paper-4/',
                coverImage: 'assets/img/covers/real/a-plus/how-to-write-a-great-research-paper.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'yuan-huang-good-toy-example-diffusion-models',
                title: 'What Makes a Good Toy Example for Diffusion Models?',
                excerpt: 'Liangyu Yuan and Yufei Huang examine how two-dimensional toy distributions can clarify diffusion and flow-matching behavior while also encoding researcher choices, using Leaves to study guidance, class separation, and within-class structure.',
                author: 'Liangyu Yuan, Yufei Huang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=diffusiontoy.github.io&sz=128',
                category: 'Visual Generation',
                tags: ['Diffusion Models', 'Toy Examples', 'Flow Matching', 'Guidance'],
                readTime: '8 min read',
                publishDate: '2026-07-26',
            ...
            {
                id: 'lilian-harness-engineering-self-improvement',
                title: 'Harness Engineering for Self-Improvement',
                excerpt: 'Lilian Weng studies how external harnesses shape self-improving agent systems, covering verifiers, feedback loops, task environments, data generation, and the practical engineering needed to make iterative improvement measurable.',
                author: 'Lilian Weng',
                authorAvatar: 'https://github.com/lilianweng.png',
                category: 'AI Agents',
                tags: ['Self-Improvement', 'Agent Harnesses', 'Evaluation', 'Feedback Loops'],
                readTime: '25 min read',
                publishDate: '2026-07-04',
                sourceName: 'Lil\'Log',
                url: 'https://lilianweng.github.io/posts/2026-07-04-harness/',
                coverImage: 'assets/img/covers/real/Harness Engineering for Self-Improvement .png',
                coverAlt: 'Harness Engineering for Self-Improvement article cover',
                coverFit: 'cover'
            },
            {
                id: 'lilian-scaling-laws-carefully',
                title: 'Scaling Laws, Carefully',
                excerpt: 'Lilian Weng revisits scaling laws as empirical modeling tools, emphasizing what can and cannot be inferred from power-law fits, dataset quality, compute allocation, evaluation choices, and extrapolation assumptions.',
                author: 'Lilian Weng',
                authorAvatar: 'https://github.com/lilianweng.png',
                category: 'Foundation Model',
                tags: ['Scaling Laws', 'Model Training', 'Compute', 'Empirical AI'],
                readTime: '28 min read',
                publishDate: '2026-06-24',
                sourceName: 'Lil\'Log',
                url: 'https://lilianweng.github.io/posts/2026-06-24-scaling-laws/',
                coverImage: 'assets/img/covers/real/Scaling Laws, Carefully .png',
                coverAlt: 'Scaling Laws, Carefully article cover',
                coverFit: 'cover'
            },
            {
                id: 'feifei-functional-taxonomy-world-models',
                title: 'A Functional Taxonomy of World Models',
                excerpt: 'Fei-Fei Li proposes a functional taxonomy for world models, organizing renderers, simulators, planners, and the feedback loop that connects them across embodied intelligence, video generation, and agent learning.',
                author: 'Fei-Fei Li',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=drfeifei.substack.com&sz=128',
                category: 'World Model',
                tags: ['World Models', 'Embodied AI', 'Representation', 'Planning'],
                readTime: '14 min read',
                publishDate: '2026-06-03',
                sourceName: 'Fei-Fei Li',
                url: 'https://drfeifei.substack.com/p/a-functional-taxonomy-of-world-models',
                coverImage: 'assets/img/covers/real/A Functional Taxonomy of World Models .png',
                coverAlt: 'A Functional Taxonomy of World Models article cover',
                coverFit: 'cover'
            },
            {
            ...
            },
            {
                ...
                excerpt: 'OpenAI describes deployment simulation as a pre-release evaluation method: replaying realistic conversation prefixes with candidate models to estimate deployment-time failures, reduce evaluation awareness, and test agentic tool-use trajectories.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Deployment Simulation', 'Model Evaluation', 'Safety', 'Agent Evals'],
                readTime: '22 min read',
                publishDate: '2026-06-16',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/deployment-simulation/',
                coverImage: 'assets/img/covers/real/openai-deployment-simulation.png',
                coverAlt: 'Real cover from OpenAI article diagram rendered as PNG',
                coverFit: 'cover'
            },
            {
                id: 'google-machine-unlearning-audit',
                title: 'New Framework for Auditing Machine Unlearning',
                excerpt: 'Mónica Ribero introduces a black-box auditing approach for machine unlearning, using statistically grounded two-sample testing to verify whether a model has actually forgotten targeted training data.',
                author: 'Mónica Ribero',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Machine Unlearning', 'Auditing', 'Privacy', 'Two-Sample Testing'],
                readTime: '10 min read',
            ...
            {
                id: 'google-agentic-rag-sufficient-context',
                title: 'Unlocking Dependable Responses with Gemini Enterprise Agent Platform’s Agentic RAG',
                excerpt: 'Google Research explains an agentic RAG design that plans, rewrites, routes, and iteratively retrieves until a sufficient-context judge decides the evidence can support a grounded answer.',
                author: 'Cyrus Rashtchian and Da-Cheng Juan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'AI Agents',
                tags: ['Agentic RAG', 'Retrieval', 'Grounding', 'Sufficient Context'],
                readTime: '14 min read',
            ...
            {
                id: 'huggingface-olmo-eval-workbench',
                title: 'olmo-eval: An Evaluation Workbench for the Model Development Loop',
                excerpt: 'Ai2 and Hugging Face present olmo-eval as an evaluation stack built for iterative model development, tracking interventions across data, architecture, hyperparameters, scale, and reproducible benchmark configuration.',
                author: 'Tyler Murray, Ai2 and Kyle Wiggers',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Research Craft',
                tags: ['Model Evaluation', 'OLMo', 'Benchmarking', 'Reproducibility'],
                readTime: '8 min read',
                publishDate: '2026-06-12',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/allenai/olmo-eval',
                coverImage: 'https://cdn-uploads.huggingface.co/production/uploads/638e39b249de7ae552d977b5/gacAOFYwPkpxu7cC4eeey.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'sebastian-llm-architecture-kv-compression',
                title: 'Recent Developments in LLM Architectures: KV Sharing, mHC, and Compressed Attention',
                excerpt: 'Sebastian Raschka compares recent open-weight LLM architecture changes, focusing on how KV sharing, per-layer embeddings, attention budgeting, and compressed attention reduce long-context inference costs.',
                author: 'Sebastian Raschka',
                authorAvatar: 'https://sebastianraschka.com/images/logos/photo-2021-08-25_compressed.jpg',
                category: 'Foundation Model',
                tags: ['LLM Architecture', 'KV Cache', 'Compressed Attention', 'Long Context'],
                readTime: '25 min read',
                publishDate: '2026-05-16',
                sourceName: 'Ahead of AI',
                url: 'https://magazine.sebastianraschka.com/p/recent-developments-in-llm-architectures',
                coverImage: 'https://substackcdn.com/image/fetch/$s_!6wCM!,w_1200,h_675,c_fill,f_jpg,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2b841d26-5b2d-4be9-9710-d89d4f023f0c_1600x900.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-continuous-batching-async',
                title: 'Unlocking Asynchronicity in Continuous Batching',
                excerpt: 'Rémi Ouazan Reboul, Pedro Cuenca, and Aritra Roy Gosthipaty show how asynchronous CPU/GPU scheduling, CUDA streams, and event coordination remove idle gaps in continuous batching for faster LLM inference.',
                author: 'Rémi Ouazan Reboul, Pedro Cuenca, Aritra Roy Gosthipaty',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['LLM Inference', 'Continuous Batching', 'CUDA Streams', 'Throughput'],
                readTime: '18 min read',
                publishDate: '2026-05-14',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/continuous_async',
                coverImage: 'https://huggingface.co/blog/assets/continuous_async/thumbnail.png',
                coverAlt: 'Real cover from twitter:image',
                coverFit: 'cover'
            },
            {
                id: 'google-reasoningbank-agent-memory',
                title: 'ReasoningBank: Enabling Agents to Learn from Experience',
                excerpt: 'Jun Yan and Chen-Yu Lee explain ReasoningBank, an agent memory framework that distills reusable strategies from successful and failed trajectories, then uses memory-aware test-time scaling to improve future agent behavior.',
                author: 'Jun Yan and Chen-Yu Lee',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'AI Agents',
                tags: ['Agent Memory', 'Test-Time Scaling', 'ReasoningBank', 'SWE-Bench'],
                readTime: '14 min read',
            ...
            {
                id: 'bai-verbalization-overinterpretation',
                title: 'Prediction, Explanation, or Over-interpretation?',
                excerpt: 'Xiaoyan Bai and collaborators compare self-report, activation-oracle, and natural-language-autoencoder verbalization methods, showing why verbal explanations of model internals need behavioral grounding before they are treated as faithful evidence.',
                author: 'Xiaoyan Bai, Tianze Hua, Yichen Wang, Tianyang Xu, Mina Lee, Ellie Pavlick, Chenhao Tan',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=elena-baixy.github.io&sz=128',
                category: 'Trustworthy AI',
                tags: ['Interpretability', 'Model Internals', 'Evaluation Awareness', 'Verbalization'],
                readTime: '16 min read',
                publishDate: '2026-06-01',
                sourceName: 'Xiaoyan Bai',
                url: 'https://elena-baixy.github.io/verbalization.html',
                coverImage: 'https://elena-baixy.github.io/verbalization_blog/hero.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-scaling-video-training-parallelism',
                title: 'Scaling Video Training with Parallelism',
                excerpt: 'Yukang Chen, Luozhou Wang, Wei Huang, Shuai Yang, Weian Mao, and Song Han explain why long-video models need sequence parallelism that respects frame origin, VAE work, clean/noisy target layout, and hardware topology.',
                author: 'Yukang Chen, Luozhou Wang, Wei Huang, Shuai Yang, Weian Mao, Song Han',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                category: 'Visual Generation',
                tags: ['Video Generation', 'Sequence Parallelism', 'Training Systems', 'Long Context'],
                readTime: '12 min read',
                publishDate: '2026-06-03',
                sourceName: 'NVIDIA Research',
                url: 'https://research.nvidia.com/labs/eai/blogs/scaling-video-training-with-parallelism/',
                coverImage: 'assets/img/covers/real/nvidia-scaling-video-training-parallelism.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'yoonho-text-optimization-seriously',
                title: 'We Should Take Text Optimization More Seriously',
                excerpt: 'Yoonho Lee argues that prompts, memory, retrieval state, files, and harnesses are legitimate update targets, framing text optimization as an auditable, sample-efficient learning layer for model systems.',
                author: 'Yoonho Lee',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=yoonholee.com&sz=128',
                category: 'AI Agents',
                tags: ['Text Optimization', 'Prompting', 'Agent Memory', 'Update-Time Compute'],
                readTime: '14 min read',
                publishDate: '2026-06-08',
                sourceName: 'Yoonho Lee',
                url: 'https://yoonholee.com/blog/2026/we-should-take-text-optimization-more-seriously/',
                coverImage: 'assets/img/covers/real/yoonho-text-optimization-seriously.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'tilde-compositional-steepest-descent',
                title: 'Towards Compositional Steepest Descent',
                excerpt: 'The Tilde Research team develops a compositional view of Muon-style optimization, moving from single-layer operator-norm updates to functional perturbations in QK, OV, RMSNorm, and gated MLP structures.',
                author: 'Ben Keigwin, Li Yang, Dhruv Pai, Yunzhe Zhang, Alec DeWulf',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=tilderesearch.com&sz=128',
                category: 'Efficient AI',
                tags: ['Muon', 'Optimization', 'Steepest Descent', 'Transformer Training'],
                readTime: '35 min read',
                publishDate: '2026-06-01',
                sourceName: 'Tilde Research',
                url: 'https://blog.tilderesearch.com/blog/compositional-muon',
                coverImage: 'https://blog.tilderesearch.com/images/blog/compositional-muon/cover.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'openathena-pretraining-efficiency',
                title: 'Improving our LLM Pretraining Efficiency',
                excerpt: 'Larry Dial details Open Athena improvements to a large-scale pretraining recipe, from dense-to-MoE migration and expert sparsity to MuonH, partial key offset, and routed expert normalization.',
                author: 'Larry Dial',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openathena.ai&sz=128',
                category: 'Efficient AI',
                tags: ['Pretraining', 'MoE', 'Muon', 'Training Efficiency'],
                readTime: '12 min read',
                publishDate: '2026-06-03',
                sourceName: 'Open Athena',
                url: 'https://openathena.ai/blog/pretraining-speedup/',
                coverImage: 'https://openathena.ai/assets/images/blog/pretraining-speedup/lr-bpb-grid.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'luke-huang-frontier-asynchronous-rl',
                title: 'Is Frontier Asynchronous RL Solved?',
                excerpt: 'Luke J. Huang surveys asynchronous RL for frontier post-training, separating throughput gains from policy-lag instability, numerical mismatch, importance-sampling controls, and open systems questions.',
                author: 'Luke J. Huang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=luk-huang.github.io&sz=128',
                category: 'AI Agents',
                tags: ['Asynchronous RL', 'Post-Training', 'Policy Lag', 'RL Systems'],
                readTime: '15 min read',
                publishDate: '2026-05-31',
                sourceName: 'Luke J. Huang',
                url: 'https://luk-huang.github.io/personal-website/blog/is-frontier-asynchronous-rl-solved.html',
                coverImage: 'https://luk-huang.github.io/personal-website/assets/blog/async-rl/figures/1sync-vs-async-rl.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'yichuan-rl-as-a-service-infrastructure',
                title: 'Rethinking RL as a Service and the Position of RL Infrastructure',
                excerpt: 'Yichuan Wang distinguishes the real systems opportunity in RL infrastructure from the weaker near-term business case for generic RL-as-a-service, emphasizing reward design, rollout scale, and enterprise adaptation loops.',
                author: 'Yichuan Wang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=yichuan-w.github.io&sz=128',
                category: 'AI Agents',
                tags: ['RL Infrastructure', 'Post-Training', 'Enterprise AI', 'Agent Harnesses'],
                readTime: '8 min read',
                publishDate: '2026-05-01',
                sourceName: 'Yichuan Wang',
                url: 'https://yichuan-w.github.io/blog/rethinking-rl-as-a-service/',
                coverImage: 'assets/img/covers/real/yichuan-rl-as-a-service-infrastructure.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'galilai-stable-worldmodel',
                title: 'Stable World-Model',
                excerpt: 'The GalilAI Group presents an open-source toolkit for world-model research, with installable environments, baselines, wrappers, datasets, and training interfaces for running controlled model-based RL experiments.',
                author: 'GalilAI Group',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=galilai-group.github.io&sz=128',
                category: 'World Model',
                tags: ['World Models', 'Model-Based RL', 'Research Toolkit', 'Environments'],
                readTime: '8 min read',
                publishDate: '2026-06-01',
                sourceName: 'GalilAI Group',
                url: 'https://galilai-group.github.io/stable-worldmodel/',
                coverImage: 'assets/img/covers/real/galilai-stable-worldmodel.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'hylak-how-to-eval-ai-agents',
                title: 'How to Eval AI Agents: The 2026 Guide',
                excerpt: 'Ben Hylak lays out a production-minded agent evaluation loop: choose between benchmark maxing and floor raising, inspect trajectories, write code-aware offline evals, and turn real failures into targeted regressions.',
                author: 'Ben Hylak',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=howtoeval.com&sz=128',
                category: 'Research Craft',
                tags: ['Agent Evaluation', 'Production Monitoring', 'Error Analysis', 'Offline Evals'],
                readTime: '30 min read',
                publishDate: '2026-05-01',
                sourceName: 'howtoeval.com',
                url: 'https://www.howtoeval.com/',
                coverImage: 'https://www.howtoeval.com/og-image.png?v=2',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'davies-ai-agent-evaluation-frameworks',
                title: 'AI Agent Evaluation: Frameworks, Strategies, and Best Practices',
                excerpt: 'Dave Davies organizes agent evaluation across technical capability, autonomy, trust and safety, and business impact, giving a broad framework for assessing increasingly independent LLM systems.',
                author: 'Dave Davies',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=medium.com&sz=128',
                category: 'Research Craft',
                tags: ['Agent Evaluation', 'Autonomy', 'Trust and Safety', 'Production AI'],
                readTime: '143 min read',
                publishDate: '2025-10-22',
                sourceName: 'Online Inference',
                url: 'https://medium.com/online-inference/ai-agent-evaluation-frameworks-strategies-and-best-practices-9dc3cfdf9890',
                coverImage: 'assets/img/covers/real/davies-ai-agent-evaluation-frameworks.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'priyal-mechanics-of-lora',
                title: 'The Mechanics of LoRA',
                excerpt: 'Priyal Taneja explains LoRA from the serving and systems angle, connecting low-rank adapters, base-model reuse, routing, and the practical constraints that shape adapter-based deployment.',
                author: 'Priyal Taneja',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=priyaltaneja.com&sz=128',
                category: 'Efficient AI',
                tags: ['LoRA', 'Adapters', 'Model Serving', 'Efficient Fine-Tuning'],
                readTime: '18 min read',
                publishDate: '2026-06-01',
                sourceName: 'Priyal Taneja',
                url: 'https://www.priyaltaneja.com/mechanics-of-lora',
                coverImage: 'assets/img/covers/real/priyal-mechanics-of-lora.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'xuhui-thinking-in-rl',
                title: 'Thinking in RL',
                excerpt: 'Xuhui Zhou gives an opinionated map of modern RL algorithms for LLM training, tying PPO, GRPO, REINFORCE variants, DPO, advantage estimates, and policy-gradient ideas into one conceptual tree.',
                author: 'Xuhui Zhou',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=xuhuiz.com&sz=128',
                category: 'AI Agents',
                tags: ['Reinforcement Learning', 'PPO', 'GRPO', 'Policy Gradients'],
                readTime: '35 min read',
                publishDate: '2026-04-13',
                sourceName: 'Xuhui Zhou',
                url: 'https://xuhuiz.com/blog/thinking-in-rl',
                coverImage: 'assets/img/covers/real/xuhui-thinking-in-rl.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            },
            {
                id: 'chinmay-policy-distillation-imitation-game',
                title: 'The Imitation Game: State of Policy Distillation in Language Model Training',
                excerpt: 'Chinmay Karkar surveys on-policy distillation for language models, covering teacher-student objectives, cross-tokenizer supervision, multi-teacher recipes, failure modes, and open problems.',
                author: 'Chinmay Karkar',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=chinmaykarkar.com&sz=128',
                category: 'Efficient AI',
                tags: ['Policy Distillation', 'Knowledge Distillation', 'Post-Training', 'Tokenizer Alignment'],
                readTime: '24 min read',
                publishDate: '2026-05-15',
                sourceName: 'Chinmay Karkar',
                url: 'https://chinmaykarkar.com/blog/OPD_blog/',
                coverImage: 'https://chinmaykarkar.com/OPD_blog_light.jpg',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'openai-macro-evals-agentic-systems',
                title: 'Macro Evals for Agentic Systems',
                excerpt: 'OpenAI Cookbook demonstrates macro evals for agentic systems, using realistic end-to-end workflows, trace bundles, tool-call evidence, review packets, and aggregate diagnostics rather than isolated LLM-call scoring.',
                author: 'OpenAI Cookbook',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developers.openai.com&sz=128',
                category: 'Research Craft',
                tags: ['Macro Evals', 'Agents SDK', 'Trace Analysis', 'Workflow Evaluation'],
                readTime: '45 min read',
                publishDate: '2026-05-01',
                ...
                coverImage: 'https://developers.openai.com/open-graph.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'shreya-agent-assisted-qualitative-analysis',
                title: 'Exploring Agent-Assisted Qualitative Analysis',
                excerpt: 'Shreya Shankar uses qualitative analysis as a testbed for agent design, comparing naive agentic setups, human-in-the-loop workflows, and the gap between automation behavior and actual research methodology.',
                author: 'Shreya Shankar',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=sh-reya.com&sz=128',
                category: 'Research Craft',
                tags: ['Qualitative Analysis', 'Human-in-the-Loop', 'Agents', 'Research Methods'],
                readTime: '28 min read',
                publishDate: '2026-05-21',
                sourceName: 'Shreya Shankar',
            ...
            {
                id: 'sakana-diffusionblocks',
                title: 'DiffusionBlocks: Training Neural Networks One Block at a Time',
                excerpt: 'Sakana AI introduces DiffusionBlocks, a block-wise training framework that reinterprets residual-network updates as diffusion dynamics to reduce activation memory while matching end-to-end training across multiple architectures.',
                author: 'Makoto Shing, Masanori Koyama, Takuya Akiba',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=pub.sakana.ai&sz=128',
                category: 'Efficient AI',
                tags: ['DiffusionBlocks', 'Block-wise Training', 'Memory Efficiency', 'Transformers'],
                readTime: '12 min read',
                publishDate: '2026-05-01',
                sourceName: 'Sakana AI',
                url: 'https://pub.sakana.ai/diffusionblocks/',
                coverImage: 'https://pub.sakana.ai/diffusionblocks/assets/figures/cover_social.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'aleksa-transformer-life-token',
                title: 'Inside the Transformer: The Life of a Token',
                excerpt: 'Aleksa Gordic walks through a modern dense transformer forward pass, covering tokenization, embeddings, RMSNorm, GeGLU MLPs, GQA, YaRN, block-local attention, FLOPs per token, and cluster sizing.',
                author: 'Aleksa Gordic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=aleksagordic.com&sz=128',
                category: 'Foundation Model',
                tags: ['Transformer Architecture', 'Attention', 'YaRN', 'LLM Systems'],
                readTime: '30 min read',
                publishDate: '2026-05-26',
                sourceName: 'Aleksa Gordic',
                url: 'https://www.aleksagordic.com/blog/transformer',
                coverImage: 'https://www.aleksagordic.com/blog/transformer/flow_pre.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'greg-goal-engineering',
                title: 'Goal Engineering: How I Brief Coding Agents Using Paired Goal+Rider Documents',
                excerpt: 'Greg Ceccarelli describes a practical agent-briefing workflow built around compact goal files and richer rider documents, turning coding-agent runs into durable, testable, reviewable work units.',
                author: 'Greg Ceccarelli',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=gregceccarelli.com&sz=128',
                category: 'AI Agents',
                tags: ['Coding Agents', 'Specifications', 'Goal Documents', 'Agent Workflow'],
                readTime: '25 min read',
                publishDate: '2026-05-18',
                sourceName: 'Greg Ceccarelli',
                url: 'https://www.gregceccarelli.com/goal-engineering',
                coverImage: 'https://www.gregceccarelli.com/goal-engineering/assets/og-image.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'jiaxin-generalization-dynamics',
                title: 'Generalization Dynamics of LM Pre-training',
                excerpt: 'Jiaxin Wen, Zhengxuan Wu, Dawn Song, and Lijie Chen show that language models can mode-hop between shallow pattern matching and generalizable behavior during pretraining, motivating checkpoint and data-selection monitors.',
                author: 'Jiaxin Wen, Zhengxuan Wu, Dawn Song, Lijie Chen',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jiaxin-wen.github.io&sz=128',
                category: 'Foundation Model',
                tags: ['Generalization', 'Pretraining Dynamics', 'Checkpoint Selection', 'Mode Hopping'],
                readTime: '25 min read',
                publishDate: '2026-05-01',
                sourceName: 'Jiaxin Wen',
                url: 'https://jiaxin-wen.github.io/blog/generalization-dynamics',
                coverImage: 'https://jiaxin-wen.github.io/blog/figures/img/flipped_answer_hard_acc_tokens.png',
                coverAlt: 'Real cover from first-image',
                coverFit: 'cover'
            },
            {
                id: 'trajectory-multi-lora-continual-learning',
                title: 'Multi-LoRA Training for Continual Learning',
                excerpt: 'Chuck Tang describes Trajectory C-LoRA, a concurrent multi-LoRA training platform for continual learning that improves experiment throughput while coordinating live feedback, production data, and open training code.',
                author: 'Chuck Tang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=trajectory.ai&sz=128',
                category: 'Efficient AI',
                tags: ['LoRA', 'Continual Learning', 'Training Infrastructure', 'SkyRL'],
                readTime: '14 min read',
                publishDate: '2026-05-30',
                sourceName: 'Trajectory',
                url: 'https://trajectory.ai/field-notes/multi-lora-training-for-continual-learning',
                coverImage: 'https://framerusercontent.com/images/V0JD7u4HYc4JQduGmL3bK9t2hM.jpg',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'roy-anatomy-of-an-llm',
                title: 'The Anatomy of an LLM',
                excerpt: 'Roy van Rijn builds an interactive visual guide that traces text through tokenization, vectors, transformer blocks, logits, sampling, training phases, KV cache, quantization, and post-training.',
                author: 'Roy van Rijn',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=royvanrijn.com&sz=128',
                category: 'LLM & MLLM',
                tags: ['LLM Explainer', 'Tokenization', 'Attention', 'KV Cache'],
                readTime: '20 min read',
                publishDate: '2026-06-01',
                sourceName: 'Roy van Rijn',
                url: 'https://www.royvanrijn.com/anatomy-of-an-llm/',
                coverImage: 'https://www.royvanrijn.com/anatomy-of-an-llm/social/og-image.png',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'perplexity-unigram-tokenizer-cpu',
                title: 'Improving Unigram Tokenizer CPU Performance',
                excerpt: 'Perplexity Research explains a production tokenizer rewrite that accelerates XLM-RoBERTa Unigram encoding with Viterbi, trie layout, zero steady-state heap allocations, and careful CPU-side benchmarking.',
                author: 'Perplexity Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.perplexity.ai&sz=128',
                category: 'Efficient AI',
                tags: ['Tokenizer', 'CPU Performance', 'Viterbi', 'Inference Systems'],
                readTime: '18 min read',
                publishDate: '2026-05-20',
                sourceName: 'Perplexity Research',
                url: 'https://research.perplexity.ai/articles/improving-unigram-tokenizer-cpu-performance',
                coverImage: 'https://framerusercontent.com/images/Fn05k3P0cxKGt2z2j6iRi5PlrA.png?width=1920&height=1072',
                coverAlt: 'Real cover from og:image',
                coverFit: 'cover'
            },
            {
                id: 'howard-spectral-progressive-diffusion',
                title: 'Spectral Progressive Diffusion for Efficient Image and Video Generation',
                excerpt: 'Howard Xiao, Brian Chao, Lior Yariv, and Gordon Wetzstein propose a training-free and fine-tunable diffusion acceleration method that grows spatial resolution along the denoising trajectory using spectral noise expansion.',
                author: 'Howard Xiao, Brian Chao, Lior Yariv, Gordon Wetzstein',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=howardxiao.ca&sz=128',
                category: 'Visual Generation',
                tags: ['Diffusion', 'Video Generation', 'Image Generation', 'Inference Efficiency'],
                readTime: '10 min read',
                publishDate: '2026-06-01',
                sourceName: 'Howard Xiao',
                url: 'https://howardxiao.ca/speed/',
                coverImage: 'assets/img/covers/real/howard-spectral-progressive-diffusion.png',
                coverAlt: 'Real cover from original-page-screenshot',
                coverFit: 'cover'
            }
        ];
    ...
    getQualitySystemsCraftFrontierBlogs() {
        return [
            {
                id: 'nvidia-cuda-kernel-fusion',
                title: 'Kernel Fusion in NVIDIA CUDA: Optimizing Memory Traffic and Launch Overhead',
                excerpt: 'Daniel Rodriguez uses Nsight traces to compare hand-written CUDA, torch.compile, and explicit fusion, showing when fusion cuts memory traffic versus when launch overhead still dominates. The measurements are single-GPU microbenchmarks, so the ranking should not be treated as a multi-node serving result.',
                author: 'Daniel Rodriguez',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['CUDA', 'Kernel Fusion', 'Nsight', 'Memory Bandwidth'],
                readTime: '12 min read',
                publishDate: '2026-07-10',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/kernel-fusion-in-nvidia-cuda-optimizing-memory-traffic-and-launch-overhead/',
                coverImage: 'assets/img/covers/real/nvidia-cuda-kernel-fusion.webp',
                coverAlt: 'Kernel Fusion in NVIDIA CUDA: Optimizing Memory Traffic and Launch Overhead article cover',
                coverFit: 'cover'
            },
            {
                id: 'lei-mao-system-performance-optimizations',
                title: 'System Performance Optimizations',
                excerpt: 'Lei Mao walks through practical systems optimizations for deep learning workloads, connecting CPU/GPU overlap, memory layout, and kernel choices to observable latency. It is an independent engineering note rather than a controlled multi-hardware study.',
                author: 'Lei Mao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=leimao.github.io&sz=128',
                category: 'Efficient AI',
                tags: ['Systems', 'Performance', 'Profiling', 'Deep Learning'],
                readTime: '14 min read',
                publishDate: '2026-01-15',
                sourceName: 'Lei Mao',
                url: 'https://leimao.github.io/article/System-Performance-Optimizations/',
                coverImage: 'assets/img/covers/real/lei-mao-system-performance-optimizations.png',
                coverAlt: 'System Performance Optimizations article cover',
                coverFit: 'cover'
            },
            {
                id: 'modal-sota-speculative-decoding',
                title: 'Achieve State-of-the-Art Inference Latencies with Speculative Decoding',
                excerpt: 'Charles Frye and Shankha Biswas report production measurements of speculative decoding, including draft-model choice, acceptance rates, and end-to-end latency rather than token-throughput alone. Gains remain tied to the serving stack and draft/target pairing under test.',
                ...
                coverImage: 'assets/img/covers/real/modal-sota-speculative-decoding.png',
                coverAlt: 'Achieve State-of-the-Art Inference Latencies with Speculative Decoding article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-tensorrt-llm-public-release',
                title: 'Optimizing Inference on LLMs with TensorRT-LLM',
                excerpt: 'NVIDIA documents TensorRT-LLM\'s public inference stack: kernel selection, in-flight batching, and quantization paths intended to turn a trained decoder into a deployable engine. The performance claims are NVIDIA-hardware specific and should be re-benchmarked on other runtimes.',
                author: 'NVIDIA',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['TensorRT-LLM', 'Inference', 'Quantization', 'Serving'],
                readTime: '10 min read',
                publishDate: '2023-10-17',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/optimizing-inference-on-llms-with-tensorrt-llm-now-publicly-available/',
                coverImage: 'assets/img/covers/real/nvidia-tensorrt-llm-public-release.png',
                coverAlt: 'Optimizing Inference on LLMs with TensorRT-LLM article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-tensorrt-kv-cache-reuse',
                title: 'New KV Cache Reuse Optimizations in TensorRT-LLM',
                excerpt: 'This note explains how prefix and block reuse in TensorRT-LLM reduce KV-cache traffic for multi-turn and batched decode. The speedups assume compatible cache layouts and will shrink when prefixes rarely overlap.',
                author: 'NVIDIA',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['KV Cache', 'TensorRT-LLM', 'Prefix Caching', 'Inference'],
                readTime: '8 min read',
                publishDate: '2024-06-01',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/introducing-new-kv-cache-reuse-optimizations-in-nvidia-tensorrt-llm/',
                coverImage: 'assets/img/covers/real/nvidia-tensorrt-kv-cache-reuse.jpg',
                coverAlt: 'New KV Cache Reuse Optimizations in TensorRT-LLM article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-nvfp4-kv-cache',
                title: 'NVFP4 KV Cache for Long Context and Large Batches',
                excerpt: 'NVIDIA describes NVFP4 KV-cache quantization for long-context and large-batch decode, trading a controlled precision loss for memory capacity and bandwidth. Results are reported on NVIDIA GPUs and should not be copied onto other low-bit formats without re-measurement.',
                author: 'NVIDIA',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['NVFP4', 'KV Cache', 'Quantization', 'Long Context'],
                readTime: '9 min read',
                publishDate: '2025-11-01',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/optimizing-inference-for-long-context-and-large-batch-sizes-with-nvfp4-kv-cache/',
                coverImage: 'assets/img/covers/real/nvidia-nvfp4-kv-cache.png',
                coverAlt: 'NVFP4 KV Cache for Long Context and Large Batches article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-tensorrt-speculative-decoding-llama',
                title: 'TensorRT-LLM Speculative Decoding',
                excerpt: 'NVIDIA reports speculative decoding inside TensorRT-LLM on Llama 3.3 70B, including draft acceptance and throughput multipliers versus autoregressive decode. The 3× figure is configuration-specific and depends on draft quality plus batch shape.',
                author: 'NVIDIA',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['Speculative Decoding', 'Llama', 'TensorRT-LLM', 'Throughput'],
                readTime: '8 min read',
                ...
                coverImage: 'assets/img/covers/real/nvidia-tensorrt-speculative-decoding-llama.png',
                coverAlt: 'TensorRT-LLM Speculative Decoding article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepspeed-ulysses-offload',
                title: 'DeepSpeed Ulysses-Offload',
                excerpt: 'The DeepSpeed tutorial presents Ulysses-Offload as a sequence-parallel recipe that shards attention along sequence and offloads activation pressure for long-context training. It is a systems recipe, not a new modeling result, and assumes the DeepSpeed/Ulysses software stack.',
                author: 'Microsoft DeepSpeed',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepspeed.ai&sz=128',
                category: 'Efficient AI',
                tags: ['DeepSpeed', 'Sequence Parallelism', 'Long Context', 'Offloading'],
                readTime: '16 min read',
                publishDate: '2025-06-01',
                sourceName: 'DeepSpeed',
                url: 'https://www.deepspeed.ai/tutorials/ulysses-offload/',
                coverImage: 'https://www.google.com/s2/favicons?domain=deepspeed.ai&sz=128',
                coverAlt: 'DeepSpeed Ulysses-Offload article cover',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-assisted-generation',
                title: 'Assisted Generation: A New Direction Toward Low-Latency Text Generation',
                excerpt: 'Hugging Face explains assisted generation as a draft-then-verify decoding method that reduces sequential steps without changing the target model\'s distribution when verification is exact. Latency gains depend on draft acceptance and are smaller on already-batched decode.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['Assisted Generation', 'Speculative Decoding', 'Latency', 'Transformers'],
                readTime: '12 min read',
                publishDate: '2023-06-23',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/assisted-generation',
                coverImage: 'assets/img/covers/real/huggingface-assisted-generation.png',
                coverAlt: 'Assisted Generation: A New Direction Toward Low-Latency Text Generation article cover',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-torch-attention-profile',
                title: 'Profiling PyTorch: Attention Kernels',
                excerpt: 'A PyTorch profiling walkthrough that isolates attention kernel time, memory traffic, and the difference between naive and fused implementations. It is a teaching profile, not a claim about every production attention backend.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['PyTorch', 'Attention', 'Profiling', 'Kernels'],
                readTime: '11 min read',
                publishDate: '2026-07-10',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/torch-attention-profile',
                coverImage: 'assets/img/covers/real/huggingface-torch-attention-profile.png',
                coverAlt: 'Profiling PyTorch: Attention Kernels article cover',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-native-speed-vllm-transformers-backend',
                title: 'Native-Speed vLLM with the Transformers Backend',
                excerpt: 'Hugging Face describes running Transformers models through vLLM at native kernel speed, reducing the historical gap between research checkpoints and serving engines. Throughput still depends on the vLLM version, hardware, and whether custom modeling code maps cleanly.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['vLLM', 'Transformers', 'Serving', 'Inference'],
                readTime: '8 min read',
                publishDate: '2026-07-08',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/native-speed-vllm-transformers-backend',
                coverImage: 'assets/img/covers/real/huggingface-native-speed-vllm-transformers-backend.png',
                coverAlt: 'Native-Speed vLLM with the Transformers Backend article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-pushing-intelligence-to-4-bit',
                title: 'Pushing Intelligence to 4-Bit',
                excerpt: 'NVIDIA Research discusses 4-bit inference as a systems and accuracy problem, covering KV-cache and weight quantization under long context. The essay is hardware-aware; bit-width conclusions may not transfer to non-NVIDIA kernels.',
                author: 'NVIDIA Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['4-bit', 'Quantization', 'Inference', 'KV Cache'],
                readTime: '10 min read',
                publishDate: '2026-06-16',
                sourceName: 'NVIDIA Research',
                url: 'https://research.nvidia.com/labs/eai/blogs/pushing-intelligence-to-4-bit/',
                coverImage: 'assets/img/covers/real/nvidia-pushing-intelligence-to-4-bit.png',
                coverAlt: 'Pushing Intelligence to 4-Bit article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-gemini-nano-frozen-mtp',
                title: 'Accelerating Gemini Nano with Frozen Multi-Token Prediction',
                excerpt: 'Google Research explains frozen multi-token prediction as an on-device decode accelerator for Gemini Nano on Pixel, keeping a frozen draft head rather than training a separate speculator. The latency numbers are device-specific and tied to the Pixel stack.',
                author: 'Google Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'Efficient AI',
                tags: ['Multi-Token Prediction', 'On-Device', 'Gemini Nano', 'Speculative Decoding'],
                readTime: '9 min read',
                publishDate: '2026-06-26',
                sourceName: 'Google Research',
                url: 'https://research.google/blog/accelerating-gemini-nano-models-on-pixel-with-frozen-multi-token-prediction/',
                coverImage: 'assets/img/covers/real/google-gemini-nano-frozen-mtp.jpg',
                coverAlt: 'Accelerating Gemini Nano with Frozen Multi-Token Prediction article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-kv-cache-compression-infra',
                title: 'KV-Cache Compression and Its Infrastructure Problems',
                excerpt: 'NVIDIA Research treats KV-cache compression as an infrastructure problem: layout, paging, and quantizers interact with batching in ways a paper ablation can hide. The post is diagnostic; it does not offer a single universally best compressor.',
                author: 'NVIDIA Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['KV Cache', 'Compression', 'Serving', 'Infrastructure'],
                readTime: '11 min read',
                publishDate: '2026-06-12',
                sourceName: 'NVIDIA Research',
                url: 'https://research.nvidia.com/labs/eai/post/kv-cache-compression-and-its-infra-problems/',
                coverImage: 'https://www.google.com/s2/favicons?domain=research.nvidia.com&sz=128',
                coverAlt: 'KV-Cache Compression and Its Infrastructure Problems article cover',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-optimum-intel-v2',
                title: 'Optimum Intel 2.0',
                excerpt: 'Jeff Boudier presents Optimum Intel 2.0 as a path from Transformers checkpoints to Intel-optimized inference, covering quantization and runtime backends. Performance claims are Intel-hardware specific.',
                author: 'Jeff Boudier',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['Optimum', 'Intel', 'Quantization', 'CPU Inference'],
                readTime: '7 min read',
                publishDate: '2026-06-11',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/jeffboudier/optimum-intel-v2',
                coverImage: 'assets/img/covers/real/huggingface-optimum-intel-v2.png',
                coverAlt: 'Optimum Intel 2.0 article cover',
                coverFit: 'cover'
            },
            {
                id: 'huggingface-torch-mlp-fusion',
                title: 'Profiling in PyTorch, Part 2: From nn.Linear to a Fused MLP',
                excerpt: 'The follow-up profile traces an MLP from nn.Linear through fusion, showing how kernel launch and memory traffic change once pointwise ops are merged. It is a teaching example on a single device class.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'Efficient AI',
                tags: ['PyTorch', 'Fusion', 'MLP', 'Profiling'],
                readTime: '12 min read',
                publishDate: '2026-06-11',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/torch-mlp-fusion',
                coverImage: 'assets/img/covers/real/huggingface-torch-mlp-fusion.png',
                coverAlt: 'Profiling in PyTorch, Part 2: From nn.Linear to a Fused MLP article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-thunderkittens-2',
                title: 'ThunderKittens 2.0: Making Kernels Faster and Easier to Write',
                excerpt: 'Stanford Hazy Research updates ThunderKittens as an embedded DSL for AI kernels, aiming to keep Tensor-core performance without full CUDA specialist workflows. Ease-of-use claims should be read against the team\'s hardware and kernel set.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['ThunderKittens', 'Kernels', 'CUDA', 'DSL'],
                readTime: '13 min read',
                publishDate: '2026-02-19',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2026-02-19-tk-2',
                coverImage: 'assets/img/covers/real/hazyresearch-thunderkittens-2.png',
                coverAlt: 'ThunderKittens 2.0: Making Kernels Faster and Easier to Write article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-minions-on-device-cloud',
                title: 'Minions: Cost-Efficient Collaboration Between On-Device and Cloud Language Models',
                excerpt: 'Hazy Research describes Minions as a protocol for splitting work between on-device and cloud LMs to cut cost while preserving task quality. The savings depend on which subtasks can be locally filtered before a cloud call.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['On-Device', 'Cloud', 'Cost', 'Language Models'],
                readTime: '11 min read',
                publishDate: '2025-02-24',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2025-02-24-minions',
                coverImage: 'assets/img/covers/real/hazyresearch-minions-on-device-cloud.png',
                coverAlt: 'Minions: Cost-Efficient Collaboration Between On-Device and Cloud Language Models article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-lolcats-part-2',
                title: 'LoLCATs Part 2: Low-Rank Linearizing of LLMs',
                excerpt: 'Part 2 of LoLCATs develops low-rank linearization as a way to convert softmax attention models toward linear-time forms without a full retrain. Quality gaps versus the original Transformer remain task-dependent.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['Linear Attention', 'Low-Rank', 'LoLCATs', 'Architecture'],
                readTime: '14 min read',
                publishDate: '2024-10-14',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2024-10-14-lolcats-p2',
                coverImage: 'assets/img/covers/real/hazyresearch-lolcats-part-2.png',
                coverAlt: 'LoLCATs Part 2: Low-Rank Linearizing of LLMs article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-just-read-twice',
                title: 'Just Read Twice: Closing the Recall Gap for Recurrent Language Models',
                excerpt: 'Just Read Twice proposes a simple two-pass recipe to recover associative recall in recurrent language models that otherwise lag Transformers. The gap closed here is recall-centric and does not automatically transfer to every long-context benchmark.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['Recurrent LMs', 'Recall', 'Long Context', 'Architecture'],
                readTime: '12 min read',
                publishDate: '2024-07-01',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2024-07-01-jrt',
                coverImage: 'assets/img/covers/real/hazyresearch-just-read-twice.png',
                coverAlt: 'Just Read Twice: Closing the Recall Gap for Recurrent Language Models article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-based-one-year-later',
                title: 'BASED One Year Later: Exploring the State of Linear Attention',
                excerpt: 'A retrospective on BASED and linear attention, revisiting what held up empirically and where softmax attention still wins. It is a field-status essay, not a new architecture announcement.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['Linear Attention', 'BASED', 'Architecture', 'Retrospective'],
                readTime: '13 min read',
                publishDate: '2025-03-24',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2025-03-24-based-retro',
                coverImage: 'assets/img/covers/real/hazyresearch-based-one-year-later.png',
                coverAlt: 'BASED One Year Later: Exploring the State of Linear Attention article cover',
                coverFit: 'cover'
            },
            {
                id: 'epoch-is-a-compute-crunch-coming',
                title: 'Is a Compute Crunch Coming?',
                excerpt: 'Epoch AI examines whether supply of AI accelerators and power can keep pace with demand, separating chip fabrication, packaging, and datacenter constraints. It is a scenario analysis, not a point forecast.',
                author: 'Epoch AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Efficient AI',
                tags: ['Compute', 'Hardware', 'Forecasting', 'Infrastructure'],
                readTime: '18 min read',
                publishDate: '2024-08-01',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/gradient-updates/is-a-compute-crunch-coming',
                coverImage: 'assets/img/covers/real/epoch-is-a-compute-crunch-coming.png',
                coverAlt: 'Is a Compute Crunch Coming? article cover',
                coverFit: 'cover'
            },
            {
                id: 'bair-tiny-agent-function-calling-edge',
                title: 'TinyAgent: Function Calling at the Edge',
                excerpt: 'BAIR presents TinyAgent as a small on-device agent that performs function calling without round-tripping every step to a frontier cloud model. Edge accuracy and tool coverage remain narrower than large-server agents.',
                author: 'BAIR',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=bair.berkeley.edu&sz=128',
                category: 'Efficient AI',
                tags: ['On-Device', 'Function Calling', 'Agents', 'Edge'],
                readTime: '10 min read',
                publishDate: '2024-05-29',
                sourceName: 'BAIR',
                url: 'https://bair.berkeley.edu/blog/2024/05/29/tiny-agent/',
                coverImage: 'assets/img/covers/real/bair-tiny-agent-function-calling-edge.png',
                coverAlt: 'TinyAgent: Function Calling at the Edge article cover',
                coverFit: 'cover'
            },
            {
                id: 'pytorch-accelerating-llm-inference-gemlite',
                title: 'Accelerating LLM Inference with GemLite, TorchAO and SGLang',
                excerpt: 'PyTorch, Mobius Labs, and SGLang combine low-bit kernels, TorchAO quantization, and a serving engine in a reproducible end-to-end recipe. Speedups are for the reported model and GPU pair and should be re-run before citing as general.',
                author: 'PyTorch / Mobius Labs / SGLang',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=pytorch.org&sz=128',
                category: 'Efficient AI',
                tags: ['TorchAO', 'SGLang', 'Quantization', 'Serving'],
                readTime: '12 min read',
                publishDate: '2025-03-01',
                sourceName: 'PyTorch Blog',
                url: 'https://pytorch.org/blog/accelerating-llm-inference/',
                coverImage: 'https://www.google.com/s2/favicons?domain=pytorch.org&sz=128',
                coverAlt: 'Accelerating LLM Inference with GemLite, TorchAO and SGLang article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-flashfftconv',
                title: 'FlashFFTConv: Efficient Convolutions for Long Sequences with Tensor Cores',
                excerpt: 'FlashFFTConv fuses FFT convolution onto Tensor Cores so long-sequence convolutional models can approach attention-class hardware utilization. Gains assume convolution-heavy architectures rather than vanilla Transformers.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Efficient AI',
                tags: ['FFT', 'Convolution', 'Tensor Cores', 'Long Sequences'],
                readTime: '12 min read',
                publishDate: '2023-11-13',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/blog/2023-11-13-flashfftconv',
                coverImage: 'assets/img/covers/real/hazyresearch-flashfftconv.png',
                coverAlt: 'FlashFFTConv: Efficient Convolutions for Long Sequences with Tensor Cores article cover',
                coverFit: 'cover'
            },
            {
                id: 'nvidia-megatron-trillion-parameters',
                title: 'Scaling Language Model Training to a Trillion Parameters Using Megatron',
                excerpt: 'NVIDIA describes Megatron-style tensor, pipeline, and data parallelism that made trillion-parameter training tractable on their clusters. The recipe is historical and cluster-specific; modern successors changed several partitioning defaults.',
                author: 'NVIDIA',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developer.nvidia.com&sz=128',
                category: 'Efficient AI',
                tags: ['Megatron', 'Tensor Parallel', 'Pipeline Parallel', 'Training'],
                readTime: '12 min read',
                publishDate: '2021-10-01',
                sourceName: 'NVIDIA Technical Blog',
                url: 'https://developer.nvidia.com/blog/scaling-language-model-training-to-a-trillion-parameters-using-megatron/',
                coverImage: 'assets/img/covers/real/nvidia-megatron-trillion-parameters.png',
                coverAlt: 'Scaling Language Model Training to a Trillion Parameters Using Megatron article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepmind-frontier-safety-framework',
                title: 'Strengthening Our Frontier Safety Framework',
                excerpt: 'Google DeepMind updates its frontier safety framework with sharper capability thresholds and evaluation commitments. The post is a policy-and-process note; independent auditors cannot verify every internal eval from the blog alone.',
                author: 'Google DeepMind',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Frontier Safety', 'Evaluations', 'Governance', 'DeepMind'],
                readTime: '9 min read',
                publishDate: '2025-02-04',
                sourceName: 'Google DeepMind',
                url: 'https://deepmind.google/blog/strengthening-our-frontier-safety-framework/',
                coverImage: 'assets/img/covers/real/deepmind-frontier-safety-framework.png',
                coverAlt: 'Strengthening Our Frontier Safety Framework article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-trustworthy-third-party-evaluations',
                title: 'Trustworthy Third-Party Evaluations',
                excerpt: 'OpenAI outlines conditions under which third-party model evaluations can be trusted: access, independence, documentation, and limits on training on the eval itself. The post sets a bar; it does not publish a full open eval harness.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Evaluations', 'Third Party', 'Governance', 'Transparency'],
                readTime: '10 min read',
                publishDate: '2025-03-01',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/trustworthy-third-party-evaluations-foundations/',
                coverImage: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                coverAlt: 'Trustworthy Third-Party Evaluations article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-hf-model-evaluation-security-incident',
                title: 'Hugging Face Model Evaluation Security Incident',
                excerpt: 'OpenAI reports a security incident around Hugging Face model evaluation infrastructure, treating eval platforms as part of the trusted computing base. The write-up is an incident note; readers should check Hugging Face\'s own timeline for operational details.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Security', 'Evaluations', 'Incident', 'Infrastructure'],
                readTime: '7 min read',
                publishDate: '2026-07-21',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/hugging-face-model-evaluation-security-incident/',
                coverImage: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                coverAlt: 'Hugging Face Model Evaluation Security Incident article cover',
                coverFit: 'cover'
            },
            {
                id: 'openai-safety-alignment-long-horizon-models',
                title: 'Safety and Alignment in an Era of Long-Horizon Models',
                excerpt: 'OpenAI discusses how long-horizon agents change alignment: specification, monitoring, and evaluation all stretch when tasks last hours rather than a single turn. It is a research-program essay rather than a finished control theorem.',
                author: 'OpenAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Alignment', 'Long-Horizon', 'Agents', 'Safety'],
                readTime: '12 min read',
                publishDate: '2026-07-20',
                sourceName: 'OpenAI',
                url: 'https://openai.com/index/safety-alignment-long-horizon-models/',
                coverImage: 'https://www.google.com/s2/favicons?domain=openai.com&sz=128',
                coverAlt: 'Safety and Alignment in an Era of Long-Horizon Models article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepmind-securing-internal-systems-ai-agents',
                title: 'Securing Internal Systems against Increasingly Capable and Imperfectly Aligned AI',
                excerpt: 'DeepMind argues that internal tools must assume agents will be capable and imperfectly aligned, so sandboxing, least privilege, and monitoring become first-class design constraints. The post is a security architecture note, not a public red-team dataset.',
                author: 'Google DeepMind',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Agent Security', 'Sandboxing', 'Least Privilege', 'Monitoring'],
                readTime: '11 min read',
                publishDate: '2026-06-18',
                sourceName: 'Google DeepMind',
                url: 'https://deepmind.google/blog/securing-the-future-of-ai-agents/',
                coverImage: 'assets/img/covers/real/deepmind-securing-internal-systems-ai-agents.png',
                coverAlt: 'Securing Internal Systems against Increasingly Capable and Imperfectly Aligned AI article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-measuring-n-day-exploits',
                title: 'Measuring LLMs’ Impact on N-Day Exploits',
                excerpt: 'Anthropic measures whether frontier models change the cost of exploiting known n-day vulnerabilities, separating assistance from fully autonomous exploitation. The result is an eval snapshot and should not be read as a live cyber-risk dashboard.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Cybersecurity', 'N-day', 'Evaluations', 'Risk'],
                readTime: '12 min read',
                publishDate: '2026-06-08',
                sourceName: 'Anthropic',
                url: 'https://www.anthropic.com/research/n-days',
                coverImage: 'assets/img/covers/real/anthropic-measuring-n-day-exploits.jpg',
                coverAlt: 'Measuring LLMs’ Impact on N-Day Exploits article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-mapping-ai-enabled-cyber-threats',
                title: 'Mapping AI-Enabled Cyber Threats',
                excerpt: 'Anthropic\'s attack navigator maps how language models can assist along a cyber kill chain, distinguishing reconnaissance, exploit development, and operations. It is a taxonomy for defenders, not a proof of observed campaigns.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Cybersecurity', 'Threat Model', 'Kill Chain', 'Risk'],
                readTime: '11 min read',
                publishDate: '2026-06-03',
                sourceName: 'Anthropic',
                url: 'https://www.anthropic.com/research/attack-navigator',
                coverImage: 'assets/img/covers/real/anthropic-mapping-ai-enabled-cyber-threats.jpg',
                coverAlt: 'Mapping AI-Enabled Cyber Threats article cover',
                coverFit: 'cover'
            },
            {
                id: 'anthropic-trustworthy-agents-in-practice',
                title: 'Trustworthy Agents in Practice',
                excerpt: 'Anthropic collects practical controls for agents that use tools: permissioning, logging, human approval, and evaluation loops. The guidance is operational; it does not claim a solved alignment problem.',
                author: 'Anthropic',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128',
                category: 'Trustworthy AI',
                tags: ['Agents', 'Permissions', 'Monitoring', 'Safety'],
                readTime: '12 min read',
                publishDate: '2026-04-09',
                sourceName: 'Anthropic',
                url: 'https://www.anthropic.com/research/trustworthy-agents',
                coverImage: 'assets/img/covers/real/anthropic-trustworthy-agents-in-practice.png',
                coverAlt: 'Trustworthy Agents in Practice article cover',
                coverFit: 'cover'
            },
            {
                id: 'deepmind-protecting-people-harmful-manipulation',
                title: 'Protecting People from Harmful Manipulation',
                excerpt: 'DeepMind discusses harmful manipulation as a product and model-behavior problem, including evaluation of persuasive failure modes. The post mixes research and policy and is not a complete taxonomy of influence attacks.',
                author: 'Google DeepMind',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=deepmind.google&sz=128',
                category: 'Trustworthy AI',
                tags: ['Manipulation', 'Safety', 'Evaluations', 'Policy'],
                readTime: '9 min read',
                publishDate: '2026-03-26',
                sourceName: 'Google DeepMind',
                url: 'https://deepmind.google/blog/protecting-people-from-harmful-manipulation/',
                coverImage: 'assets/img/covers/real/deepmind-protecting-people-harmful-manipulation.png',
                coverAlt: 'Protecting People from Harmful Manipulation article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-good-data-analysis',
                title: 'Good Data Analysis',
                excerpt: 'Google\'s good-data-analysis guide lists failure modes in slicing, leakage, and metric choice before a model is trained. It is a practice checklist, not a statistics textbook.',
                author: 'Google',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developers.google.com&sz=128',
                category: 'Research Craft',
                tags: ['Data Analysis', 'Metrics', 'Leakage', 'Methodology'],
                readTime: '20 min read',
                publishDate: '2022-06-01',
                sourceName: 'Google Developers',
                url: 'https://developers.google.com/machine-learning/guides/good-data-analysis',
                coverImage: 'assets/img/covers/real/google-good-data-analysis.png',
                coverAlt: 'Good Data Analysis article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-data-traps',
                title: 'Data Traps',
                excerpt: 'A companion guide to traps in training data: skewed sampling, label leakage, feedback loops, and silent schema change. The examples are production-oriented and still apply to LLM pipelines.',
                author: 'Google',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=developers.google.com&sz=128',
                category: 'Research Craft',
                tags: ['Data Quality', 'Leakage', 'Feedback Loops', 'ML Ops'],
                readTime: '18 min read',
                publishDate: '2022-06-01',
                sourceName: 'Google Developers',
                url: 'https://developers.google.com/machine-learning/guides/data-traps',
                coverImage: 'assets/img/covers/real/google-data-traps.png',
                coverAlt: 'Data Traps article cover',
                coverFit: 'cover'
            },
            {
                id: 'fsdl-experiment-management',
                title: 'Experiment Management',
                excerpt: 'Full Stack Deep Learning\'s experiment-management lab covers tracking, configs, and comparison discipline so runs remain interpretable weeks later. It is course material from 2022; tool names have changed more than the underlying hygiene.',
                author: 'Full Stack Deep Learning',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=fullstackdeeplearning.com&sz=128',
                category: 'Research Craft',
                tags: ['Experiment Tracking', 'Configs', 'ML Ops', 'Reproducibility'],
                readTime: '35 min read',
                publishDate: '2022-03-01',
                sourceName: 'Full Stack Deep Learning',
                url: 'https://fullstackdeeplearning.com/course/2022/lab-4-experiment-management/',
                coverImage: 'assets/img/covers/real/fsdl-experiment-management.png',
                coverAlt: 'Experiment Management article cover',
                coverFit: 'cover'
            },
            {
                id: 'fsdl-development-infrastructure-tooling',
                title: 'Development Infrastructure and Tooling',
                excerpt: 'The FSDL lecture on development infrastructure treats environments, data versioning, and CI as part of the research loop rather than afterthoughts. Tooling specifics are 2022-era; the argument for investing in infra is not.',
                author: 'Full Stack Deep Learning',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=fullstackdeeplearning.com&sz=128',
                category: 'Research Craft',
                tags: ['Infrastructure', 'Tooling', 'ML Ops', 'Research Workflow'],
                readTime: '40 min read',
                publishDate: '2022-03-01',
                sourceName: 'Full Stack Deep Learning',
                url: 'https://fullstackdeeplearning.com/course/2022/lecture-2-development-infrastructure-and-tooling/',
                coverImage: 'assets/img/covers/real/fsdl-development-infrastructure-tooling.png',
                coverAlt: 'Development Infrastructure and Tooling article cover',
                coverFit: 'cover'
            },
            {
                id: 'ai2-astabench-update-spring-2026',
                title: 'AstaBench Update: Spring 2026',
                excerpt: 'Ai2 updates AstaBench with new scientific-agent tasks and scoring notes, treating benchmark drift as something to document rather than hide. Scores remain benchmark-specific and should not be flattened into a single agent IQ.',
                author: 'Ai2',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=allenai.org&sz=128',
                category: 'Research Craft',
                tags: ['Benchmarks', 'Scientific Agents', 'Evaluation', 'AstaBench'],
                readTime: '9 min read',
                publishDate: '2026-04-30',
                sourceName: 'Ai2',
                url: 'https://allenai.org/blog/astabench-update-spring-2026',
                coverImage: 'assets/img/covers/real/ai2-astabench-update-spring-2026.png',
                coverAlt: 'AstaBench Update: Spring 2026 article cover',
                coverFit: 'cover'
            },
            {
                id: 'google-empirical-research-assistance',
                title: 'Four Ways Google Researchers Have Been Using Empirical Research Assistance',
                excerpt: 'Google Research scientists describe using empirical-research assistance for literature triage, experiment bookkeeping, and writing support, with notes on where the tools still fail. It is a practice report from one lab, not a product benchmark.',
                author: 'Google Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=research.google&sz=128',
                category: 'Research Craft',
                tags: ['Research Workflow', 'Assistance', 'Literature', 'Experiments'],
                readTime: '8 min read',
                publishDate: '2026-04-29',
                sourceName: 'Google Research',
                url: 'https://research.google/blog/four-ways-google-research-scientists-have-been-using-empirical-research-assistance/',
                coverImage: 'assets/img/covers/real/google-empirical-research-assistance.jpg',
                coverAlt: 'Four Ways Google Researchers Have Been Using Empirical Research Assistance article cover',
                coverFit: 'cover'
            },
            {
                id: 'distill-bayesian-optimization',
                title: 'Exploring Bayesian Optimization',
                excerpt: 'Distill\'s interactive essay on Bayesian optimization builds intuition for Gaussian processes, acquisition functions, and when BO beats grid search. It is a 2020 teaching piece; modern HPO stacks add multivariate and multi-fidelity wrinkles.',
                author: 'Distill',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'Research Craft',
                tags: ['Bayesian Optimization', 'HPO', 'Gaussian Processes', 'Interactive'],
                readTime: '35 min read',
                publishDate: '2020-04-06',
                sourceName: 'Distill',
                url: 'https://distill.pub/2020/bayesian-optimization/',
                coverImage: 'assets/img/covers/real/distill-bayesian-optimization.jpg',
                coverAlt: 'Exploring Bayesian Optimization article cover',
                coverFit: 'cover'
            },
            {
                id: 'hazyresearch-what-data-centric-ai-is-not',
                title: 'What Data-Centric AI Is Not',
                excerpt: 'Stanford Hazy Research clarifies data-centric AI by ruling out slogans: it is not merely \'more data\', nor a replacement for learning algorithms. The 2021 framing still helps keep dataset work from collapsing into marketing.',
                author: 'Stanford Hazy Research',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                category: 'Research Craft',
                tags: ['Data-Centric AI', 'Datasets', 'Methodology', 'Definitions'],
                readTime: '8 min read',
                publishDate: '2021-06-01',
                sourceName: 'Hazy Research',
                url: 'https://hazyresearch.stanford.edu/what-data-centric-ai-is-not',
                coverImage: 'https://www.google.com/s2/favicons?domain=hazyresearch.stanford.edu&sz=128',
                coverAlt: 'What Data-Centric AI Is Not article cover',
                coverFit: 'cover'
            },
            {
                id: 'eu-ai-office-frontier-expert-findings',
                title: 'Frontier AI Expert Findings: EU Competitiveness, Sovereignty and Security',
                excerpt: 'The European Commission AI Office publishes expert findings on frontier AI competitiveness, sovereignty, and security. Treat it as a policy-and-evidence brief, not a model card or a training recipe.',
                author: 'European Commission AI Office',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=digital-strategy.ec.europa.eu&sz=128',
                category: 'Frontier',
                tags: ['Policy', 'Frontier AI', 'EU', 'Security'],
                readTime: '30 min read',
                publishDate: '2026-07-15',
                ...
                coverImage: 'https://www.google.com/s2/favicons?domain=digital-strategy.ec.europa.eu&sz=128',
                coverAlt: 'Frontier AI Expert Findings: EU Competitiveness, Sovereignty and Security article cover',
                coverFit: 'cover'
            },
            {
                id: 'un-scientific-panel-ai-preliminary-report',
                title: 'Preliminary Report of the UN Independent International Scientific Panel on AI',
                excerpt: 'The UN Independent International Scientific Panel on AI releases a preliminary scientific assessment of capabilities, risks, and evidence gaps. It is a panel report, not a lab blog, and should be read as a synthesis with explicit uncertainty.',
                author: 'United Nations',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=un.org&sz=128',
                category: 'Frontier',
                tags: ['UN', 'Scientific Panel', 'Risk', 'Governance'],
                readTime: '40 min read',
                publishDate: '2026-06-01',
                sourceName: 'United Nations',
                url: 'https://www.un.org/independent-international-scientific-panel-ai/en/preliminary-report',
                coverImage: 'https://www.google.com/s2/favicons?domain=un.org&sz=128',
                coverAlt: 'Preliminary Report of the UN Independent International Scientific Panel on AI article cover',
                coverFit: 'cover'
            },
            {
                id: 'stanford-hai-ai-index-2026',
                title: 'AI Index Report 2026',
                excerpt: 'Stanford HAI\'s 2026 AI Index compiles quantitative trends on capability, investment, policy, and public opinion. Use the underlying charts rather than any single headline; methodology notes matter for cross-year comparisons.',
                author: 'Stanford HAI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=hai.stanford.edu&sz=128',
                category: 'Frontier',
                ...
                coverImage: 'assets/img/covers/real/stanford-hai-ai-index-2026.jpg',
                coverAlt: 'AI Index Report 2026 article cover',
                coverFit: 'cover'
            },
            {
                id: 'state-of-ai-2026-model-provider-survey',
                title: 'State of AI 2026: Model Provider Survey',
                excerpt: 'The 2026 State of AI model-provider survey aggregates how builders report training, serving, and productization choices. Self-reported survey data should be triangulated against public evals and independent measurements.',
                author: 'State of AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=2026.stateofai.dev&sz=128',
                category: 'Frontier',
                tags: ['Survey', 'Model Providers', 'Industry', 'Trends'],
                readTime: '20 min read',
                publishDate: '2026-06-01',
                sourceName: 'State of AI',
                url: 'https://2026.stateofai.dev/en-US/models/',
                coverImage: 'assets/img/covers/real/state-of-ai-2026-model-provider-survey.png',
                coverAlt: 'State of AI 2026: Model Provider Survey article cover',
                coverFit: 'cover'
            },
            {
                id: 'epoch-where-autonomy-works-2026',
                title: 'Where Autonomy Works: Evaluating Robot Capabilities in 2026',
                excerpt: 'Epoch AI evaluates where robot autonomy actually works in 2026, distinguishing demo-friendly settings from economically relevant ones. Task coverage is necessarily incomplete; treat gaps as missing measurements, not proofs of impossibility.',
                author: 'Epoch AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['Robotics', 'Autonomy', 'Evaluation', 'Capabilities'],
                readTime: '20 min read',
                publishDate: '2026-03-01',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/where-autonomy-works-evaluating-robot-capabilities-in-2026',
                coverImage: 'assets/img/covers/real/epoch-where-autonomy-works-2026.png',
                coverAlt: 'Where Autonomy Works: Evaluating Robot Capabilities in 2026 article cover',
                coverFit: 'cover'
            },
            {
                id: 'epoch-what-will-ai-look-like-in-2030',
                title: 'What Will AI Look Like in 2030?',
                excerpt: 'Epoch AI sketches 2030 scenarios from compute, data, and capability trends, with explicit uncertainty bands. Scenario essays are not commitments; they are structured guesses with stated drivers.',
                author: 'Epoch AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                tags: ['Forecasting', '2030', 'Scenarios', 'Compute'],
                readTime: '24 min read',
                publishDate: '2025-09-01',
                sourceName: 'Epoch AI',
                url: 'https://epoch.ai/publications/what-will-ai-look-like-in-2030',
                coverImage: 'assets/img/covers/real/epoch-what-will-ai-look-like-in-2030.png',
                coverAlt: 'What Will AI Look Like in 2030? article cover',
                coverFit: 'cover'
            },
            {
                id: 'epoch-what-you-need-to-know-ai-data-centers',
                title: 'What You Need to Know About AI Data Centers',
                excerpt: 'A primer on AI datacenters covering power, cooling, networking, and why training clusters differ from inference farms. It is explanatory; site-level numbers will vary by operator and region.',
                author: 'Epoch AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=epoch.ai&sz=128',
                category: 'Frontier',
                ...
                coverImage: 'assets/img/covers/real/epoch-what-you-need-to-know-ai-data-centers.png',
                coverAlt: 'What You Need to Know About AI Data Centers article cover',
                coverFit: 'cover'
            },
            {
                id: 'mistral-ocr-4',
                title: 'Mistral OCR 4: SOTA OCR for Document Intelligence',
                excerpt: 'Mistral OCR 4 describes a document-intelligence OCR stack with claimed state-of-the-art document parsing. Benchmark names and languages matter; treat SOTA as measured on the reported suites, not as a universal OCR ranking.',
                author: 'Mistral AI',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=mistral.ai&sz=128',
                category: 'Frontier',
                tags: ['OCR', 'Document Intelligence', 'Mistral', 'Parsing'],
                readTime: '7 min read',
                publishDate: '2026-03-01',
                sourceName: 'Mistral AI',
                url: 'https://mistral.ai/news/ocr-4/',
                coverImage: 'assets/img/covers/real/mistral-ocr-4.png',
                coverAlt: 'Mistral OCR 4: SOTA OCR for Document Intelligence article cover',
                coverFit: 'cover'
            }
        ];
    }

    getQualityFoundationLlmMultimodalBlogs() {
        return [
            
            {
                id: 'hugging-face-moe-in-transformers',
                title: 'Mixture of Experts (MoEs) in Transformers',
                excerpt: 'Hugging Face explains how MoE layers replace dense feed-forward blocks with routed experts, then walks through the engineering that makes them practical in the transformers library: weight conversion, lazy tensor materialization, faster weight loading, expert-parallel backends, and where quantization fits. A worked example predicts gpt-oss-20b decode speed from active parameters and memory bandwidth (~111 estimated vs ~115 measured tok/s on an M3 Ultra); benchmarks target the transformers stack rather than dedicated serving engines.',
                author: 'Hugging Face',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'LLM & MLLM',
                tags: ['Mixture of Experts', 'Transformers Library', 'Expert Parallelism', 'Inference'],
                readTime: '14 min read',
                publishDate: '2026-02-26',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/moe-transformers',
                coverImage: 'assets/img/covers/real/hugging-face-moe-in-transformers.png',
                coverAlt: 'Mixture of experts in transformers cover',
                coverFit: 'cover'
            }
        ];
    }

    getQualityVisualWorldAgentsBlogs() {
        return [
            
            {
                id: 'hf-braintrust-eval-agentic-setups',
                title: 'How to Actually Evaluate AI Agents at Scale',
                excerpt: 'Analyzes 1,781 real agent traces from Exgentic using Braintrust with LLM-as-a-judge scoring, finding the harness moves success roughly 7x more than model choice (12% to 92% for a fixed model), open-weight models match closed ones on SWE-bench tasks, and cost per success ranks configurations very differently from cost per task. Also documents opposite failure patterns, with failing coding agents thrashing and burning tokens while failing customer-service agents give up early; results reflect one trace dataset and judge setup.',
                author: 'Jessica (darubberduckiee)',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=huggingface.co&sz=128',
                category: 'AI Agents',
                tags: ['Agent Evaluation', 'Trace Analysis', 'LLM-as-a-Judge', 'Cost Analysis'],
                readTime: '12 min read',
                publishDate: '2026-06-24',
                sourceName: 'Hugging Face Blog',
                url: 'https://huggingface.co/blog/darubberduckiee/using-braintrust-to-eval-agentic-setups',
                coverImage: 'assets/img/covers/real/hf-braintrust-eval-agentic-setups.png',
                coverAlt: 'Evaluating AI agents at scale article cover',
                coverFit: 'cover'
            },
            {
                id: 'meta-dynabench-rethinking-ai-benchmarking',
                title: 'Dynabench: Rethinking AI Benchmarking',
                excerpt: 'Dynabench introduces dynamic adversarial data collection: human annotators interact with state-of-the-art models in the loop and craft examples that fool them, producing benchmarks that cannot saturate the way static datasets like GLUE did and measuring model error rate under human pressure. It launches with four NLP tasks run in rounds with academic partners, building on the ANLI methodology where even GPT-3 performed near chance on adversarially collected examples.',
                author: 'Douwe Kiela, Adina Williams',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=ai.meta.com&sz=128',
                category: 'AI Agents',
                tags: ['Benchmarking', 'Adversarial Data', 'Human-in-the-Loop', 'NLP Evaluation'],
                readTime: '10 min read',
                publishDate: '2020-09-24',
                sourceName: 'Meta AI',
                url: 'https://ai.meta.com/blog/dynabench-rethinking-ai-benchmarking/',
                coverImage: 'assets/img/covers/real/meta-dynabench-rethinking-ai-benchmarking.jpg',
                coverAlt: 'Dynabench dynamic benchmarking cover',
                coverFit: 'cover'
            },
            {
                id: 'minimax-agent-team-long-running-tasks',
                title: 'MiniMax Agent Team: Built for Long-Running Tasks and Continuous Evolution',
                excerpt: 'MiniMax upgrades its agent product around Agent Teams: a main agent acknowledges the task within seconds, splits it into parallel role-specialized workers with acceptance checks and retained memory, and reports at key checkpoints instead of blocking on every sub-step. The post is candid about why single agents fail on long tasks, citing context anxiety, degradation, and premature stopping, and about the costs of the team design, advising when a single agent remains the better choice.',
                author: 'MiniMax',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=minimax.io&sz=128',
                category: 'AI Agents',
                tags: ['Multi-Agent Teams', 'Long-Horizon Tasks', 'Agent Product Design', 'Orchestration'],
                readTime: '12 min read',
                publishDate: '2026-05-27',
                sourceName: 'MiniMax',
                url: 'https://www.minimax.io/blog/minimax-agent-team-long-running-1779893953',
                coverImage: 'assets/img/covers/real/minimax-agent-team-long-running-tasks.jpg',
                coverAlt: 'MiniMax Agent Team announcement cover',
                coverFit: 'cover'
            },
            {
                id: 'minimax-forge-scalable-agent-rl',
                title: 'Forge: Scalable Agent RL Framework and Algorithm',
                excerpt: 'MiniMax details Forge, the RL framework behind M2.5, which decouples agents from training infrastructure through gateway-and-data-pool middleware so both white-box and black-box scaffolds can be trained, uses Windowed FIFO scheduling to limit distribution shift from asynchronous rollouts, and applies prefix-tree merging for a claimed 40x training speedup with mathematical equivalence. Training mixed over 100,000 real agent scaffolds at 200k context using CISPO with dense process and completion-time rewards; results are internal and tied to the MiniMax stack.',
                author: 'MiniMax',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=minimax.io&sz=128',
                category: 'AI Agents',
                tags: ['Agent RL', 'Training Infrastructure', 'CISPO', 'Reinforcement Learning'],
                readTime: '14 min read',
                publishDate: '2026-02-14',
                sourceName: 'MiniMax Research',
                url: 'https://www.minimax.io/blog/forge-scalable-agent-rl-en-1779896141',
                coverImage: 'assets/img/covers/real/minimax-forge-scalable-agent-rl.jpg',
                coverAlt: 'MiniMax Forge agent RL framework cover',
                coverFit: 'cover'
            },
            {
                ...
                author: 'Gagan Bansal, Shujaat Mirza, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128',
                category: 'AI Agents',
                tags: ['Multi-Agent Security', 'Red Teaming', 'Prompt Injection', 'Agent Networks'],
                readTime: '13 min read',
                publishDate: '2026-04-30',
                sourceName: 'Microsoft Research Blog',
                ...
                coverImage: 'assets/img/covers/real/microsoft-red-teaming-network-of-agents.jpg',
                coverAlt: 'Red-teaming a network of agents cover',
                coverFit: 'cover'
            },
            {
                id: 'bair-intelligence-is-free-data-systems-for-agents',
                title: 'Intelligence Is Free, Now What? Data Systems for, of, and by Agents',
                excerpt: 'Berkeley\'s EPIC Data Lab lays out a research agenda for data systems as agents become the dominant workload: agentic speculation produces thousands of highly redundant SQL probes per request, with 80-90% duplicate sub-plans, motivating shared computation, approximate answers, batched query interfaces, and proactive feedback from the database. The post also covers structured memory and concurrency control for agent swarms plus workload-specific engines synthesized by agents, flagging reward hacking of incomplete specifications as the key verification risk.',
                author: 'Aditya G. Parameswaran, et al.',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=bair.berkeley.edu&sz=128',
                category: 'AI Agents',
                tags: ['Data Systems', 'Agent Infrastructure', 'Structured Memory', 'Research Agenda'],
                readTime: '14 min read',
                publishDate: '2026-07-07',
                sourceName: 'BAIR Blog',
                url: 'https://bair.berkeley.edu/blog/2026/07/07/intelligence-is-free-now-what/',
                coverImage: 'assets/img/covers/real/bair-intelligence-is-free-data-systems-for-agents.png',
                coverAlt: 'Data systems for agents article cover',
                coverFit: 'cover'
            }
        ];
    }

    getQualityHowToResearchBlogs() {
        return [
            {
                id: 'chapman-how-to-do-research-at-mit-ai-lab',
                title: 'How to Do Research at the MIT AI Lab',
                excerpt: 'David Chapman edited this 1988 working paper in which MIT AI Lab graduate students pool first-hand advice on reading, writing, programming, choosing problems, and managing advisors and emotions. It treats research as an apprenticeship built from explicit, learnable skills rather than innate talent. The tooling and lab culture it describes are firmly 1980s MIT, so some logistics are dated even where the craft advice holds.',
                author: 'David Chapman (ed.)',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=dspace.mit.edu&sz=128',
                category: 'How to Research',
                tags: ['Research Apprenticeship', 'Reading Papers', 'Advisor Relationships', 'Graduate School'],
                readTime: '75 min read',
                publishDate: '1988-09-01',
                sourceName: 'MIT AI Lab',
                url: 'https://dspace.mit.edu/bitstream/handle/1721.1/41487/AI_WP_316.pdf',
                coverImage: 'assets/img/covers/real/chapman-how-to-do-research-at-mit-ai-lab.png',
                coverAlt: 'First page of the MIT AI Lab working paper How to Do Research',
                coverFit: 'cover'
            },
            {
                id: 'stearns-some-modest-advice-for-graduate-students',
                title: 'Some Modest Advice for Graduate Students',
                excerpt: 'Stephen Stearns tells graduate students to assume nobody will save them: prepare a thesis plan early, treat committee meetings as leverage, and psychologically insure risky projects with backup routes. The advice is blunt, first-person, and grew out of 1980s evolutionary biology at Yale, so its picture of advisor relationships is more adversarial than many modern programs.',
                author: 'Stephen C. Stearns',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=stearnslab.yale.edu&sz=128',
                category: 'How to Research',
                tags: ['Graduate School', 'Risk Management', 'Advisor Relationships', 'Thesis Planning'],
                readTime: '12 min read',
                publishDate: '1987-01-01',
                sourceName: 'Stearns Lab, Yale',
                url: 'https://stearnslab.yale.edu/modest-advice',
                coverImage: 'assets/img/covers/real/stearns-some-modest-advice-for-graduate-students.png',
                coverAlt: 'Some Modest Advice for Graduate Students essay page',
                coverFit: 'cover'
            },
            {
                id: 'azuma-so-long-and-thanks-for-the-phd',
                title: 'So Long, and Thanks for the Ph.D.!',
                excerpt: 'Ronald Azuma\'s graduate-school survival guide, begun in 1997 and revised through 2019, catalogs what CS PhD students learn too late: initiative, daily tangible progress, and managing your advisor matter more than raw brilliance. Each section mixes stories from his UNC years with concrete checklists. The framing is distinctly American computer science, including its funding and job-market particulars.',
                author: 'Ronald T. Azuma',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.unc.edu&sz=128',
                category: 'How to Research',
                tags: ['PhD Survival', 'Initiative', 'Advisor Management', 'Career Paths'],
                readTime: '60 min read',
                publishDate: '1997-01-01',
                sourceName: 'UNC Computer Science',
                url: 'https://www.cs.unc.edu/~azuma/hitch4.html',
                coverImage: 'assets/img/covers/real/azuma-so-long-and-thanks-for-the-phd.png',
                coverAlt: 'So Long and Thanks for the PhD survival guide page',
                coverFit: 'cover'
            },
            {
                id: 'nick-feamster-cultivating-your-research-taste',
                title: 'Cultivating Your Research Taste',
                excerpt: 'Nick Feamster describes how researchers develop taste in problems the way people develop taste in music or food: exposure, imitation, feedback, and eventually a personal aesthetic. He offers concrete practices, from reading outside your subfield to dissecting why specific papers feel important and apprenticing with people whose taste you admire. The perspective draws on his networking-research career inside US academia.',
                author: 'Nick Feamster',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=practicespace.substack.com&sz=128',
                category: 'How to Research',
                tags: ['Research Taste', 'Problem Selection', 'Mentorship', 'Research Career'],
                readTime: '9 min read',
                publishDate: '2025-10-29',
                sourceName: 'Practice Space',
                url: 'https://practicespace.substack.com/p/cultivating-your-research-taste-fbd',
                coverImage: 'assets/img/covers/real/nick-feamster-cultivating-your-research-taste.jpg',
                coverAlt: 'Cultivating Your Research Taste article cover',
                coverFit: 'cover'
            },
            {
                id: 'john-regehr-picking-a-research-topic-in-computer-systems',
                title: 'Picking a Research Topic in Computer Systems',
                excerpt: 'John Regehr collects heuristics for picking systems research topics: ride externally imposed technology trends, mine the gaps between communities, and be honest about the difference between problems that are important and problems that are merely fundable. He is explicit that this is one systems professor\'s view from 2010, when multicore and embedded devices were the live examples.',
                author: 'John Regehr',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=blog.regehr.org&sz=128',
                category: 'How to Research',
                tags: ['Topic Selection', 'Computer Systems', 'Technology Trends', 'Research Strategy'],
                readTime: '10 min read',
                publishDate: '2010-03-21',
                sourceName: 'Embedded in Academia',
                url: 'https://blog.regehr.org/archives/46',
                coverImage: 'assets/img/covers/real/john-regehr-picking-a-research-topic-in-computer-systems.png',
                coverAlt: 'Picking a Research Topic in Computer Systems blog page',
                coverFit: 'cover'
            },
            {
                id: 'jason-eisner-how-to-find-research-problems',
                title: 'How to Find Research Problems',
                excerpt: 'Jason Eisner, then a Penn graduate student writing for new CS PhD students in 1997, explains where research problems actually come from: nagging anomalies, tool-domain mismatches, and questions that survive being written down and attacked from several directions. He urges students to keep an ideas file and treat dissatisfaction with existing methods as raw material. Examples lean on 1990s natural language processing.',
                author: 'Jason Eisner',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.jhu.edu&sz=128',
                category: 'How to Research',
                tags: ['Problem Discovery', 'Research Questions', 'NLP', 'Graduate School'],
                readTime: '7 min read',
                publishDate: '1997-01-01',
                sourceName: 'Johns Hopkins CS',
                url: 'https://www.cs.jhu.edu/~jason/advice/how-to-find-research-problems.html',
                coverImage: 'assets/img/covers/real/jason-eisner-how-to-find-research-problems.png',
                coverAlt: 'How to Find Research Problems essay page',
                coverFit: 'cover'
            },
            {
                id: 'noah-smith-grad-school-advice',
                title: 'Some Grad School Advice',
                excerpt: 'Noah A. Smith distills the grad-school decision to one question: who will your advisor be? He advises applicants to weight advisor fit over institutional ranking, to talk with current students, and to remember that a PhD is a paid research job rather than a continuation of coursework. The advice targets US computer-science doctoral programs specifically.',
                author: 'Noah A. Smith',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.cmu.edu&sz=128',
                category: 'How to Research',
                tags: ['Choosing an Advisor', 'PhD Applications', 'Graduate School', 'Mentorship'],
                readTime: '5 min read',
                publishDate: '2007-01-01',
                sourceName: 'Noah A. Smith',
                url: 'https://www.cs.cmu.edu/~nasmith/advice.html',
                coverImage: 'assets/img/covers/real/noah-smith-grad-school-advice.png',
                coverAlt: 'Noah Smith grad school advice page',
                coverFit: 'cover'
            },
            {
                id: 'simon-peyton-jones-how-to-write-a-great-research-proposal',
                title: 'How to Write a Great Research Proposal',
                excerpt: 'Simon Peyton Jones\'s slide essay on research proposals insists the reader must learn three things fast: what the problem is, why it matters, and why now is the moment it can be cracked. He dissects how bored, overloaded reviewers actually read and structures the proposal around their attention. The framing reflects UK-style funding panels, though the craft carries over to other systems.',
                author: 'Simon Peyton Jones',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=simon.peytonjones.org&sz=128',
                category: 'How to Research',
                tags: ['Research Proposals', 'Grant Writing', 'Problem Framing', 'Research Communication'],
                readTime: '12 min read',
                publishDate: '2016-07-27',
                sourceName: 'Simon Peyton Jones',
                url: 'https://simon.peytonjones.org/assets/pdfs/great-research-proposal.pdf',
                coverImage: 'assets/img/covers/real/simon-peyton-jones-how-to-write-a-great-research-proposal.png',
                coverAlt: 'First slide of How to Write a Great Research Proposal',
                coverFit: 'cover'
            },
            {
                id: 'simon-peyton-jones-how-to-give-a-good-research-talk',
                title: 'How to Give a Good Research Talk',
                excerpt: 'Simon Peyton Jones, John Hughes, and John Launchbury give practical rules for the 25-minute conference talk: say one thing, get to an example within minutes, keep slides sparse, and rehearse the opening. First published in SIGPLAN Notices in 1993, its overhead-projector mechanics are dated but its structural advice remains standard reading in programming-languages circles.',
                author: 'Simon Peyton Jones, John Hughes, and John Launchbury',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=simon.peytonjones.org&sz=128',
                category: 'How to Research',
                tags: ['Research Talks', 'Presentation Skills', 'Conference Speaking', 'Research Communication'],
                readTime: '10 min read',
                publishDate: '1993-11-01',
                sourceName: 'Simon Peyton Jones',
                url: 'https://simon.peytonjones.org/assets/pdfs/giving-a-talk.pdf',
                coverImage: 'assets/img/covers/real/simon-peyton-jones-how-to-give-a-good-research-talk.png',
                coverAlt: 'First page of How to Give a Good Research Talk',
                coverFit: 'cover'
            },
            {
                id: 'cs-grad-job-and-interview-guide',
                title: 'Computer Science Graduate Job and Interview Guide',
                excerpt: 'This community guide, assembled by CS faculty and researchers, walks graduate students through the research job hunt end to end: finding openings, preparing application packages, interviewing, negotiating, and deciding, with real materials from successful candidates. Accounts cover research universities, liberal arts colleges, and industrial labs. It is US-centric and its market snapshots date from around 2020.',
                author: 'CS Guides Community',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=csguides.github.io&sz=128',
                category: 'How to Research',
                tags: ['Academic Job Market', 'Industry Research Jobs', 'Application Materials', 'Interviewing'],
                readTime: '45 min read',
                publishDate: '2020-01-01',
                sourceName: 'CS Guides',
                url: 'https://csguides.github.io/grad-job-guide/',
                coverImage: 'assets/img/covers/real/cs-grad-job-and-interview-guide.png',
                coverAlt: 'CS Graduate Job and Interview Guide landing page',
                coverFit: 'cover'
            },
            {
                id: 'visionbook-how-to-do-research',
                title: 'How to Do Research (Foundations of Computer Vision)',
                excerpt: 'Antonio Torralba, Phillip Isola, and William Freeman close their computer-vision textbook with a chapter on doing research itself: choosing problems by expected surprise, alternating exploration and exploitation, and structuring collaborations honestly. The advice generalizes beyond vision but is calibrated to empirical, publication-driven machine learning in MIT-style labs.',
                author: 'Antonio Torralba, Phillip Isola, and William Freeman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=visionbook.mit.edu&sz=128',
                category: 'How to Research',
                tags: ['Research Process', 'Problem Selection', 'Computer Vision', 'Scientific Method'],
                readTime: '25 min read',
                publishDate: '2024-04-16',
                sourceName: 'Foundations of Computer Vision',
                url: 'https://visionbook.mit.edu/how_to_do_research.html',
                coverImage: 'assets/img/covers/real/visionbook-how-to-do-research.jpg',
                coverAlt: 'How to Do Research chapter illustration',
                coverFit: 'cover'
            },
            {
                id: 'visionbook-how-to-write-papers',
                title: 'How to Write Papers (Foundations of Computer Vision)',
                excerpt: 'In the writing chapter of Foundations of Computer Vision, Torralba, Isola, and Freeman prescribe a paper-building workflow: nail the one-sentence contribution, design figure-first drafts, and revise for the skimming reviewer before the careful one. Their templates and examples are tuned to CVPR/NeurIPS-style empirical papers rather than journal or theory formats.',
                author: 'Antonio Torralba, Phillip Isola, and William Freeman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=visionbook.mit.edu&sz=128',
                category: 'How to Research',
                tags: ['Paper Writing', 'Scientific Writing', 'Figures', 'Peer Review'],
                readTime: '30 min read',
                publishDate: '2024-04-16',
                sourceName: 'Foundations of Computer Vision',
                url: 'https://visionbook.mit.edu/how_to_write_papers.html',
                coverImage: 'assets/img/covers/real/visionbook-how-to-write-papers.jpg',
                coverAlt: 'How to Write Papers chapter illustration',
                coverFit: 'cover'
            },
            {
                id: 'visionbook-how-to-give-talks',
                title: 'How to Give Talks (Foundations of Computer Vision)',
                excerpt: 'The talks chapter from Torralba, Isola, and Freeman\'s textbook treats a research talk as narrative design: one idea per slide, visual explanations over bullet lists, and rehearsing transitions instead of sentences, with concrete slide makeovers. The guidance is aimed at ML and vision conference talks, where figures carry most of the argument.',
                author: 'Antonio Torralba, Phillip Isola, and William Freeman',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=visionbook.mit.edu&sz=128',
                category: 'How to Research',
                tags: ['Research Talks', 'Presentation Design', 'Storytelling', 'Conference Speaking'],
                readTime: '25 min read',
                publishDate: '2024-04-16',
                sourceName: 'Foundations of Computer Vision',
                url: 'https://visionbook.mit.edu/how_to_give_talks.html',
                coverImage: 'assets/img/covers/real/visionbook-how-to-give-talks.jpg',
                coverAlt: 'How to Give Talks chapter illustration',
                coverFit: 'cover'
            },
            {
                id: 'stanford-cs-phd-advising-guide',
                title: 'Stanford CS PhD Advising Guide',
                excerpt: 'Stanford\'s CS department wrote this guide to make the advisor-student relationship legible: what advising is for, how rotations and alignment work, and what students and faculty owe each other in meetings, feedback, and funding. It is unusually explicit about mutual expectations. Some mechanics, like the rotation system, are Stanford-specific.',
                author: 'Stanford Computer Science Department',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.stanford.edu&sz=128',
                category: 'How to Research',
                tags: ['PhD Advising', 'Advisor Relationships', 'Rotations', 'Expectations Setting'],
                readTime: '10 min read',
                publishDate: '2023-01-01',
                sourceName: 'Stanford Computer Science',
                url: 'https://www.cs.stanford.edu/phd-milestones-progress-guidelines/phd-advising-guide',
                coverImage: 'assets/img/covers/real/stanford-cs-phd-advising-guide.png',
                coverAlt: 'Stanford CS PhD Advising Guide page',
                coverFit: 'cover'
            },
            {
                id: 'mor-harchol-balter-applying-to-phd-programs-in-cs',
                title: 'Applying to Ph.D. Programs in Computer Science',
                excerpt: 'Mor Harchol-Balter demystifies CS PhD admissions from the committee\'s side: what research experience signals, how recommendation letters are actually read, and how funding decisions work. The document doubles as advice on deciding whether a PhD is right at all. Last revised in 2014, its numbers and school lists reflect that era of US admissions.',
                author: 'Mor Harchol-Balter',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.cmu.edu&sz=128',
                category: 'How to Research',
                tags: ['PhD Applications', 'Statement of Purpose', 'Recommendation Letters', 'Admissions'],
                readTime: '35 min read',
                publishDate: '2014-04-03',
                sourceName: 'Carnegie Mellon University',
                url: 'https://www.cs.cmu.edu/~harchol/gradschooltalk.pdf',
                coverImage: 'assets/img/covers/real/mor-harchol-balter-applying-to-phd-programs-in-cs.png',
                coverAlt: 'First page of Applying to PhD Programs in Computer Science',
                coverFit: 'cover'
            },
            {
                id: 'umd-choosing-a-research-advisor',
                title: 'Choosing a Research Advisor',
                excerpt: 'Udaya Shankar\'s short note for Maryland CS students argues that picking an advisor is about two axes: whether the professor\'s area excites you and whether their working style — team size, depth versus breadth, implementation versus theory — fits how you work. He tells students to read recent papers and interview current group members before committing. It is a brief departmental note rather than a full essay.',
                author: 'Udaya Shankar',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=cs.umd.edu&sz=128',
                category: 'How to Research',
                tags: ['Choosing an Advisor', 'Research Style', 'Graduate School', 'Mentorship'],
                readTime: '3 min read',
                publishDate: '2010-01-01',
                sourceName: 'UMD Computer Science',
                url: 'https://www.cs.umd.edu/grad/choosing-your-advisor',
                coverImage: 'assets/img/covers/real/umd-choosing-a-research-advisor.png',
                coverAlt: 'Choosing a Research Advisor page',
                coverFit: 'cover'
            },
            {
                id: 'neel-guha-templates-for-ml-research-papers',
                title: 'Templates for Machine Learning Research Papers',
                excerpt: 'Neel Guha gives students literal templates for machine-learning papers: reusable skeletons for intros, method sections, and experiment narratives, keyed to the claim types ML venues expect. The point is to separate the craft of argument from the novelty of the idea. Templates are tuned to current ML conference conventions and will age with them.',
                author: 'Neel Guha',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=neelguha.github.io&sz=128',
                category: 'How to Research',
                tags: ['Paper Writing', 'ML Papers', 'Argument Structure', 'Research Communication'],
                readTime: '12 min read',
                publishDate: '2026-03-24',
                sourceName: 'Neel Guha',
                url: 'https://neelguha.github.io/blog/2026/templates/',
                coverImage: 'assets/img/covers/real/neel-guha-templates-for-ml-research-papers.png',
                coverAlt: 'Templates for Machine Learning Research Papers blog page',
                coverFit: 'cover'
            },
            {
                id: 'msr-first-accomplishment-in-nlp',
                title: 'How to Make a First Accomplishment in the NLP Field',
                excerpt: 'Ming Zhou of Microsoft Research Asia maps how a newcomer earns a first real result in NLP: master the task taxonomy, reproduce a strong baseline, then find the delta a top venue will accept, while building relationships in the research community. Written in 2017, its landscape is statistical-plus-early-neural NLP, before large language models rearranged the field.',
                author: 'Ming Zhou',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128',
                category: 'How to Research',
                tags: ['NLP', 'Early Career', 'Baselines', 'Research Community'],
                readTime: '10 min read',
                publishDate: '2017-12-04',
                sourceName: 'Microsoft Research Asia',
                url: 'https://www.microsoft.com/en-us/research/articles/make-first-accomplishment-nlp-field/',
                coverImage: 'assets/img/covers/real/msr-first-accomplishment-in-nlp.jpg',
                coverAlt: 'How to Make a First Accomplishment in the NLP Field article cover',
                coverFit: 'cover'
            },
            {
                id: 'distill-communicating-with-interactive-articles',
                title: 'Communicating with Interactive Articles',
                excerpt: 'Fred Hohman and coauthors synthesize what interactive articles can do that static papers cannot: engage readers through play, expose models for direct manipulation, and layer explanations for multiple audiences. They ground each claim in examples from journalism, education, and visualization research. Building such artifacts remains costly, which the authors acknowledge as the central adoption barrier.',
                author: 'Fred Hohman, Matthew Conlen, Jeffrey Heer, and Duen Horng Chau',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=distill.pub&sz=128',
                category: 'How to Research',
                tags: ['Interactive Articles', 'Scientific Communication', 'Visualization', 'Explorable Explanations'],
                readTime: '35 min read',
                publishDate: '2020-09-11',
                sourceName: 'Distill',
                url: 'https://distill.pub/2020/communicating-with-interactive-articles/',
                coverImage: 'assets/img/covers/real/distill-communicating-with-interactive-articles.jpg',
                coverAlt: 'Communicating with Interactive Articles cover',
                coverFit: 'cover'
            },
            {
                id: 'markus-heinonen-advice-for-ml-phd-students',
                title: 'Advice for Machine Learning PhD Students',
                excerpt: 'Markus Heinonen reduces the ML PhD to three trainable fundamentals — understanding, expressing, and implementing ideas — and builds concrete weekly practices around each: simplify the problem until it fits in one plot, iterate small, and write constantly. The advice reflects supervising doctoral students at Aalto in a European, methods-focused ML tradition.',
                author: 'Markus Heinonen',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=markusheinonen.github.io&sz=128',
                category: 'How to Research',
                tags: ['ML PhD', 'Fundamentals', 'Simplification', 'Research Cadence'],
                readTime: '12 min read',
                publishDate: '2025-01-01',
                sourceName: 'Markus Heinonen',
                url: 'https://markusheinonen.github.io/advice.html',
                coverImage: 'assets/img/covers/real/markus-heinonen-advice-for-ml-phd-students.png',
                coverAlt: 'Advice for Machine Learning PhD Students page',
                coverFit: 'cover'
            },
            {
                id: 'stanford-engineering-pick-and-solve-next-great-problem',
                title: 'How to Pick — and Solve — the Next Great Problem',
                excerpt: 'Stanford\'s Michael Fischbach teaches problem selection as an explicit skill: work backward from what would matter if true, use decision trees to expose hidden assumptions, and kill projects whose best case is boring. This is a university article distilling his course rather than a first-person essay, and its examples come from bioengineering.',
                author: 'Stanford Engineering (on Michael Fischbach)',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=engineering.stanford.edu&sz=128',
                category: 'How to Research',
                tags: ['Problem Selection', 'Decision Trees', 'Research Ambition', 'Bioengineering'],
                readTime: '6 min read',
                publishDate: '2024-10-23',
                sourceName: 'Stanford Engineering',
                url: 'https://engineering.stanford.edu/news/how-pick-and-solve-next-great-problem',
                coverImage: 'assets/img/covers/real/stanford-engineering-pick-and-solve-next-great-problem.jpg',
                coverAlt: 'How to Pick and Solve the Next Great Problem article cover',
                coverFit: 'cover'
            },
            {
                id: 'david-patterson-how-to-have-a-bad-career',
                title: 'How to Have a Bad Career in Research/Academia',
                excerpt: 'David Patterson\'s famous talk inverts career advice: to have a bad career, let complexity be your guide, never be proven wrong, and avoid feedback — then flips to the real recommendations on picking projects with impact and moving ideas into practice. The slides target new systems faculty at US research universities, and this version dates from 2001.',
                author: 'David Patterson',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=eecs.berkeley.edu&sz=128',
                category: 'How to Research',
                tags: ['Career Anti-patterns', 'Technology Transfer', 'Academic Career', 'Computer Systems'],
                readTime: '15 min read',
                publishDate: '2001-12-10',
                sourceName: 'UC Berkeley EECS',
                url: 'https://people.eecs.berkeley.edu/~pattrsn/talks/BadCareer.pdf',
                coverImage: 'assets/img/covers/real/david-patterson-how-to-have-a-bad-career.png',
                coverAlt: 'First slide of How to Have a Bad Career in Research/Academia',
                coverFit: 'cover'
            },
            {
                id: 'matt-might-phd-thesis-proposal-is-a-contract',
                title: 'A Ph.D. Thesis Proposal Is a Contract',
                excerpt: 'Matt Might reframes the thesis proposal as a contract: a falsifiable claim plus the evidence the committee agrees will validate it, so the defense becomes checking terms instead of relitigating scope. He gives a template thesis statement and warns against proposals that promise systems instead of claims. The advice assumes CS programs with US-style committees.',
                author: 'Matt Might',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=matt.might.net&sz=128',
                category: 'How to Research',
                tags: ['Thesis Proposal', 'Committee Management', 'PhD Milestones', 'Dissertation'],
                readTime: '6 min read',
                publishDate: '2010-01-01',
                sourceName: 'matt.might.net',
                url: 'https://matt.might.net/articles/advice-for-phd-thesis-proposals/',
                coverImage: 'assets/img/covers/real/matt-might-phd-thesis-proposal-is-a-contract.png',
                coverAlt: 'A PhD Thesis Proposal Is a Contract article page',
                coverFit: 'cover'
            },
            {
                id: 'terence-tao-take-the-initiative',
                title: 'Take the Initiative',
                excerpt: 'Terence Tao urges researchers to stop waiting for assigned problems: read beyond the syllabus, ask questions of the literature, and manufacture your own projects from gaps you notice. Initiative, he argues, is what converts training into a research career. As with his other career-advice pages, the examples assume academic mathematics.',
                author: 'Terence Tao',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=terrytao.wordpress.com&sz=128',
                category: 'How to Research',
                tags: ['Research Initiative', 'Self-Direction', 'Career Development', 'Mathematics'],
                readTime: '5 min read',
                publishDate: '2007-01-01',
                sourceName: 'Terence Tao',
                url: 'https://terrytao.wordpress.com/career-advice/take-the-initiative/',
                coverImage: 'assets/img/covers/real/terence-tao-take-the-initiative.png',
                coverAlt: 'Take the Initiative career advice page',
                coverFit: 'cover'
            },
            {
                id: 'patrick-kidger-just-know-stuff',
                title: 'Just Know Stuff',
                excerpt: 'Patrick Kidger\'s thesis from a fast Oxford maths PhD is that ML research success mostly means just knowing stuff, and he provides the literal checklist: autodiff internals, numerical methods, software engineering, statistics, and the craft of writing libraries people use. The list is opinionated, calibrated to 2023 ML tooling, and assumes a mathematically strong reader.',
                author: 'Patrick Kidger',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=kidger.site&sz=128',
                category: 'How to Research',
                tags: ['ML PhD', 'Technical Fundamentals', 'Software Craft', 'Skill Checklist'],
                readTime: '15 min read',
                publishDate: '2023-01-26',
                sourceName: 'Patrick Kidger',
                url: 'https://kidger.site/thoughts/just-know-stuff/',
                coverImage: 'assets/img/covers/real/patrick-kidger-just-know-stuff.png',
                coverAlt: 'Just Know Stuff essay page',
                coverFit: 'cover'
            },
            {
                id: 'jacob-steinhardt-advice-for-authors',
                title: 'Advice for Authors',
                excerpt: 'Distilled from reviewing batches of ICML submissions, Steinhardt\'s advice concentrates on local writing style: be precise to maximize information content, prefer concrete claims over vague ones, and treat sentence-level clarity as more important than global structure. It is a compact reviewer\'s checklist rather than a full guide to composing a research paper.',
                author: 'Jacob Steinhardt',
                authorAvatar: 'https://www.google.com/s2/favicons?domain=jsteinhardt.stat.berkeley.edu&sz=128',
                category: 'How to Research',
                tags: ['Paper Writing', 'Scientific Writing', 'Peer Review', 'Machine Learning'],
                readTime: '8 min read',
                publishDate: '2017-02-28',
                sourceName: 'Jacob Steinhardt',
                url: 'https://jsteinhardt.stat.berkeley.edu/blog/advice-for-authors',
                coverImage: 'assets/img/covers/cover-research-adjudication.svg',
                coverAlt: 'Thematic research writing and review cover',
                coverFit: 'cover'
            }
        ];
    }
    ...
    getCuratedCommunityBlogs() {
        ...
        for (const blog of blogs) {
            const previous = byId.get(blog.id);
            if (!previous || (blog.excerpt || '').length >= (previous.excerpt || '').length) {
                byId.set(blog.id, blog);
            }
        }

        const categoryReassignments = this.getCategoryReassignments();
        return Array.from(byId.values()).map(blog => this.applyCategoryReassignments(this.enhanceCuratedBlogCover(blog), categoryReassignments));
    }
